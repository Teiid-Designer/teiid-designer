...
public class BasicModel extends BasicMetadataObject implements Model {
    ...
    /**
     * Call constructor to instantiate a runtime object by passing the RuntimeID that identifies the entity and the
     * VIrtualDatabaseID that identifes the Virtual Database the object will be contained.
     */
