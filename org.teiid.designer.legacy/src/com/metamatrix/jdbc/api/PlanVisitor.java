...
/**
 * A helper class to walk a query plan and execute some action at each node. Subclasses should override the appropriate visit()
 * methods to get notification when a node of each type is visited.
 */
public abstract class PlanVisitor {
    ...
    /**
     * <p>
     * This method controls how a tree is visited from the rootNode. This implementation will walk the tree in pre-order (a node
     * is visited before it's children) and will visit a particular node in the following order: node itself, each property of the
     * node, and finally the children of the node, in order.
     * </p>
     * <p>
    ...
    /**
     * Visit a container property - the container property will be visited, then each particular value of the container will be
     * visited.
     * 
     * @param node The node being visited
     * @param propertyName The property name being visited
