...
/**
 * Utility class containing 1) SQL state constants used to represent MetaMatrix JDBC error state code, and 2) utility methods to
 * check whether a SQL state belongs to a particular class of exception states.
 * 
 * @since 4.3
 */
public class SQLStates {
     ...
     */
    public static final SQLStateClass CLASS_CONNECTION_EXCEPTION = new SQLStateClass("08"); //$NON-NLS-1$
     ...
     * <p>
     * The SQLState subclass S01 is an implementation-specified condition and conforms to the subclass DataDirect uses for
     * SocketExceptions.
     */
     ...
     */
    public static final SQLStateClass CLASS_INVALID_AUTHORIZATION_SPECIFICATION = new SQLStateClass("28"); //$NON-NLS-1$
    ...
    public static boolean belongsToClass( String sqlStateCode,
