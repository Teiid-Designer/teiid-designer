...
public class ArgCheck {
	...
	public static final void isNonNegative(int value, String message) {
		if(value < 0) {
            final String msg = message != null ? 
                               message :
                               CoreModelerPlugin.Util.getString("ArgCheck.isNonNegativeInt"); //$NON-NLS-1$
	...
	public static final void isNonPositive(int value, String message) {
	    if(value > 0) {
            final String msg = message != null ? 
                               message :
                               CoreModelerPlugin.Util.getString("ArgCheck.isNonPositiveInt"); //$NON-NLS-1$
	        throw new IllegalArgumentException(msg);
	    }
	}
	...
	public static final void isNegative(int value, String message) {
	    if(value >= 0) {
            final String msg = message != null ? 
                               message :
                               CoreModelerPlugin.Util.getString("ArgCheck.isNegativeInt"); //$NON-NLS-1$
	        throw new IllegalArgumentException(msg);
	    }
	}
	...
	public static final void isPositive(int value, String message) {
	    if(value <= 0) { 
            final String msg = message != null ? 
                               message :
                               CoreModelerPlugin.Util.getString("ArgCheck.isPositiveInt"); //$NON-NLS-1$
	        throw new IllegalArgumentException(msg);
	    }
	}
	...
	public static final void isNotZeroLength(String value, String message) {
		...
		if(value.length() <= 0) {
            final String msg = message != null ? 
                               message :
                               CoreModelerPlugin.Util.getString("ArgCheck.isStringNonZeroLength"); //$NON-NLS-1$
            throw new IllegalArgumentException(msg);
		}
	}
	...
	public static final void isNotNull(Object value, String message) {
	    if(value == null) { 
            final String msg = message != null ? 
                               message :
                               CoreModelerPlugin.Util.getString("ArgCheck.isNonNull"); //$NON-NLS-1$
            throw new IllegalArgumentException(msg);
	    }
	}
    ...
    public static final void isNull(Object value, String message) {
        if(value != null) { 
            final String msg = message != null ? 
                               message :
                               CoreModelerPlugin.Util.getString("ArgCheck.isNull"); //$NON-NLS-1$
            throw new IllegalArgumentException(msg);
        }
    }
	...
	public static final void isInstanceOf(Class theClass, Object value, String message) {
	    ...
	    if( ! theClass.isInstance(value) ) {
            final String msg = message != null ? 
                               message :
                               CoreModelerPlugin.Util.getString("ArgCheck.isInstanceOf", theClass.getName(),value.getClass().getName()); //$NON-NLS-1$
	        throw new IllegalArgumentException(msg);
	    }
	}
    ...
    public static final void isNotEmpty(Collection collection, String message) {
        ...
        if(collection.isEmpty()) {
            final String msg = message != null ? 
                               message :
                               CoreModelerPlugin.Util.getString("ArgCheck.isCollectionNotEmpty"); //$NON-NLS-1$
            throw new IllegalArgumentException(msg);
        }
    }
    ...
    public static final void isNotEmpty(Map map, String message) {
        ...
        if(map.isEmpty()) {
            final String msg = message != null ? 
                               message :
                               CoreModelerPlugin.Util.getString("ArgCheck.isMapNotEmpty"); //$NON-NLS-1$
            throw new IllegalArgumentException(msg);
        }
    }
    ...
    public static final void isNotEmpty(Object[] array, String message) {
        ...
        if(array.length == 0) {
            final String msg = message != null ? 
                               message :
                               CoreModelerPlugin.Util.getString("ArgCheck.isArrayNotEmpty"); //$NON-NLS-1$
            throw new IllegalArgumentException(msg);
        }
    }
    ...
    public static void isNotSame(final Object firstObject, String firstName, final Object secondObject, String secondName) {
        if (firstObject == secondObject) {
            ...
            throw new IllegalArgumentException(CoreModelerPlugin.Util.getString("ArgCheck.isNotSame", firstName, secondName )); //$NON-NLS-1$
        }
    }
    ...
    public static final void contains(Collection collection, Object value, String message) {
		...
		if(! collection.contains(value)) {
            final String msg = message != null ? 
                               message :
                               CoreModelerPlugin.Util.getString("ArgCheck.contains"); //$NON-NLS-1$
            throw new IllegalArgumentException(msg);
		}
	}
	...
	public static final void containsKey(Map map, Object key, String message) {
		...
		if(! map.containsKey(key)) {
            final String msg = message != null ? 
                               message :
                               CoreModelerPlugin.Util.getString("ArgCheck.containsKey"); //$NON-NLS-1$
            throw new IllegalArgumentException(msg);
		}
	}
