 ...
 * <ul>
 *   <li>{@link com.metamatrix.metamodels.wsdl.impl.BindingOutputImpl#getDocumentation <em>Documentation</em>}</li>
 *   <li>{@link com.metamatrix.metamodels.wsdl.impl.BindingOutputImpl#getDeclaredNamespaces <em>Declared Namespaces</em>}</li>
 *   <li>{@link com.metamatrix.metamodels.wsdl.impl.BindingOutputImpl#getElements <em>Elements</em>}</li>
 *   <li>{@link com.metamatrix.metamodels.wsdl.impl.BindingOutputImpl#getMimeElements <em>Mime Elements</em>}</li>
 *   <li>{@link com.metamatrix.metamodels.wsdl.impl.BindingOutputImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.metamatrix.metamodels.wsdl.impl.BindingOutputImpl#getSoapHeader <em>Soap Header</em>}</li>
 *   <li>{@link com.metamatrix.metamodels.wsdl.impl.BindingOutputImpl#getSoapBody <em>Soap Body</em>}</li>
 *   <li>{@link com.metamatrix.metamodels.wsdl.impl.BindingOutputImpl#getBindingOperation <em>Binding Operation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BindingOutputImpl extends EObjectImpl implements BindingOutput {
	...
	public NotificationChain basicSetDocumentation(Documentation newDocumentation, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WsdlPackage.BINDING_OUTPUT__DOCUMENTATION, oldDocumentation, newDocumentation);
	...
	public void setDocumentation(Documentation newDocumentation) {
        if (newDocumentation != documentation) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, WsdlPackage.BINDING_OUTPUT__DOCUMENTATION, newDocumentation, newDocumentation));
    }
	...
	public EList getDeclaredNamespaces() {
        if (declaredNamespaces == null) {
            declaredNamespaces = new EObjectContainmentWithInverseEList(NamespaceDeclaration.class, this, WsdlPackage.BINDING_OUTPUT__DECLARED_NAMESPACES, WsdlPackage.NAMESPACE_DECLARATION__OWNER);
        }
	...
	public EList getElements() {
        if (elements == null) {
            elements = new EObjectContainmentWithInverseEList(Element.class, this, WsdlPackage.BINDING_OUTPUT__ELEMENTS, WsdlPackage.ELEMENT__ELEMENT_OWNER);
        }
        return elements;
    }
	...
	public EList getMimeElements() {
        if (mimeElements == null) {
            mimeElements = new EObjectContainmentWithInverseEList(MimeElement.class, this, WsdlPackage.BINDING_OUTPUT__MIME_ELEMENTS, MimePackage.MIME_ELEMENT__MIME_ELEMENT_OWNER);
        }
        return mimeElements;
    }
	...
	public NotificationChain basicSetSoapHeader(SoapHeader newSoapHeader, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WsdlPackage.BINDING_OUTPUT__SOAP_HEADER, oldSoapHeader, newSoapHeader);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
	...
	public void setSoapHeader(SoapHeader newSoapHeader) {
        if (newSoapHeader != soapHeader) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, WsdlPackage.BINDING_OUTPUT__SOAP_HEADER, newSoapHeader, newSoapHeader));
    }
	...
	public NotificationChain basicSetSoapBody(SoapBody newSoapBody, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WsdlPackage.BINDING_OUTPUT__SOAP_BODY, oldSoapBody, newSoapBody);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
	...
	public void setSoapBody(SoapBody newSoapBody) {
        if (newSoapBody != soapBody) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, WsdlPackage.BINDING_OUTPUT__SOAP_BODY, newSoapBody, newSoapBody));
    }
	...
	public BindingOperation getBindingOperation() {
        if (eContainerFeatureID != WsdlPackage.BINDING_OUTPUT__BINDING_OPERATION) return null;
	...
	public void setBindingOperation(BindingOperation newBindingOperation) {
        if (newBindingOperation != eContainer || (eContainerFeatureID != WsdlPackage.BINDING_OUTPUT__BINDING_OPERATION && newBindingOperation != null)) {
            ...
            if (newBindingOperation != null)
                msgs = ((InternalEObject)newBindingOperation).eInverseAdd(this, WsdlPackage.BINDING_OPERATION__BINDING_OUTPUT, BindingOperation.class, msgs);
            msgs = eBasicSetContainer((InternalEObject)newBindingOperation, WsdlPackage.BINDING_OUTPUT__BINDING_OPERATION, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, WsdlPackage.BINDING_OUTPUT__BINDING_OPERATION, newBindingOperation, newBindingOperation));
    }
    ...
    public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
        if (featureID >= 0) {
            switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
                case WsdlPackage.BINDING_OUTPUT__DOCUMENTATION:
                    if (documentation != null)
                        msgs = ((InternalEObject)documentation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WsdlPackage.BINDING_OUTPUT__DOCUMENTATION, null, msgs);
                    return basicSetDocumentation((Documentation)otherEnd, msgs);
                case WsdlPackage.BINDING_OUTPUT__DECLARED_NAMESPACES:
                    return ((InternalEList)getDeclaredNamespaces()).basicAdd(otherEnd, msgs);
                case WsdlPackage.BINDING_OUTPUT__ELEMENTS:
                    return ((InternalEList)getElements()).basicAdd(otherEnd, msgs);
                case WsdlPackage.BINDING_OUTPUT__MIME_ELEMENTS:
                    return ((InternalEList)getMimeElements()).basicAdd(otherEnd, msgs);
                case WsdlPackage.BINDING_OUTPUT__SOAP_HEADER:
                    if (soapHeader != null)
                        msgs = ((InternalEObject)soapHeader).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WsdlPackage.BINDING_OUTPUT__SOAP_HEADER, null, msgs);
                    return basicSetSoapHeader((SoapHeader)otherEnd, msgs);
                case WsdlPackage.BINDING_OUTPUT__SOAP_BODY:
                    if (soapBody != null)
                        msgs = ((InternalEObject)soapBody).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WsdlPackage.BINDING_OUTPUT__SOAP_BODY, null, msgs);
                    return basicSetSoapBody((SoapBody)otherEnd, msgs);
                case WsdlPackage.BINDING_OUTPUT__BINDING_OPERATION:
                    if (eContainer != null)
                        msgs = eBasicRemoveFromContainer(msgs);
                    return eBasicSetContainer(otherEnd, WsdlPackage.BINDING_OUTPUT__BINDING_OPERATION, msgs);
                default:
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
        if (featureID >= 0) {
            switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
                ...
                case WsdlPackage.BINDING_OUTPUT__BINDING_OPERATION:
                    return eBasicSetContainer(null, WsdlPackage.BINDING_OUTPUT__BINDING_OPERATION, msgs);
                default:
    ...
    public NotificationChain eBasicRemoveFromContainer(NotificationChain msgs) {
        if (eContainerFeatureID >= 0) {
            switch (eContainerFeatureID) {
                case WsdlPackage.BINDING_OUTPUT__BINDING_OPERATION:
                    return eContainer.eInverseRemove(this, WsdlPackage.BINDING_OPERATION__BINDING_OUTPUT, BindingOperation.class, msgs);
                default:
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class baseClass) {
        if (baseClass == NamespaceDeclarationOwner.class) {
            switch (derivedFeatureID) {
                case WsdlPackage.BINDING_OUTPUT__DECLARED_NAMESPACES: return WsdlPackage.NAMESPACE_DECLARATION_OWNER__DECLARED_NAMESPACES;
                default: return -1;
            }
        }
        if (baseClass == ElementOwner.class) {
            switch (derivedFeatureID) {
                case WsdlPackage.BINDING_OUTPUT__ELEMENTS: return WsdlPackage.ELEMENT_OWNER__ELEMENTS;
                default: return -1;
            }
        }
        if (baseClass == MimeElementOwner.class) {
            switch (derivedFeatureID) {
                case WsdlPackage.BINDING_OUTPUT__MIME_ELEMENTS: return MimePackage.MIME_ELEMENT_OWNER__MIME_ELEMENTS;
                default: return -1;
            }
        }
        if (baseClass == WsdlNameOptionalEntity.class) {
            switch (derivedFeatureID) {
                case WsdlPackage.BINDING_OUTPUT__NAME: return WsdlPackage.WSDL_NAME_OPTIONAL_ENTITY__NAME;
                default: return -1;
            }
        }
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class baseClass) {
        if (baseClass == NamespaceDeclarationOwner.class) {
            switch (baseFeatureID) {
                case WsdlPackage.NAMESPACE_DECLARATION_OWNER__DECLARED_NAMESPACES: return WsdlPackage.BINDING_OUTPUT__DECLARED_NAMESPACES;
                default: return -1;
            }
        }
        if (baseClass == ElementOwner.class) {
            switch (baseFeatureID) {
                case WsdlPackage.ELEMENT_OWNER__ELEMENTS: return WsdlPackage.BINDING_OUTPUT__ELEMENTS;
                default: return -1;
            }
        }
        if (baseClass == MimeElementOwner.class) {
            switch (baseFeatureID) {
                case MimePackage.MIME_ELEMENT_OWNER__MIME_ELEMENTS: return WsdlPackage.BINDING_OUTPUT__MIME_ELEMENTS;
                default: return -1;
            }
        }
        if (baseClass == WsdlNameOptionalEntity.class) {
            switch (baseFeatureID) {
                case WsdlPackage.WSDL_NAME_OPTIONAL_ENTITY__NAME: return WsdlPackage.BINDING_OUTPUT__NAME;
                default: return -1;
            }
        }
