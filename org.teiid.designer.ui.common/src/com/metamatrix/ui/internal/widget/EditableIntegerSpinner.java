 ...
 * IntegerSpinner
 */
public class EditableIntegerSpinner extends EditableSpinner {

    ///////////////////////////////////////////////////////////////////////////////////////////////
    // CONSTANTS
    ///////////////////////////////////////////////////////////////////////////////////////////////
    
    private static final String PREFIX = I18nUtil.getPropertyPrefix(EditableIntegerSpinner.class);
    ...
    */
    public EditableIntegerSpinner( Composite theParent,
                                   int theMin, 
                                   int theMax ) {
        super( theParent );
    ...
    public void resetLimits(int theMin, int theMax) {
        configureIntegerSpinner(theMin, theMax);
    }
}
