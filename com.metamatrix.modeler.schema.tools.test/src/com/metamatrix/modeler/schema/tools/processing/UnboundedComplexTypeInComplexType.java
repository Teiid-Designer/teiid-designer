...
public class UnboundedComplexTypeInComplexType extends BaseSchemaProcessingTestClass {
    ...
    protected List getSchemaPaths() {
        ...
        paths.add("./src/sources/UnboundedComplexTypeInComplexType.xsd"); //$NON-NLS-1$
        return paths;
    }
