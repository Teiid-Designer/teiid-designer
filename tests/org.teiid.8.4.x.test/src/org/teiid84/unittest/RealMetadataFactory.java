...
import org.teiid84.resolver.FakeFunctionMetadataSource;
...
public class RealMetadataFactory {
    ...
    public static MetadataStore exampleBQTStore() {
        ...
        ProcedureParameter nativeparam = createParameter("param", ISPParameter.ParameterInfo.IN, DataTypeManager.DefaultDataTypes.STRING); //$NON-NLS-1$
        ProcedureParameter vardic = createParameter("varag", ISPParameter.ParameterInfo.IN, DataTypeManager.DefaultDataTypes.OBJECT); //$NON-NLS-1$
     ...
     // Create physical elements
        ...
        ProcedureParameter rsp1 = createParameter("ret", ISPParameter.ParameterInfo.RETURN_VALUE, DataTypeManager.DefaultDataTypes.INTEGER);  //$NON-NLS-1$
        ProcedureParameter rsp2 = createParameter("inkey", ISPParameter.ParameterInfo.IN, DataTypeManager.DefaultDataTypes.INTEGER); //$NON-NLS-1$
