...
public class TestJdbcRelationalPlugin extends TestCase {
    ...
    public void helpTestGetString( final String key,
        ...
        final String actualValue = org.teiid.designer.jdbc.relational.ModelerJdbcRelationalConstants.Util.getString(key);
        if (actualValue == null) {
    ...
    public void testNonPlatformGetStringWithZeroLengthKey() {
        ...
        final String expectedValue = "<Missing message for key \"\" in: org.teiid.designer.jdbc.relational.i18n>"; //$NON-NLS-1$
        helpTestGetString(key, expectedValue);
    }
    ...
    public void testNonPlatformLogIStatus_ErrorWithMessageWithoutThrowable() {
        ...
        org.teiid.designer.jdbc.relational.ModelerJdbcRelationalConstants.Util.log(status);
    }
    ...
    public void testNonPlatformLogStringObject() {
        ...
        org.teiid.designer.jdbc.relational.ModelerJdbcRelationalConstants.Util.log(obj);
    }
    ...
    public void testNonPlatformLogThrowable() {
        final Throwable t = new Throwable("This is the throwable"); //$NON-NLS-1$
        t.fillInStackTrace();
        org.teiid.designer.jdbc.relational.ModelerJdbcRelationalConstants.Util.log(t);
    }
