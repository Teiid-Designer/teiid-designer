...
public class FakeResourceDescriptor extends ResourceDescriptorImpl {
    ...
    /* (non-Javadoc)
     * @See org.teiid.designer.core.container.ResourceDescriptor#getExtensions()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @See org.teiid.designer.core.container.ResourceDescriptor#getProtocols()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @See org.teiid.designer.core.container.ResourceDescriptor#getResourceFactory()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @See org.teiid.designer.core.container.ResourceDescriptor#getUniqueIdentifier()
     */
    @Override
