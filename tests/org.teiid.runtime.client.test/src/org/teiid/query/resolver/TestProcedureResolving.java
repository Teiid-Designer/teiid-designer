...
public class TestProcedureResolving {
    ...
    @Test public void testCase5474() throws Exception {
        ...
        AbstractTestResolver.helpResolve(procedure, RealMetadataFactory.example1Cached());
    }
    ...
    @Test public void testProcWithReturn() throws Exception {
        ...
        AbstractTestResolver.helpResolve(procedure, RealMetadataFactory.exampleBQTCached());
    }
    ...
    @Test public void testVariableResolutionWithIntervening() throws Exception {
        ...
        AbstractTestResolver.helpResolve(proc.toString(), RealMetadataFactory.example1Cached()); 
    }
    ...
    @Test public void testOptionalParams() throws Exception {
        ...
        StoredProcedure sp = (StoredProcedure) AbstractTestResolver.helpResolve(sql, tm);
        ...
        sp = (StoredProcedure) AbstractTestResolver.helpResolve(sql, tm);
