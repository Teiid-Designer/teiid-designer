...
public class TestCriteriaOperator extends TestCase {
    ...
    public void testGetOperator() {
        ExpectedResults[] expectedResults = new ExpectedResults[] {
            ...
            new ExpectedResults(version("8.0.0"), Operator.values().length - 5, "like", "in", "is", "between", ""), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$
            new ExpectedResults(version("8.x.0"), Operator.values().length - 5, "like", "in", "is", "between", "") //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$
        };
