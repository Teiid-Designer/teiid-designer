...
import org.teiid.runtime.client.lang.SPParameter.ParameterInfo;
...
public abstract class AbstractTest<T extends LanguageObject> extends TestCase {
    ...
    public void testInnerJoin() {
        ...
        helpTest("SELECT * FROM g1 inner join g2 on g1.a1=g2.a2", "SELECT * FROM g1 INNER JOIN g2 ON g1.a1 = g2.a2", (T) query);
    }
    ...
    public void testCrossJoin() {
        ...
        helpTest("SELECT * FROM g1 cross join g2", "SELECT * FROM g1 CROSS JOIN g2", (T) query);
    }
    ...
    public void testFromClauses() {
        ...
        helpTest("SELECT * FROM (g1 cross join g2), g3", "SELECT * FROM g1 CROSS JOIN g2, g3", (T) query);
    }
    ...
    public void testMultiCrossJoin() {
        ...
        helpTest("SELECT * FROM (g1 cross join g2) cross join g3", "SELECT * FROM (g1 CROSS JOIN g2) CROSS JOIN g3", (T) query);
    }
    ...
    public void testMixedJoin3() {
        ...
        helpTest("SELECT * FROM g1, g2 inner join g3 on g2.a=g3.a", "SELECT * FROM g1, g2 INNER JOIN g3 ON g2.a = g3.a", (T) query);
    }
    ...
    public void testFullJoin() {
        ...
        helpTest("Select g.a, h.b from g full join h on g.x=h.x", "SELECT g.a, h.b FROM g FULL OUTER JOIN h ON g.x = h.x", (T) query);
    }
    ...
    public void testConversionFunction() {
        ...
        Query query = getFactory().newQuery(select, from);
        helpTest("SELECT CONVERT(a, string) FROM g", "SELECT CONVERT(a, string) FROM g", (T) query);
    }
    ...
    public void testMultiFunction() {
        ...
        Query query = getFactory().newQuery(select, from);
        helpTest("SELECT 5 + length(concat(a, 'x')) FROM g", "SELECT (5 + length(concat(a, 'x'))) FROM g", (T) query);
    }
    ...
    public void testAliasedFunction() {
        ...
        Query query = getFactory().newQuery(select, from);
        helpTest("SELECT REPLACE(a, 'x', 'y') AS y FROM g", "SELECT REPLACE(a, 'x', 'y') AS y FROM g", (T) query);
    }
    ...
    public void testCastFunction() {
        ...
        Query query = getFactory().newQuery(select, from);
        helpTest("SELECT cast(a as string) FROM g", "SELECT cast(a AS string) FROM g", (T) query);
    }
    ...
    public void testLeftFunction() {
        ...
        Query query = getFactory().newQuery(select, from);
        helpTest("SELECT left(fullname, 3) as x FROM sys.groups", "SELECT left(fullname, 3) AS x FROM sys.groups", (T) query);
    }
    ...
    public void testRightFunction() {
        ...
        Query query = getFactory().newQuery(select, from);
        helpTest("SELECT right(fullname, 3) as x FROM sys.groups", "SELECT right(fullname, 3) AS x FROM sys.groups", (T) query);
    }
    ...
    public void testCharFunction() {
        ...
        Query query = getFactory().newQuery(select, from);
        helpTest("SELECT char('x') AS x FROM sys.groups", "SELECT char('x') AS x FROM sys.groups", (T) query);
    }
    ...
    public void testInsertFunction() {
        ...
        Query query = getFactory().newQuery(select, from);
        helpTest("SELECT insert('x', 1, 'a') AS x FROM sys.groups", "SELECT insert('x', 1, 'a') AS x FROM sys.groups", (T) query);
    }
    ...
    public void testInsertIntoSelect() {
        ...
        helpTest("insert into tempA SELECT 1", "INSERT INTO tempA SELECT 1", (T) insert);
    }
    ...
    public void testTranslateFunction() {
        ...
        Query query = getFactory().newQuery(select, from);
        helpTest("SELECT translate('x', 'x', 'y') FROM sys.groups", "SELECT translate('x', 'x', 'y') FROM sys.groups", (T) query);
    }
    ...
    public void testArithmeticOperatorPrecedence1() {
        ...
        Query query = getFactory().newQuery(select, from);
        helpTest("SELECT 5 + 2 + 3 FROM g", "SELECT ((5 + 2) + 3) FROM g", (T) query);
    }
    ...
    public void testArithmeticOperatorPrecedenceMixed1() {
        ...
        Query query = getFactory().newQuery(select, from);
        helpTest("SELECT 1 + 2 * 3 + 4 * 5 FROM g", "SELECT ((1 + (2 * 3)) + (4 * 5)) FROM g", (T) query);
    }
    ...
    public void testLeftAssociativeExpressions1() {
        ...
        Query query = getFactory().newQuery(select, from);
        helpTest("SELECT 5 - 4 - 3 - 2 FROM g", "SELECT (((5 - 4) - 3) - 2) FROM g", (T) query);
    }
    ...
    public void testConcatOperator1() {
        ...
        Query query = getFactory().newQuery(select, from);
        helpTest("SELECT 'a' || 'b' || 'c' FROM g", "SELECT (('a' || 'b') || 'c') FROM g", (T) query);
    }
    ...
    public void testMixedOperators1() {
        ...
        Query query = getFactory().newQuery(select, from);
        helpTest("SELECT 2 + 3 || 5 + 1 * 2 FROM g", "SELECT ((2 + 3) || (5 + (1 * 2))) FROM g", (T) query);
    }
    ...
    public void testGroupBy() {
        ...
        helpTest("SELECT a FROM m.g GROUP BY b, c", "SELECT a FROM m.g GROUP BY b, c", (T) query);
    }
    ...
    public void testGroupByHaving() {
        ...
        helpTest("SELECT a FROM m.g GROUP BY b, c HAVING b=5", "SELECT a FROM m.g GROUP BY b, c HAVING b = 5", (T) query);
    }
    ...
    public void testAggregateFunction() {
        ...
        Query query = getFactory().newQuery(select, from);
        helpTest("SELECT COUNT(a) AS c FROM m.g", "SELECT COUNT(a) AS c FROM m.g", (T) query);
    }
    ...
    public void testHavingFunction() {
        ...
        helpTest("SELECT a FROM m.g GROUP BY a HAVING COUNT(b) > 0", "SELECT a FROM m.g GROUP BY a HAVING COUNT(b) > 0", (T) query);
    }
    ...
    public void testFunctionOfAggregates() {
        ...
        Query query = getFactory().newQuery(select, from);
        helpTest("SELECT COUNT(a) * SUM(a) AS c FROM m.g", "SELECT (COUNT(a) * SUM(a)) AS c FROM m.g", (T) query);
    ...
    public void testArithmeticNullFunction() {
        ...
        helpTest("SELECT 5-null, a.g1.c1 FROM a.g1", "SELECT (5 - null), a.g1.c1 FROM a.g1", (T) query);
    }
    ...
    public void testStringLiteral() {
        ...
        helpTest("SELECT 'abc' FROM a.g1", "SELECT 'abc' FROM a.g1", (T) query);
    }
    ...
    public void testStringLiteralEscapedTick() {
        ...
        helpTest("SELECT 'O''Leary' FROM a.g1", "SELECT 'O''Leary' FROM a.g1", (T) query);
    }
    ...
    public void testStringLiteralEscapedTick3() {
        ...
        helpTest("SELECT 'a''b''c' FROM a.g1", "SELECT 'a''b''c' FROM a.g1", (T) query);
    }
    ...
    public void testStringLiteralEscapedTick4() {
        ...
        helpTest("SELECT \" \"\" \" FROM a.g1", "SELECT \" \"\" \" FROM a.g1", (T) query);
    }
    ...
    public void testLongLiteral() {
        ...
        helpTest("SELECT 123456789012 FROM a.g1", "SELECT 123456789012 FROM a.g1", (T) query);
    }
    ...
    public void testBigIntegerLiteral() {
        ...
        helpTest("SELECT 1000000000000000000000000 FROM a.g1", "SELECT 1000000000000000000000000 FROM a.g1", (T) query);
    }
    ...
    public void testDateLiteral1() {
        ...
        helpTest("SELECT {d'2002-10-02'} FROM m.g1", "SELECT {d'2002-10-02'} FROM m.g1", (T) query);
    }
    ...
    public void testDateLiteral2() {
        ...
        helpTest("SELECT {d'2002-09-01'} FROM m.g1", "SELECT {d'2002-09-01'} FROM m.g1", (T) query);
    }
    ...
    public void testTimeLiteral1() {
        ...
        helpTest("SELECT {t '11:10:00' } FROM m.g1", "SELECT {t'11:10:00'} FROM m.g1", (T) query);
    }
    ...
    public void testTimeLiteral2() {
        ...
        helpTest("SELECT {t '05:10:00'} FROM m.g1", "SELECT {t'05:10:00'} FROM m.g1", (T) query);
    }
    ...
    public void testTimestampLiteral() {
        ...
        helpTest("SELECT {ts'2002-10-02 19:00:02.50'} FROM m.g1", "SELECT {ts'2002-10-02 19:00:02.5'} FROM m.g1", (T) query);
    }
    ...
    public void testSelectDistinct() {
        ...
        Query query = getFactory().newQuery(select, from);
        helpTest("SELECT DISTINCT a FROM g", "SELECT DISTINCT a FROM g", (T) query);
    }
    ...
    public void testSelectAll() {
        ...
        Query query = getFactory().newQuery(select, from);
        helpTest("SELECT ALL a FROM g", "SELECT a FROM g", (T) query);
    }
    ...
    public void testAliasInSelect() {
        ...
        Query query = getFactory().newQuery(select, from);
        helpTest("SELECT a AS myA, b FROM g", "SELECT a AS myA, b FROM g", (T) query);
    }
    ...
    public void testAliasInSelect2() {
        ...
        Query query = getFactory().newQuery(select, from);
        helpTest("SELECT a myA, b FROM g, h", "SELECT a AS myA, b FROM g, h", (T) query);
    }
    ...
    public void testAliasInFrom() {
        ...
        Query query = getFactory().newQuery(select, from);
        helpTest("SELECT myG.a FROM g AS myG", "SELECT myG.a FROM g AS myG", (T) query);
    }
    ...
    public void testAliasesInFrom() {
        ...
        Query query = getFactory().newQuery(select, from);
        helpTest("SELECT myG.*, myH.b FROM g AS myG, h AS myH", "SELECT myG.*, myH.b FROM g AS myG, h AS myH", (T) query);
    }
    ...
    public void testHiddenAliasesInFrom() {
        ...
        Query query = getFactory().newQuery(select, from);
        helpTest("SELECT myG.*, myH.b FROM g myG, h myH", "SELECT myG.*, myH.b FROM g AS myG, h AS myH", (T) query);
    }
    ...
    public void testIsNullCriteria1() {
        ...
        helpTest("Select a From db.g Where a IS NULL", "SELECT a FROM db.g WHERE a IS NULL", (T) query);
    }
    ...
    public void testIsNullCriteria2() {
        ...
        Query query = getFactory().newQuery(select, from);
        query.setCriteria(crit);
        helpTest("Select a From db.g Where a IS NOT NULL", "SELECT a FROM db.g WHERE a IS NOT NULL", (T) query);
    }
    ...
    public void testNotIsNullCriteria() {
        ...
        Query query = getFactory().newQuery(select, from);
        query.setCriteria(crit);
        helpTest("Select a From db.g Where Not a IS NULL", "SELECT a FROM db.g WHERE NOT (a IS NULL)", (T) query);
    }
    ...
    public void testStringNotEqualDoubleTicks() {
        ...
        Query query = getFactory().newQuery(select, from);
        query.setCriteria(crit);
        helpTest("SELECT a from db.g where a <> \"value\"", "SELECT a FROM db.g WHERE a <> \"value\"", (T) query);
    }
    ...
    public void testPartlyQuotedGroup() {
        ...
        Query query = getFactory().newQuery(select, from);
        query.setCriteria(crit);
        helpTest("SELECT a from db.\"g\" where a = 5", "SELECT a FROM db.g WHERE a = 5", (T) query);
    }
    ...
    public void testPartlyQuotedElement1() {
        ...
        helpTest("SELECT \"db\".g.a from db.g", "SELECT db.g.a FROM db.g", (T) query);
    }
    ...
    public void testStringLiteralLikeQuotedElement() {
        ...
        helpTest("SELECT \"g\"\".\"\"a\" from g", "SELECT \"g\"\"\".\"\"\"a\" FROM g", (T) query);
    }
    ...
    public void testStringLiteralLikeQuotedElement1() {
        ...
        helpTest("SELECT \"g\"\".\"\"a\" from g", "SELECT 'g\".\"a' FROM g", (T) query, info);
    }
    ...
    public void testQuotedAlias() {
        ...
        helpTest("SELECT g.x AS \"select\" FROM g", "SELECT g.x AS \"select\" FROM g", (T) query);
    }
    ...
    public void testQuotedAlias2() {
        ...
        helpTest("SELECT g.x AS \"year\" FROM g", "SELECT g.x AS \"year\" FROM g", (T) query);
    }
    ...
    public void testQuotedAlias3() {
        ...
        helpTest("SELECT g.x AS \"some year\" FROM g", "SELECT g.x AS \"some year\" FROM g", (T) query);
    }
    ...
    public void testReservedWordElement1() {
        ...
        helpTest("SELECT g.\"select\" FROM g", "SELECT g.\"select\" FROM g", (T) query);
    }
    ...
    public void testXMLCriteriaWithAttribute() {
        ...
        helpTest("SELECT * FROM model.doc WHERE ab.cd.@ef = 'abc'", "SELECT * FROM model.doc WHERE ab.cd.@ef = 'abc'", (T) query);
    }
    ...
    public void testBetween1() {
        ...
        Query query = getFactory().newQuery(select, from);
        query.setCriteria(crit);
        helpTest("SELECT a from db.g where a BETWEEN 1000 AND 2000", "SELECT a FROM db.g WHERE a BETWEEN 1000 AND 2000", (T) query);
    }
    ...
    public void testCompareLT() {
        ...
        Query query = getFactory().newQuery(select, from);
        query.setCriteria(crit);
        helpTest("SELECT a from db.g where a < 1000", "SELECT a FROM db.g WHERE a < 1000", (T) query);
    }
    ...
    protected void helpTestCompoundCompare(String testSQL) {
        ...
        Query query = getFactory().newQuery(select, from);
        query.setCriteria(crit);
        helpTest(testSQL, "SELECT a FROM db.g WHERE (b = x) AND (a = 1000)", (T) query);
    }
    ...
    public void testSetCriteria0() {
        ...
        Query query = getFactory().newQuery(select, from);
        query.setCriteria(crit);
        helpTest("SELECT a FROM db.g WHERE b IN (1000,5000)", "SELECT a FROM db.g WHERE b IN (1000, 5000)", (T) query);
    }
    ...
    public void testSetCriteria1() {
        ...
        Query query = getFactory().newQuery(select, from);
        query.setCriteria(crit);
        helpTest("SELECT a FROM db.g WHERE b NOT IN (1000,5000)", "SELECT a FROM db.g WHERE b NOT IN (1000, 5000)", (T) query);
    }
    ...
    public void testOrderBy() {
        ...
        helpTest("SELECT a FROM db.g WHERE b = aString ORDER BY c", "SELECT a FROM db.g WHERE b = aString ORDER BY c", (T) query);
    }
    ...
    public void testOrderBys() {
        ...
        Query query = getOrderByQuery(orderBy);
        helpTest("SELECT a FROM db.g WHERE b = aString ORDER BY c,d", "SELECT a FROM db.g WHERE b = aString ORDER BY c, d", (T) query);
    }
    ...
    public void testLike0() {
        ...
        Query query = getFactory().newQuery(select, from);
        query.setCriteria(crit);
        helpTest("SELECT a FROM db.g WHERE b LIKE 'aString'", "SELECT a FROM db.g WHERE b LIKE 'aString'", (T) query);
    }
    ...
    public void testLike1() {
        ...
        Query query = getFactory().newQuery(select, from);
        query.setCriteria(crit);
        helpTest("SELECT a FROM db.g WHERE b NOT LIKE 'aString'", "SELECT a FROM db.g WHERE b NOT LIKE 'aString'", (T) query);
    }
    ...
    public void testReservedWordsInElement() {
        ...
        Query query = getFactory().newQuery(select, from);
        helpTest("SELECT \"date\".\"time\" from db.g", "SELECT \"date\".\"time\" FROM db.g", (T) query);
    ...
    public void testNoFromClause() {
        ...
        Query query = getFactory().newQuery();
        query.setSelect(select);
        helpTest("SELECT a, 5", "SELECT a, 5", (T) query);
    }
    ...
    public void testOrInSelect() {
        ...
        helpTest("select a or b", "SELECT (a) OR (b)", (T) query);
    }
    ...
    public void testLikeWOConstant() {
        ...
        Query query = getFactory().newQuery(select, from);
        query.setCriteria(crit);
        helpTest("SELECT a FROM g WHERE a LIKE x", "SELECT a FROM g WHERE a LIKE x", (T) query);
    }
    ...
    public void testReusabilityOfParserObject() {
        ...
        helpTest("SELECT a FROM m.g", "SELECT a FROM m.g", (T) query);
    ...
    public void testParameter1() {
        ...
        Query query = getFactory().newQuery(select, from);
        query.setCriteria(crit);
        helpTest("SELECT a from db.g where b LIKE ?", "SELECT a FROM db.g WHERE b LIKE ?", (T) query);
    }
    ...
    public void testParameter2() {
        ...
        Query query = getFactory().newQuery(select, from);
        query.setCriteria(crit);
        helpTest("SELECT ? from db.g where b LIKE ?", "SELECT ? FROM db.g WHERE b LIKE ?", (T) query);
    }
    ...
    public void testSubquery1() {
        ...
        helpTest("SELECT a, b FROM (SELECT c FROM m.g) AS y", "SELECT a, b FROM (SELECT c FROM m.g) AS y", (T) query2);
    }
    ...
    public void testInsertWithReference() {
        ...
        helpTest("INSERT INTO m.g (a) VALUES (?)", "INSERT INTO m.g (a) VALUES (?)", (T) insert);
    }
    ...
    public void testStoredQueryWithNoParameter() {
        ...
        helpTest("exec proc1()", "EXEC proc1()", (T) storedQuery);
        helpTest("execute proc1()", "EXEC proc1()", (T) storedQuery);
    }
    ...
    public void testStoredQueryWithNoParameter2() {
        ...
        Query query = getFactory().newQuery(select, from);
        helpTest("SELECT X.A FROM (exec proc1()) AS X", "SELECT X.A FROM (EXEC proc1()) AS X", (T) query);
    }
    ...
    public void testStoredQuery() {
        ...
        helpTest("Exec proc1('param1')", "EXEC proc1('param1')", (T) storedQuery);
        helpTest("execute proc1('param1')", "EXEC proc1('param1')", (T) storedQuery);
    }
    ...
    public void testStoredQuery2() {
        ...
        Query query = getFactory().newQuery(select, from);
        helpTest("SELECT X.A FROM (exec proc1('param1')) AS X", "SELECT X.A FROM (EXEC proc1('param1')) AS X", (T) query);
    }
    ...
    public void testUnicode1() {
        try {
            ...
            helpTest(sql, query.toString(), (T) query);
    ...
    public void testEscapedFunction1() {
        ...
        helpTest(sql, "SELECT * FROM a.thing WHERE e1 = concat('a', 'b')", (T) query);
    }
    ...
    public void testEscapedFunction2() {
        ...
        helpTest(sql, "SELECT * FROM a.thing WHERE e1 = convert(5, string)", (T) query);
    }
    ...
    public void testEscapedFunction3() {
        ...
        helpTest(sql, "SELECT * FROM a.thing WHERE e1 = cast(5 AS string)", (T) query);
    }
    ...
    public void testEscapedFunction4() {
        ...
        helpTest(sql, "SELECT * FROM a.thing WHERE e1 = concat(concat('a', 'b'), 'c')", (T) query);
    }
    ...
    public void testFunctionWithUnderscore() {
        ...
        helpTest(sql, "SELECT yowza_yowza() FROM a.thing", (T) query);
    }
    ...
    public void testManyInnerJoins1() {
        ...
        helpTest(sql, sqlExpected, (T) query);
    }
    ...
    public void testScalarSubqueryExpressionInSelect() {
        ...
        helpTest("SELECT e1, (SELECT e1 FROM m.g1) FROM m.g2", "SELECT e1, (SELECT e1 FROM m.g1) FROM m.g2", (T) q2);
    }
    ...
    public void testScalarSubqueryExpressionInSelect2() {
        ...
        helpTest("SELECT (SELECT e1 FROM m.g1) FROM m.g2", "SELECT (SELECT e1 FROM m.g1) FROM m.g2", (T) q2);
    }
    ...
    public void testScalarSubqueryExpressionInSelect3() {
        ...
        helpTest("SELECT (SELECT e1 FROM m.g1), e1 FROM m.g2", "SELECT (SELECT e1 FROM m.g1), e1 FROM m.g2", (T) q2);
    }
    ...
    public void testScalarSubqueryExpressionWithAlias() {
        ...
        helpTest("SELECT e1, (SELECT e1 FROM m.g1) as X FROM m.g2", "SELECT e1, (SELECT e1 FROM m.g1) AS X FROM m.g2", (T) q2);
    }
    ...
    public void testSelectInto() {
        ...
        q.setFrom(from);
        q.setInto(into);
        helpTest("SELECT c1, c2 INTO #temp FROM m.g", "SELECT c1, c2 INTO #temp FROM m.g", (T) q);
    }
    ...
    public void testElementInDoubleQuotes() throws Exception {
        ...
        helpTest("SELECT \"foo\" FROM x", "SELECT foo FROM x", (T) query);
    }
    ...
    public void testElementInDoubleQuotes_Insert() throws Exception {
        ...
        helpTest("insert into x (\"foo\") values ('bar')", "INSERT INTO x (foo) VALUES ('bar')", (T) query);
    }
    ...
    public void testElementInDoubleQuotes_Update() throws Exception {
        ...
        helpTest("update x set \"foo\"='bar'", "UPDATE x SET foo = 'bar'", (T) query);
    }
    ...
    public void testElementInDoubleQuotes_delete() throws Exception {
        ...
        helpTest("delete from x where \"foo\"='bar'", "DELETE FROM x WHERE foo = 'bar'", (T) query);
    }
    ...
    public void testAliasInDoubleQuotes() throws Exception {
        ...
        helpTest("SELECT fooKey AS \"fooAlias\" FROM x", "SELECT fooKey AS fooAlias FROM x", (T) query);
    }
    ...
    public void testSingleQuotedConstant() throws Exception {
        ...
        helpTest("SELECT 'fooString' FROM \"x.y.z\"", "SELECT 'fooString' FROM x.y.z", (T) query);
    }
    ...
    public void testOrderByWithNumbers_InQuotes() throws Exception {
        ...
        helpTest("SELECT x, y from z order by \"1\"", "SELECT x, y FROM z ORDER BY \"1\"", (T) query);
    }
    ...
    public void testCase3281NamedVariable() {
        ...
        parameter.setParameterType(ParameterInfo.IN);
        storedQuery.setParameter(parameter);
        helpTest("Exec proc1(param1 = 'paramValue1')", "EXEC proc1(param1 => 'paramValue1')", (T) storedQuery);
        helpTest("execute proc1(param1 = 'paramValue1')", "EXEC proc1(param1 => 'paramValue1')", (T) storedQuery);
    }
    ...
    public void testCase3281QuotedNamedVariableFails2() {
        ...
        param1.setParameterType(ParameterInfo.IN);
        storedQuery.setParameter(param1);
        helpTest("Exec proc1('a' = 'b')", "EXEC proc1(('a' = 'b'))", (T) storedQuery);
    }
    ...
    public void testNameSpacedFunctionName() {
        ...
        helpTest(sql, "SELECT a.x()", (T) query);
    }
    ...
    public void testUnionJoin() {
        ...
        helpTest(sql, expected, (T) command);
    }

    @Test
    public void testCommandWithSemicolon() throws Exception {
        helpTest("select * from pm1.g1;", "SELECT * FROM pm1.g1", (T) parser.parseCommand("select * from pm1.g1"));
    }
    ...
    public void testInsertWithoutColumns() {
        ...
        helpTest("INSERT INTO m.g VALUES ('a', 'b')", "INSERT INTO m.g VALUES ('a', 'b')", (T) insert);
    }
    ...
    public void testXmlAggWithOrderBy() throws Exception {
        ...
        helpTest(sql, "SELECT XMLAGG(1 ORDER BY e2)", (T) query);
    }
    ...
    public void testTextAggWithOrderBy() throws Exception {
        ...
        helpTest(sql, "SELECT TEXTAGG(FOR e1 AS col1, e2 AS col2 DELIMITER ',' HEADER ORDER BY e2)", (T) query);
    }
    ...
    public void testArrayAggWithOrderBy() throws Exception {
        ...
        Query query = getFactory().newQuery();
        query.setSelect(getFactory().newSelect(Arrays.asList(as)));
        helpTest(sql, "SELECT ARRAY_AGG(1 ORDER BY e2)", (T) query);
    }
    ...
    public void testArrayAggWithIndexing() throws Exception {
        ...
        helpTest(sql, "SELECT array_get(ARRAY_AGG(1), 1)", (T) query);
    }
    ...
    public void testNestedTable() throws Exception {
        ...
        helpTest(sql, "SELECT * FROM TABLE(EXEC foo()) AS x", (T) query);
    }
    ...
    public void testTextTable() throws Exception {
        ...
        helpTest(sql, "SELECT * FROM TEXTTABLE(file COLUMNS x string WIDTH 1, y date WIDTH 10 SKIP 10) AS x", (T) query);
    ...
    public void testExplicitTable() throws Exception {
        ...
        query.setFrom(from);
        helpTest("TABLE X", "SELECT * FROM X", (T) query);
    }
    ...
    public void testArrayTable() throws Exception {
        ...
        tt.setName("x");
        query.setFrom(getFactory().newFrom(Arrays.asList(tt)));
        helpTest(sql, "SELECT * FROM ARRAYTABLE(null COLUMNS x string, y date) AS x", (T) query);
    }
    ...
    public void testNonReserved() throws Exception {
        ...
        helpTest(sql, "SELECT count", (T) query);
    }
    ...
    public void testAggFilter() throws Exception {
        ...
        helpTest(sql, "SELECT COUNT(*) FILTER(WHERE x = 1) FROM g", (T) query);
    }
    ...
    public void testWindowFunction() throws Exception {
        ...
        query.setFrom(getFactory().newFrom(Arrays.asList(getFactory().newUnaryFromClause(getFactory().newGroupSymbol("g")))));
        helpTest(sql, "SELECT ROW_NUMBER() OVER (PARTITION BY x ORDER BY y) FROM g", (T) query);
    }
    ...
    public void testSubString() {
        ...
        helpTest(sql, "SELECT substring(RTRIM(MED.BATDAT), 4, 4) FROM FCC.MEDMAS AS MED", (T) query);
    }
}
