...
public abstract class AbstractTestSQLStringVisitor extends TestCase {
    ...
    protected void helpTest(String expectedSql, LanguageObject expectedNode) {
        helpTest(expectedSql, expectedNode, new ParseInfo());
    }

    protected void helpTest(String expectedSql, LanguageObject expectedNode, ParseInfo info) {
    ...
    public void testInnerJoin() {
        ...
        helpTest("SELECT * FROM g1 INNER JOIN g2 ON g1.a1 = g2.a2", query);
    }
    ...
    public void testCrossJoin() {
        ...
        helpTest("SELECT * FROM g1 CROSS JOIN g2", query);
    }
    ...
    public void testFromClauses() {
        ...
        helpTest("SELECT * FROM g1 CROSS JOIN g2, g3", query);
    }
...
//    }
    ...
    public void testMultiCrossJoin() {
        ...
        helpTest("SELECT * FROM (g1 CROSS JOIN g2) CROSS JOIN g3", query);
    }
    ...
    public void testMixedJoin3() {
        ...
        helpTest("SELECT * FROM g1, g2 INNER JOIN g3 ON g2.a = g3.a", query);
    }
    ...
    public void testFullJoin() {
        ...
        helpTest("SELECT g.a, h.b FROM g FULL OUTER JOIN h ON g.x = h.x", query);
    }
    ...
    public void testConversionFunction() {
        ...
        Query query = getFactory().newQuery(select, from);
        helpTest("SELECT CONVERT(a, string) FROM g", query);
    }
    ...
    public void testMultiFunction() {
        ...
        Query query = getFactory().newQuery(select, from);
        helpTest("SELECT (5 + length(concat(a, 'x'))) FROM g", query);
    }
    ...
    public void testAliasedFunction() {
        ...
        Query query = getFactory().newQuery(select, from);
        helpTest("SELECT REPLACE(a, 'x', 'y') AS y FROM g", query);
    }
    ...
    public void testCastFunction() {
        ...
        Query query = getFactory().newQuery(select, from);
        helpTest("SELECT cast(a AS string) FROM g", query);
    }
    ...
    public void testLeftFunction() {
        ...
        Query query = getFactory().newQuery(select, from);
        helpTest("SELECT left(fullname, 3) AS x FROM sys.groups", query);
    }
    ...
    public void testRightFunction() {
        ...
        Query query = getFactory().newQuery(select, from);
        helpTest("SELECT right(fullname, 3) AS x FROM sys.groups", query);
    }
    ...
    public void testCharFunction() {
        ...
        Query query = getFactory().newQuery(select, from);
        helpTest("SELECT char('x') AS x FROM sys.groups", query);
    }
    ...
    public void testInsertFunction() {
        ...
        Query query = getFactory().newQuery(select, from);
        helpTest("SELECT insert('x', 1, 'a') AS x FROM sys.groups", query);
    }
    ...
    public void testInsertIntoSelect() {
        ...
        helpTest("INSERT INTO tempA SELECT 1", insert);
    }
    ...
    public void testTranslateFunction() {
        ...
        Query query = getFactory().newQuery(select, from);
        helpTest("SELECT translate('x', 'x', 'y') FROM sys.groups", query);
    }
    ...
    public void testArithmeticOperatorPrecedence1() {
        ...
        Query query = getFactory().newQuery(select, from);
        helpTest("SELECT ((5 + 2) + 3) FROM g", query);
    }
    ...
    public void testArithmeticOperatorPrecedenceMixed1() {
        ...
        Query query = getFactory().newQuery(select, from);
        helpTest("SELECT ((1 + (2 * 3)) + (4 * 5)) FROM g", query);
    }
    ...
    public void testLeftAssociativeExpressions1() {
        ...
        Query query = getFactory().newQuery(select, from);
        helpTest("SELECT (((5 - 4) - 3) - 2) FROM g", query);
    }
    ...
    public void testConcatOperator1() {
        ...
        Query query = getFactory().newQuery(select, from);
        helpTest("SELECT (('a' || 'b') || 'c') FROM g", query);
    }
    ...
    public void testMixedOperators1() {
        ...
        Query query = getFactory().newQuery(select, from);
        helpTest("SELECT ((2 + 3) || (5 + (1 * 2))) FROM g", query);
    }
    ...
    public void testGroupBy() {
        ...
        helpTest("SELECT a FROM m.g GROUP BY b, c", query);
    }
    ...
    public void testGroupByHaving() {
        ...
        helpTest("SELECT a FROM m.g GROUP BY b, c HAVING b = 5", query);
    }
    ...
    public void testAggregateFunction() {
        ...
        Query query = getFactory().newQuery(select, from);
        helpTest("SELECT COUNT(a) AS c FROM m.g", query);
    }
    ...
    public void testHavingFunction() {
        ...
        helpTest("SELECT a FROM m.g GROUP BY a HAVING COUNT(b) > 0", query);
    }
...
//    }
    ...
    public void testFunctionOfAggregates() {
        ...
        Query query = getFactory().newQuery(select, from);
        helpTest("SELECT (COUNT(a) * SUM(a)) AS c FROM m.g", query);
    ...
    public void testArithmeticNullFunction() {
        ...
        helpTest("SELECT (5 - null), a.g1.c1 FROM a.g1", query);
    }
    ...
    public void testStringLiteral() {
        ...
        helpTest("SELECT 'abc' FROM a.g1", query);
    }
    ...
    public void testStringLiteralEscapedTick() {
        ...
        helpTest("SELECT 'O''Leary' FROM a.g1", query);
    }
    ...
    public void testStringLiteralEscapedTick3() {
        ...
        helpTest("SELECT 'a''b''c' FROM a.g1", query);
    }
    ...
    public void testStringLiteralEscapedTick4() {
        ...
        helpTest("SELECT \" \"\" \" FROM a.g1", query);
    }
    ...
    public void testLongLiteral() {
        ...
        helpTest("SELECT 123456789012 FROM a.g1", query);
    }
    ...
    public void testBigIntegerLiteral() {
        ...
        helpTest("SELECT 1000000000000000000000000 FROM a.g1", query);
    }
    ...
    public void testDateLiteral1() {
        ...
        helpTest("SELECT {d'2002-10-02'} FROM m.g1", query);
    }
    ...
    public void testDateLiteral2() {
        ...
        helpTest("SELECT {d'2002-09-01'} FROM m.g1", query);
    }
...
//    }
    ...
    public void testTimeLiteral1() {
        ...
        helpTest("SELECT {t'11:10:00'} FROM m.g1", query);
    }
    ...
    public void testTimeLiteral2() {
        ...
        helpTest("SELECT {t'05:10:00'} FROM m.g1", query);
    }
...
//    }
    ...
    public void testTimestampLiteral() {
        ...
        helpTest("SELECT {ts'2002-10-02 19:00:02.5'} FROM m.g1", query);
    }
...
//    }
    ...
    public void testSelectDistinct() {
        ...
        Query query = getFactory().newQuery(select, from);
        helpTest("SELECT DISTINCT a FROM g", query);
    }
    ...
    public void testSelectAll() {
        ...
        Query query = getFactory().newQuery(select, from);
        helpTest("SELECT a FROM g", query);
    }
    ...
    public void testAliasInSelect() {
        ...
        Query query = getFactory().newQuery(select, from);
        helpTest("SELECT a AS myA, b FROM g", query);
    }
    ...
    public void testAliasInSelect2() {
        ...
        Query query = getFactory().newQuery(select, from);
        helpTest("SELECT a AS myA, b FROM g, h", query);
    }
    ...
    public void testAliasInFrom() {
        ...
        Query query = getFactory().newQuery(select, from);
        helpTest("SELECT myG.a FROM g AS myG", query);
    }
    ...
    public void testAliasesInFrom() {
        ...
        Query query = getFactory().newQuery(select, from);
        helpTest("SELECT myG.*, myH.b FROM g AS myG, h AS myH", query);
    }
...
//    }
    ...
    public void testIsNullCriteria1() {
        ...
        helpTest("SELECT a FROM db.g WHERE a IS NULL", query);
    }
    ...
    public void testIsNullCriteria2() {
        ...
        Query query = getFactory().newQuery(select, from);
        query.setCriteria(crit);
        helpTest("SELECT a FROM db.g WHERE a IS NOT NULL", query);
    }
    ...
    public void testNotIsNullCriteria() {
        ...
        Query query = getFactory().newQuery(select, from);
        query.setCriteria(crit);
        helpTest("SELECT a FROM db.g WHERE NOT (a IS NULL)", query);
    }
    ...
    public void testStringNotEqualDoubleTicks() {
        ...
        Query query = getFactory().newQuery(select, from);
        query.setCriteria(crit);
        helpTest("SELECT a FROM db.g WHERE a <> \"value\"", query);
    }
    ...
    public void testPartlyQuotedGroup() {
        ...
        Query query = getFactory().newQuery(select, from);
        query.setCriteria(crit);
        helpTest("SELECT a FROM db.g WHERE a = 5", query);
    }
    ...
    public void testPartlyQuotedElement1() {
        ...
        helpTest("SELECT db.g.a FROM db.g", query);
    }
    ...
    public void testStringLiteralLikeQuotedElement() {
        ...
        helpTest("SELECT \"g\"\"\".\"\"\"a\" FROM g", query);
    }
    ...
    public void testStringLiteralLikeQuotedElement1() {
        ...
        helpTest("SELECT 'g\".\"a' FROM g", query, info);
    }
    ...
    public void testQuotedAlias() {
        ...
        helpTest("SELECT g.x AS \"select\" FROM g", query);
    }
    ...
    public void testQuotedAlias2() {
        ...
        helpTest("SELECT g.x AS \"year\" FROM g", query);
    }
    ...
    public void testQuotedAlias3() {
        ...
        helpTest("SELECT g.x AS \"some year\" FROM g", query);
    }
    ...
    public void testReservedWordElement1() {
        ...
        helpTest("SELECT g.\"select\" FROM g", query);
    }
    ...
    public void testXMLCriteriaWithAttribute() {
        ...
        helpTest("SELECT * FROM model.doc WHERE ab.cd.@ef = 'abc'", query);
    }
    ...
    public void testBetween1() {
        ...
        Query query = getFactory().newQuery(select, from);
        query.setCriteria(crit);
        helpTest("SELECT a FROM db.g WHERE a BETWEEN 1000 AND 2000", query);
    }
    ...
    public void testCompareLT() {
        ...
        Query query = getFactory().newQuery(select, from);
        query.setCriteria(crit);
        helpTest("SELECT a FROM db.g WHERE a < 1000", query);
    }
    ...
    protected void helpTestCompoundCompare(String testSQL) {
        ...
        Query query = getFactory().newQuery(select, from);
        query.setCriteria(crit);
        helpTest("SELECT a FROM db.g WHERE (b = x) AND (a = 1000)", query);
    }
    ...
    public void testSetCriteria0() {
        ...
        Query query = getFactory().newQuery(select, from);
        query.setCriteria(crit);
        helpTest("SELECT a FROM db.g WHERE b IN (1000, 5000)", query);
    }
    ...
    public void testSetCriteria1() {
        ...
        Query query = getFactory().newQuery(select, from);
        query.setCriteria(crit);
        helpTest("SELECT a FROM db.g WHERE b NOT IN (1000, 5000)", query);
    }
    ...
    public void testOrderBy() {
        ...
        helpTest("SELECT a FROM db.g WHERE b = aString ORDER BY c", query);
    }
    ...
    public void testOrderBys() {
        ...
        Query query = getOrderByQuery(orderBy);
        helpTest("SELECT a FROM db.g WHERE b = aString ORDER BY c, d", query);
    }
    ...
    public void testLike0() {
        ...
        Query query = getFactory().newQuery(select, from);
        query.setCriteria(crit);
        helpTest("SELECT a FROM db.g WHERE b LIKE 'aString'", query);
    }
    ...
    public void testLike1() {
        ...
        Query query = getFactory().newQuery(select, from);
        query.setCriteria(crit);
        helpTest("SELECT a FROM db.g WHERE b NOT LIKE 'aString'", query);
    }
    ...
    public void testReservedWordsInElement() {
        ...
        Query query = getFactory().newQuery(select, from);
        helpTest("SELECT \"date\".\"time\" FROM db.g", query);
...
//    }
    ...
    public void testLikeWOConstant() {
        ...
        Query query = getFactory().newQuery(select, from);
        query.setCriteria(crit);
        helpTest("SELECT a FROM g WHERE a LIKE x", query);
    }
...
//    }
    ...
    public void testReusabilityOfParserObject() {
        ...
        helpTest("SELECT a FROM m.g", query);
    ...
    public void testParameter1() {
        ...
        Query query = getFactory().newQuery(select, from);
        query.setCriteria(crit);
        helpTest("SELECT a FROM db.g WHERE b LIKE ?", query);
    }
    ...
    public void testParameter2() {
        ...
        Query query = getFactory().newQuery(select, from);
        query.setCriteria(crit);
        helpTest("SELECT ? FROM db.g WHERE b LIKE ?", query);
    }
    ...
    public void testSubquery1() {
        ...
        helpTest("SELECT a, b FROM (SELECT c FROM m.g) AS y", query2);
    }
...
//    }
    ...
    public void testInsertWithReference() {
        ...
        helpTest("INSERT INTO m.g (a) VALUES (?)", insert);
    }
    ...
    public void testStoredQueryWithNoParameter() {
        ...
        helpTest("EXEC proc1()", storedQuery);
        helpTest("EXEC proc1()", storedQuery);
    }
    ...
    public void testStoredQueryWithNoParameter2() {
        ...
        Query query = getFactory().newQuery(select, from);
        helpTest("SELECT X.A FROM (EXEC proc1()) AS X", query);
    }
    ...
    public void testStoredQuery() {
        ...
        helpTest("EXEC proc1('param1')", storedQuery);
        helpTest("EXEC proc1('param1')", storedQuery);
    }
    ...
    public void testStoredQuery2() {
        ...
        Query query = getFactory().newQuery(select, from);
        helpTest("SELECT X.A FROM (EXEC proc1('param1')) AS X", query);
    }
    ...
    public void testAssignStatement() throws Exception {
        ...
        helpTest("a = (SELECT a1 FROM g WHERE a2 = 5);", queryStmt);

        helpTest("a = 'aString';", exprStmt);
    }
    ...
    public void testDeclareStatementWithAssignment() throws Exception {
        ...
        helpTest("DECLARE short a = null;", stmt);
    }
    ...
    public void testCommandStatement() throws Exception {
        ...
        helpTest("SELECT a1 FROM g WHERE a2 = 5;", cmdStmt);
    }
...
//        CommandStatement cmdStmt = getFactory().newCommandStatement(sqlCmd);
//
//        helpTest("EXECUTE IMMEDIATE z USING a = b;", cmdStmt);
//    }
//
...
//    }
    ...
    public void testSubquerySetCriteria0() {
        //test getFactory().wrap up command with subquerySetCriteria
    ...
    public void testEscapedFunction1() {
        ...
        helpTest("SELECT * FROM a.thing WHERE e1 = concat('a', 'b')", query);
    }
    ...
    public void testEscapedFunction2() {
        ...
        helpTest("SELECT * FROM a.thing WHERE e1 = convert(5, string)", query);
    }
    ...
    public void testEscapedFunction3() {
        ...
        helpTest("SELECT * FROM a.thing WHERE e1 = cast(5 AS string)", query);
    }
    ...
    public void testEscapedFunction4() {
        ...
        helpTest("SELECT * FROM a.thing WHERE e1 = concat(concat('a', 'b'), 'c')", query);
    }
    ...
    public void testFunctionWithUnderscore() {
        ...
        helpTest("SELECT yowza_yowza() FROM a.thing", query);
    }
    ...
    public void testScalarSubqueryExpressionInSelect() {
        ...
        helpTest("SELECT e1, (SELECT e1 FROM m.g1) FROM m.g2", q2);
    }
    ...
    public void testScalarSubqueryExpressionInSelect2() {
        ...
        helpTest("SELECT (SELECT e1 FROM m.g1) FROM m.g2", q2);
    }
    ...
    public void testScalarSubqueryExpressionInSelect3() {
        ...
        helpTest("SELECT (SELECT e1 FROM m.g1), e1 FROM m.g2", q2);
    }
    ...
    public void testScalarSubqueryExpressionWithAlias() {
        ...
        helpTest("SELECT e1, (SELECT e1 FROM m.g1) AS X FROM m.g2", q2);
    }
...
//    }
    ...
    public void testSelectInto() {
        ...
        q.setFrom(from);
        q.setInto(into);
        helpTest("SELECT c1, c2 INTO #temp FROM m.g", q);
    }
    ...
    protected void helpTestCompoundNonJoinCriteria(String sqlPred, Criteria predCrit) {
        ...
        helpTest("SELECT * FROM m.g1 INNER JOIN m.g2 ON e1 = 0 AND "
                                                                        + sqlPred, q);
    ...
    public void testElementInDoubleQuotes() throws Exception {
        ...
        helpTest("SELECT foo FROM x", query);
    }
    ...
    public void testElementInDoubleQuotes_Insert() throws Exception {
        ...
        helpTest("INSERT INTO x (foo) VALUES ('bar')", query);
    }
    ...
    public void testElementInDoubleQuotes_Update() throws Exception {
        ...
        helpTest("UPDATE x SET foo = 'bar'", query);
    }
    ...
    public void testElementInDoubleQuotes_delete() throws Exception {
        ...
        helpTest("DELETE FROM x WHERE foo = 'bar'", query);
    }
    ...
    public void testAliasInDoubleQuotes() throws Exception {
        ...
        helpTest("SELECT fooKey AS fooAlias FROM x", query);
    }
    ...
    public void testSingleQuotedConstant() throws Exception {
        ...
        helpTest("SELECT 'fooString' FROM x.y.z", query);
    }
...
//    }
    ...
    public void testOrderByWithNumbers_InQuotes() throws Exception {
        ...
        helpTest("SELECT x, y FROM z ORDER BY \"1\"", query);
    }
...
//    }
    ...
    public void testCase3281NamedVariable() {
        ...
        parameter.setParameterType(ParameterInfo.IN);
        storedQuery.setParameter(parameter);
        helpTest("EXEC proc1(param1 => 'paramValue1')", storedQuery);
        helpTest("EXEC proc1(param1 => 'paramValue1')", storedQuery);
    }
    ...
    public void testCase3281QuotedNamedVariableFails2() {
        ...
        param1.setParameterType(ParameterInfo.IN);
        storedQuery.setParameter(param1);
        helpTest("EXEC proc1(('a' = 'b'))", storedQuery);
    }
...
//    }
    ...
    public void testCommandWithSemicolon() throws Exception {
        helpTest("SELECT * FROM pm1.g1", parser.parseCommand("select * from pm1.g1"));
    }
    ...
    public void testInsertWithoutColumns() {
        ...
        helpTest("INSERT INTO m.g VALUES ('a', 'b')", insert);
    }
    ...
    public void testXmlElement() throws Exception {
        ...
        helpTest("XMLELEMENT(NAME \"table\", 'x')", f);
    }
    ...
    public void testXmlElementWithAttributes() throws Exception {
        ...
        helpTest("XMLELEMENT(NAME y, XMLATTRIBUTES('a' AS val))", f);
    }
    ...
    public void testXmlForest() throws Exception {
        ...
        helpTest("XMLFOREST(a AS \"table\")", f);
    }
    ...
    public void testXmlAggWithOrderBy() throws Exception {
        ...
        helpTest("SELECT XMLAGG(1 ORDER BY e2)", query);
    }
    ...
    public void testTextAggWithOrderBy() throws Exception {
        ...
        helpTest("SELECT TEXTAGG(FOR e1 AS col1, e2 AS col2 DELIMITER ',' HEADER ORDER BY e2)", query);
    }
    ...
    public void testArrayAggWithOrderBy() throws Exception {
        ...
        Query query = getFactory().newQuery();
        query.setSelect(getFactory().newSelect(Arrays.asList(as)));
        helpTest("SELECT ARRAY_AGG(1 ORDER BY e2)", query);
    }
    ...
    public void testArrayAggWithIndexing() throws Exception {
        ...
        helpTest("SELECT array_get(ARRAY_AGG(1), 1)", query);
    }
    ...
    public void testNestedTable() throws Exception {
        ...
        helpTest("SELECT * FROM TABLE(EXEC foo()) AS x", query);
    }
    ...
    public void testTextTable() throws Exception {
        ...
        helpTest("SELECT * FROM TEXTTABLE(file COLUMNS x string WIDTH 1, y date WIDTH 10 SKIP 10) AS x", query);
...
//        helpException("SELECT * from texttable(foo x string)", null);
//    }
    ...
    public void testXmlSerialize() throws Exception {
        ...
        helpTest("XMLSERIALIZE(DOCUMENT x AS CLOB)", f);
    }
    ...
    public void testXmlQuery() throws Exception {
        ...
        helpTest("XMLQUERY('/x' PASSING foo NULL ON EMPTY)", f);
    }
    ...
    public void testXmlParse() throws Exception {
        ...
        helpTest("XMLPARSE(DOCUMENT x WELLFORMED)", f);
    }
    ...
    public void testXmlSerialize1() throws Exception {
        ...
        f.setExpression(getFactory().newElementSymbol("x"));
        f.setTypeString("CLOB");
        helpTest("XMLSERIALIZE(x AS CLOB)", f);
    }
    ...
    public void testExpressionCriteria() throws Exception {
        ...
        helpTest("CASE WHEN x THEN y END", sce);
    }
    ...
    public void testExpressionCriteria1() throws Exception {
        SearchedCaseExpression sce = getFactory().newSearchedCaseExpression(Arrays.asList(getFactory().newNotCriteria(getFactory().newExpressionCriteria(getFactory().newElementSymbol("x")))),
                                                               Arrays.asList(getFactory().newElementSymbol("y")));
        helpTest("CASE WHEN NOT (x) THEN y END", sce);
    }
    ...
    public void testArrayTable() throws Exception {
        ...
        tt.setName("x");
        query.setFrom(getFactory().newFrom(Arrays.asList(tt)));
        helpTest("SELECT * FROM ARRAYTABLE(null COLUMNS x string, y date) AS x", query);
    }
    ...
    public void testAggFilter() throws Exception {
        ...
        helpTest("SELECT COUNT(*) FILTER(WHERE x = 1) FROM g", query);
    }
    ...
    public void testWindowFunction() throws Exception {
        ...
        query.setFrom(getFactory().newFrom(Arrays.asList(getFactory().newUnaryFromClause(getFactory().newGroupSymbol("g")))));
        helpTest("SELECT ROW_NUMBER() OVER (PARTITION BY x ORDER BY y) FROM g", query);
    }
...
//    }
    ...
    public void testSubString() {
        ...
        helpTest("SELECT substring(RTRIM(MED.BATDAT), 4, 4) FROM FCC.MEDMAS AS MED", query);
    }
