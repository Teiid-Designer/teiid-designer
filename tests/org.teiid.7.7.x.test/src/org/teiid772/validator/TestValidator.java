...
public class TestValidator {
    ...
    public static TransformationMetadata exampleMetadata() {
        ...
        MappingElement complexRoot = new MappingElement("a0"); //$NON-NLS-1$ 
        doc.addChildElement(complexRoot);
        
        MappingElement sourceNode = new MappingElement("a1"); //$NON-NLS-1$
    ...
    private TransformationMetadata helpCreateCase4237VirtualProcedureMetadata() {
        ...
        ProcedureParameter inParam = RealMetadataFactory.createParameter("in", ISPParameter.ParameterInfo.IN, DataTypeManager.DefaultDataTypes.STRING);  //$NON-NLS-1$
        ...
        ProcedureParameter virtualInParam = RealMetadataFactory.createParameter("in1", ISPParameter.ParameterInfo.IN, DataTypeManager.DefaultDataTypes.STRING);  //$NON-NLS-1$
