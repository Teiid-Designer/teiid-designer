...
import org.teiid772.unittest.TimestampUtil;
...
public class TestResolver {
    ...
    public static Command helpResolveWithBindings(String sql, QueryMetadataInterface metadata, List bindings)
    ...
    private void helpTestIsXMLQuery(String sql, boolean isXML)
    ...
    public void testStoredQuery1() {
        ...
        helpCheckParameter(param2,
                           ParameterInfo.IN,
                           1,
                           "pm1.sq2.in", DataTypeManager.DefaultDataClasses.STRING, new Constant("abc")); //$NON-NLS-1$ //$NON-NLS-2$
    }
    ...
    public void testStoredQueryParamOrdering_8211() {
        ...
        helpCheckParameter(param1,
                           ParameterInfo.IN,
                           1,
                           "pm1.sq3a.in", DataTypeManager.DefaultDataClasses.STRING, new Constant("abc")); //$NON-NLS-1$ //$NON-NLS-2$

        SPParameter param2 = params.get(1);
        helpCheckParameter(param2,
                           ParameterInfo.IN,
                           2,
                           "pm1.sq3a.in2", DataTypeManager.DefaultDataClasses.INTEGER, new Constant(new Integer(123))); //$NON-NLS-1$
    }
    ...
    public void testExecNamedParamsOmitRequiredParamWithDefaultValue() {
        Object[] expectedParameterExpressions = new Object[] {
            new Constant("xyz"), new Constant(new Integer(666)), new Constant("YYZ")};//$NON-NLS-1$ //$NON-NLS-2$
    ...
    private Object[] helpGetStoredProcDefaultValues() {
        ...
        return new Object[] {
            ...
            new Constant(new Double(13.0)), new Constant(new Float(13.0)), new Constant(new Integer(13)),
            new Constant(new Long(13)), new Constant(new Short((short)13)),
    ...
    public void testStringConversion1() {
        ...
        FunctionDescriptor fd = library.findFunction(IFunctionLibrary.FunctionName.CONVERT.text(), new Class[] {srcType,
    ...
    public void testNamespacedFunction() throws Exception {
        ...
        QueryMetadataInterface metadata = RealMetadataFactory.createTransformationMetadata(RealMetadataFactory.example1Cached().getMetadataStore(),
                                                                                           "example1",
                                                                                           new FunctionTree(
                                                                                                            "foo",
    ...
    public static TransformationMetadata example_12968() {
        ...
        RealMetadataFactory.createElements(pm1g1, new String[] {"myColumn", "myColumn2"}, //$NON-NLS-1$ //$NON-NLS-2$ 
                                           new String[] {DataTypeManager.DefaultDataTypes.STRING,
                                               DataTypeManager.DefaultDataTypes.INTEGER});
        RealMetadataFactory.createElements(pm2g1, new String[] {"myColumn", "myColumn2"}, //$NON-NLS-1$ //$NON-NLS-2$ 
                                           new String[] {DataTypeManager.DefaultDataTypes.STRING,
                                               DataTypeManager.DefaultDataTypes.INTEGER});
    ...
    public void testCreateQualifiedName() {
        ...
        helpResolveException(sql,
                             "Cannot create temporary table \"pm1.g1\". Local temporary tables must be created with unqualified names."); //$NON-NLS-1$
    }
    ...
    public void testLookupWithoutConstant() throws Exception {
        ...
        helpResolveException(sql,
                             metadata,
                             "Error Code:ERR.015.008.0063 Message:The first three arguments for the LOOKUP function must be specified as constants."); //$NON-NLS-1$
    }
    ...
    public void testXMLJoinFail() {
        ...
        helpResolveException(query,
                             "Error Code:ERR.015.008.0003 Message:Only one XML document may be specified in the FROM clause of a query."); //$NON-NLS-1$
    }
    ...
    public void testExecWithDuplicateNames() {
        ...
        ProcedureParameter rs2p2 = RealMetadataFactory.createParameter("in", ISPParameter.ParameterInfo.IN, DataTypeManager.DefaultDataTypes.STRING); //$NON-NLS-1$
    ...
    public void testInsertWithoutColumnsFails() {
        ...
        helpResolveException(sql,
                             "Error Code:ERR.015.008.0010 Message:INSERT statement must have the same number of elements and values specified.  This statement has 4 elements and 2 values."); //$NON-NLS-1$
    }
    ...
    public void testInsertWithoutColumnsFails1() {
        ...
        helpResolveException(sql,
                             "Error Code:ERR.015.008.0041 Message:Expected value of type 'boolean' but '3' is of type 'integer' and no implicit conversion is available."); //$NON-NLS-1$
    }
    ...
    public void testInsertWithQueryFails() {
        ...
        helpResolveException(sql,
                             "Cannot convert insert query expression projected symbol '3' of type java.lang.Integer to insert column 'pm1.g1.e3' of type java.lang.Boolean"); //$NON-NLS-1$
    }
    ...
    public void testCallableStatementTooManyParameters() throws Exception {
        ...
        TestResolver.helpResolveException(sql,
                                          RealMetadataFactory.exampleBQTCached(),
                                          "Error Code:ERR.015.008.0007 Message:Incorrect number of parameters specified on the stored procedure pm4.spTest9 - expected 1 but got 2"); //$NON-NLS-1$
    }
    ...
    public void testNoTypeCriteria() {
        ...
        helpResolveException(sql,
                             ...
                             "Error Code:ERR.015.008.0026 Message:Expression '? = ?' has a parameter with non-determinable type information.  The use of an explicit convert may be necessary."); //$NON-NLS-1$
    }
    ...
    CreateUpdateProcedureCommand helpResolveUpdateProcedure(String procedure, String userUpdateStr)
        throws QueryParserException, QueryResolverException, TeiidComponentException, QueryMetadataException {
