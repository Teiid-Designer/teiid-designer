...
public class Test9FunctionResolving extends AbstractTestFunctionResolving {

    private Test9Factory factory;

    protected Test9FunctionResolving(Version teiidVersion) {
        super(teiidVersion);
    }

    public Test9FunctionResolving() {
