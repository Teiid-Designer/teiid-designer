...
public class Test9SQLStringVisitor extends AbstractTestSQLStringVisitor {

    private Test9Factory factory;

    protected Test9SQLStringVisitor(Version teiidVersion) {
        super(teiidVersion);
    }

    public Test9SQLStringVisitor() {
