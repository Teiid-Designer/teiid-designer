...
public class Test9CreateDrop extends AbstractSqlTest {

    private Test9Factory factory;

    protected Test9CreateDrop(Version teiidVersion) {
        super(teiidVersion);
    }

    public Test9CreateDrop() {
    ...
    // NOTE Designer will NOT be supporting TEMP TABLES, so commenting out all TEMP TABLE tests
