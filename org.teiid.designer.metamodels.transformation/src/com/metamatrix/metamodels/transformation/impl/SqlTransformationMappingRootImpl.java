...
public class SqlTransformationMappingRootImpl extends TransformationMappingRootImpl implements SqlTransformationMappingRoot {
    ...
    protected EClass eStaticClass() {
        return TransformationPackage.eINSTANCE.getSqlTransformationMappingRoot();
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
        if (featureID >= 0) {
            switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
                ...
                case TransformationPackage.SQL_TRANSFORMATION_MAPPING_ROOT__NESTED_IN:
                    return eBasicSetContainer(null, TransformationPackage.SQL_TRANSFORMATION_MAPPING_ROOT__NESTED_IN, msgs);
                default:
    ...
    public Object eGet(EStructuralFeature eFeature, boolean resolve) {
        switch (eDerivedStructuralFeatureID(eFeature)) {
            ...
            case TransformationPackage.SQL_TRANSFORMATION_MAPPING_ROOT__NESTED_IN:
                return getNestedIn();
            case TransformationPackage.SQL_TRANSFORMATION_MAPPING_ROOT__INPUTS:
                return getInputs();
            case TransformationPackage.SQL_TRANSFORMATION_MAPPING_ROOT__OUTPUTS:
                return getOutputs();
            case TransformationPackage.SQL_TRANSFORMATION_MAPPING_ROOT__TYPE_MAPPING:
                if (resolve) return getTypeMapping();
                return basicGetTypeMapping();
            case TransformationPackage.SQL_TRANSFORMATION_MAPPING_ROOT__OUTPUT_READ_ONLY:
                return isOutputReadOnly() ? Boolean.TRUE : Boolean.FALSE;
            case TransformationPackage.SQL_TRANSFORMATION_MAPPING_ROOT__TOP_TO_BOTTOM:
                return isTopToBottom() ? Boolean.TRUE : Boolean.FALSE;
            case TransformationPackage.SQL_TRANSFORMATION_MAPPING_ROOT__COMMAND_STACK:
                return getCommandStack();
            case TransformationPackage.SQL_TRANSFORMATION_MAPPING_ROOT__TARGET:
