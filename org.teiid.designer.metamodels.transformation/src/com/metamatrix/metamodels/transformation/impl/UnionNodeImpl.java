...
public class UnionNodeImpl extends OperationNodeImpl implements UnionNode {
    ...
    protected EClass eStaticClass() {
        return TransformationPackage.eINSTANCE.getUnionNode();
    }
    ...
    public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
        if (featureID >= 0) {
            switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
                ...
                case TransformationPackage.UNION_NODE__OUTPUT_LINKS:
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
        if (featureID >= 0) {
            switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
                case TransformationPackage.UNION_NODE__OWNER:
                    return eBasicSetContainer(null, TransformationPackage.UNION_NODE__OWNER, msgs);
                case TransformationPackage.UNION_NODE__INPUT_LINKS:
                ...
                case TransformationPackage.UNION_NODE__NODE_GROUP:
                    return eBasicSetContainer(null, TransformationPackage.UNION_NODE__NODE_GROUP, msgs);
                default:
