...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Revision Log</b></em>'. <!-- end-user-doc -->
 * <p>
...
public interface RevisionLog extends HistoryLog {
    ...
    /**
     * Returns the value of the '<em><b>First Revision</b></em>' containment reference. It is bidirectional and its opposite is '
     * {@link com.metamatrix.metamodels.history.Revision#getHistoryLog <em>History Log</em>}'. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>First Revision</em>' containment reference isn't clear, there really should be more of a
     * description here...
     * </p>
     * <!-- end-user-doc -->
     * 
    ...
    /**
     * Sets the value of the '{@link com.metamatrix.metamodels.history.RevisionLog#getFirstRevision <em>First Revision</em>}'
