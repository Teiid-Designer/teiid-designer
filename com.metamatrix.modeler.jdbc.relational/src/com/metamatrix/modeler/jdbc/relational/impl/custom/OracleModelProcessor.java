...
public class OracleModelProcessor extends RelationalModelProcessorImpl {
     ...
     * @param factory
     */
    public OracleModelProcessor(final RelationalFactory factory, final RelationalTypeMapping mapping) {
     ...
     * <p>
     * This implementation returns true if <code>columnType == DatabaseMetaData.procedureColumnResult</code>
     * or <code>"REF CURSOR".equals(typeName)</code>.
     * </p>
     ...
     * @return true if the information designates a column in a result set for the procedure, or false
     * otherwise.
     * @see com.metamatrix.modeler.jdbc.relational.impl.RelationalModelProcessorImpl#isProcedureResultColumn(short, short, java.lang.String)
     */
    @Override
     ...
     * {@link DatabaseMetaData#getProcedureColumns(java.lang.String, java.lang.String, java.lang.String, java.lang.String)
     * DatabaseMetaData.getProcedureColumns(...)} was determined by
     * {@link #isProcedureResultColumn(short, short, String)} to be a column for a result set (i.e., the
     * method returns true), then determine whether the column should be added to the {@link ProcedureResult}.
     * <p>
     * Some JDBC drivers return a procedure column that represents the result set but no columns in 
     * the result set itself.  In such cases, this method should return false.
     * </p><p>
     * This method implementation always returns false, since Oracle does not ever return columns in the
     * result set.
     * </p>
     * @param columnType the short indicating what the metadata describes; should be one of 
     * {@link DatabaseMetaData#procedureColumnUnknown}, {@link DatabaseMetaData#procedureColumnIn},
     ...
     * @param type the {@link Types JDBC type} of the column
     * @param typeName the DBMS-specific name of the column type
     * @return true if the information designates a column <i>in</i> a result set for the procedure, 
     * or false if the column actually <i>represents</i> the result set and thus should not be considered
     * a column in the {@link ProcedureResult}.
     * @see com.metamatrix.modeler.jdbc.relational.impl.RelationalModelProcessorImpl#includeColumnInProcedureResult(short, short, java.lang.String)
     */
    @Override
    ...
    /**
     * @see com.metamatrix.modeler.jdbc.relational.impl.RelationalModelProcessorImpl#setColumnInfo(com.metamatrix.metamodels.relational.Column, com.metamatrix.modeler.jdbc.metadata.JdbcTable, com.metamatrix.modeler.jdbc.relational.impl.Context, java.util.List, java.lang.String, int, java.lang.String, int, int, int, int, java.lang.String, int)
     */
    @Override
    protected void setColumnInfo( final Column column, final JdbcTable tableNode, 
                                  final Context context, final List problems,
                                  final String name, final int type, final String typeName,
                                  final int columnSize, final int numDecDigits, final int numPrecRadix,
                                  final int nullable, final String defaultValue, final int charOctetLen) {
        super.setColumnInfo(column,tableNode,context,problems,name,type,typeName,columnSize,
                            numDecDigits,numPrecRadix,nullable,defaultValue,charOctetLen);
        ...
        if ( type == Types.BLOB || type == Types.CLOB || 
             BLOB_TYPE_NAME.equals(typeName) || CLOB_TYPE_NAME.equals(typeName)) {
            column.setLength(0);
        }
    }
