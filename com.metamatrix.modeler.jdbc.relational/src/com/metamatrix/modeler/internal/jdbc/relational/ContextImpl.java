...
public class ContextImpl implements Context {
    ...
    public ContextImpl( final Resource resource, final ModelContents contents,
                        final JdbcDatabase jdbcDatabase, final JdbcImportSettings settings, 
                        final IProgressMonitor monitor, final Logger logger ) {
     ...
     * such object was found in the model
     */
    ...
    public EObject addNewObject( final IPath path, final EObject obj ) {
