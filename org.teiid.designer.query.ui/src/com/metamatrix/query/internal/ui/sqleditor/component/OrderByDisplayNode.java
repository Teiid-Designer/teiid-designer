...
public class OrderByDisplayNode extends DisplayNode {
     ...
     */
    public OrderByDisplayNode(DisplayNode parentNode, OrderBy orderBy) {
    ...
    private void createDisplayNodeList() {
        ...
        if(childNodeList.size()>0) {
            ...
            while ( iter.hasNext() ) {
                ...
                if (seSymbol instanceof ElementSymbol && !((ElementSymbol)seSymbol).getDisplayFullyQualified()) {
                    displayNodeList.add(DisplayNodeFactory.createDisplayNode(this,seSymbol.getShortName()));
                } else {
