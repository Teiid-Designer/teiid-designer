...
public class OverlayPreferenceStore implements IPreferenceStore {
    ...
    public static class OverlayKey {
        ...
        public OverlayKey( TypeDescriptor descriptor,
                           String key ) {
    ...
    void propagateProperty( IPreferenceStore orgin,
                            OverlayKey key,
        ...
        if (BOOLEAN == d) {
            ...
            if (targetValue != null && originValue != null && !targetValue.equals(originValue)) target.setValue(key.fKey,
                                                                                                                originValue);
    ...
    private void loadProperty( IPreferenceStore orgin,
                               OverlayKey key,
                               IPreferenceStore target,
