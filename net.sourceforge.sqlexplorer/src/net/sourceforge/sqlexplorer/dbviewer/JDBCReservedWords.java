...
public class JDBCReservedWords {
    ...
    public static final String[] ALL_WORDS = new String[] {ALL, ALL_COLS, AND, ANY, AS, ASC, AVG, BEGIN, BETWEEN, BIGINTEGER,
        ...
        NOCACHE, NOT, NULL, OBJECT, ON, OR, ORDER, OPTION, OUTER, PLANONLY, PROCEDURE, RIGHT, SELECT, SET, SHORT, SHOWPLAN, SOME,
    ...
    static {
        ...
        for (int i = 0; i != JDBCReservedWords.ALL_WORDS.length; ++i) {
            String reservedWord = JDBCReservedWords.ALL_WORDS[i];
            JDBCReservedWords.RESERVED_WORDS.add(reservedWord.toUpperCase());
        }
    }

    /** Can't construct */
    private JDBCReservedWords() {
    }
