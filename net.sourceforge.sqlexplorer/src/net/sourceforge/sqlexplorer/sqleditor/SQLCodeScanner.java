...
public class SQLCodeScanner extends AbstractSQLScanner {
    ...
    private static class VersionedWordRule extends WordRule {
        ...
        public VersionedWordRule( IWordDetector detector,
                                  String version,
                                  boolean enable,
        ...
        public IToken evaluate( ICharacterScanner scanner ) {
            ...
            if (fEnable) {
                if (fCurrentVersion.equals(fVersion)) return token;
                return Token.UNDEFINED;
            }
            if (fCurrentVersion.equals(fVersion)) return Token.UNDEFINED;
            return token;
        }
    }
    ...
    static String[] fgTokenProperties = {ISQLColorConstants.SQL_TABLE, ISQLColorConstants.SQL_COLUMS,
        ISQLColorConstants.SQL_KEYWORD, ISQLColorConstants.SQL_STRING, ISQLColorConstants.SQL_DEFAULT};
     ...
     */
    public SQLCodeScanner( IColorManager manager,
    ...
    protected List createRules() {
        ...
        UnsignedWordRule wordRule = new UnsignedWordRule(new SQLWordDetector(), token, getToken(ISQLColorConstants.SQL_TABLE),
                                                         getToken(ISQLColorConstants.SQL_COLUMS), dictionary);
    ...
    public void setRules( IRule[] rules ) {
        ...
        for (i = 0; i < rules.length; i++)
            if (rules[i].equals(fVersionedWordRule)) break;

        // not found - invalidate fVersionedWordRule
        if (i == rules.length) fVersionedWordRule = null;
