...
public class SQLTextTools {
    ...
    public IDocumentPartitioner createDocumentPartitioner() {
        ...
        String[] types = new String[] {IDocument.DEFAULT_CONTENT_TYPE, ISQLColorConstants.SQL_MULTILINE_COMMENT,
            ISQLColorConstants.SQL_SINGLE_LINE_COMMENT, ISQLColorConstants.SQL_STRING};
    ...
    protected void adaptToPreferenceChange( PropertyChangeEvent event ) {
        ...
        if (fStringScanner.affectsBehavior(event)) fStringScanner.adaptToPreferenceChange(event);
    }
