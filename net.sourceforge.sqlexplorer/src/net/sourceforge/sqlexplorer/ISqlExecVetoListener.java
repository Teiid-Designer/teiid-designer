...
/**
 * An <code>ISqlExecVetoListener</code> can be registered with the {@link net.sourceforge.sqlexplorer.plugin.SQLExplorerPlugin}
 * to potentially stop SQL execution from a SQL Editor. 
 * @since 5.0.1
 */
public interface ISqlExecVetoListener {
     ...
     * @return a status with severity not equal to {@link IStatus#ERROR} to continue with execution; otherwise
