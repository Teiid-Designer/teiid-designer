...
public abstract class RelationalEntityAspect extends AbstractMetamodelAspect implements SqlAspect {
    ...
    protected int convertDirectionKindToMetadataConstant(final DirectionKind kind) {
        switch (kind.getValue()) {
            case DirectionKind.IN : return MetadataConstants.PARAMETER_TYPES.IN_PARM;
            case DirectionKind.OUT : return MetadataConstants.PARAMETER_TYPES.OUT_PARM;
            case DirectionKind.INOUT : return MetadataConstants.PARAMETER_TYPES.INOUT_PARM;
            case DirectionKind.RETURN : return MetadataConstants.PARAMETER_TYPES.RETURN_VALUE;
            case DirectionKind.UNKNOWN : return MetadataConstants.PARAMETER_TYPES.RESULT_SET;
            default : 
                return -1;
        }
    }
    ...
    protected DirectionKind convertMetadataContantToDirectionKind(final int direction) {
        switch (direction) {
            case MetadataConstants.PARAMETER_TYPES.IN_PARM : return DirectionKind.IN_LITERAL;
            case MetadataConstants.PARAMETER_TYPES.OUT_PARM : return DirectionKind.OUT_LITERAL;
            case MetadataConstants.PARAMETER_TYPES.INOUT_PARM : return DirectionKind.INOUT_LITERAL;
            case MetadataConstants.PARAMETER_TYPES.RETURN_VALUE : return DirectionKind.RETURN_LITERAL;
            default : 
                case MetadataConstants.PARAMETER_TYPES.RESULT_SET : return DirectionKind.UNKNOWN_LITERAL;
        }
    }
    
    protected int convertNullableTypeToMetadataConstant(final NullableType type) {
        switch (type.getValue()) {
            case NullableType.NO_NULLS : return MetadataConstants.NULL_TYPES.NOT_NULL;
            case NullableType.NULLABLE : return MetadataConstants.NULL_TYPES.NULLABLE;
            case NullableType.NULLABLE_UNKNOWN : return MetadataConstants.NULL_TYPES.UNKNOWN;
            default : 
                return -1;
        }
    }
    ...
    protected NullableType convertMetadataConstantToNullableType(final int nullType) {
        switch (nullType) {
            case MetadataConstants.NULL_TYPES.NOT_NULL : return NullableType.NO_NULLS_LITERAL;
            case MetadataConstants.NULL_TYPES.NULLABLE : return NullableType.NULLABLE_LITERAL;
            case MetadataConstants.NULL_TYPES.UNKNOWN  : return NullableType.NULLABLE_UNKNOWN_LITERAL;
            default : 
    ...
    protected int convertSearchabilityTypeToMetadataConstant(final SearchabilityType type) {
        switch (type.getValue()) {
            case SearchabilityType.SEARCHABLE : return MetadataConstants.SEARCH_TYPES.SEARCHABLE;
            case SearchabilityType.ALL_EXCEPT_LIKE : return MetadataConstants.SEARCH_TYPES.ALLEXCEPTLIKE;
            case SearchabilityType.LIKE_ONLY : return MetadataConstants.SEARCH_TYPES.LIKE_ONLY;
            case SearchabilityType.UNSEARCHABLE : return MetadataConstants.SEARCH_TYPES.UNSEARCHABLE;
            default : 
                return -1;
        }
    }
    ...
    protected SearchabilityType convertMetadataConstantToSearchabilityType(final int searchabilityType) {
        switch (searchabilityType) {
            case MetadataConstants.SEARCH_TYPES.SEARCHABLE    : return SearchabilityType.SEARCHABLE_LITERAL;
            case MetadataConstants.SEARCH_TYPES.ALLEXCEPTLIKE : return SearchabilityType.ALL_EXCEPT_LIKE_LITERAL;
            case MetadataConstants.SEARCH_TYPES.LIKE_ONLY     : return SearchabilityType.LIKE_ONLY_LITERAL;
            case MetadataConstants.SEARCH_TYPES.UNSEARCHABLE  : return SearchabilityType.UNSEARCHABLE_LITERAL;
            default : 
