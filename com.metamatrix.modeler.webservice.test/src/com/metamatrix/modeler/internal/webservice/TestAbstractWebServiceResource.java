...
public class TestAbstractWebServiceResource extends TestCase {
    ...
    public static Test suite() {
        TestSuite suite = new SmartTestSuite("com.metamatrix.modeler.webservice", "TestAbstractWebServiceResource"); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    public void helpCheckCollection( final int expectedSize, final Collection actual) {
    ...
    public void testEqualsObject() {
        ...
        IWebServiceResource resource5Dup = new FakeConcreteAbstractWebServiceResource(RESOURCE5_NAMESPACE,RESOURCE5_FULLPATH,false);
