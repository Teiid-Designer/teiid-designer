...
public class MetamodelBuilderExecutionPlugin extends Plugin {
    ...
    /**
     * The plug-in identifier of this plugin (value <code>"com.metamatrix.metamodels.builder.execution"</code>).
     */
    public static final String PLUGIN_ID = "com.metamatrix.metamodels.builder.execution"; //$NON-NLS-1$
