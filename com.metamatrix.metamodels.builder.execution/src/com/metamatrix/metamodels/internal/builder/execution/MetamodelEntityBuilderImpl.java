...
/** 
 * Implementation of the MetamodelEntityBuilder - creates EObjects given a MetamodelEntityRecord or
 * List of records.
 */
public class MetamodelEntityBuilderImpl implements MetamodelEntityBuilder, MetamodelBuilderConstants {
     ...
     * @param resources -  The resourceSet where entities will be added (internal ojbect resources
     *                      must be contained in the resource set or they will not be found) - May not be null or empty
     */
    public MetamodelEntityBuilderImpl(final MultiStatus status, final ResourceSet resources) {
    ...
    /**
     * Create a new EObject using the given record and then adds the entity
     * to the appropriate parent and sets all supplied feature values. 
	...
	public EObject create(MetamodelEntityRecord record, IProgressMonitor monitor) {
        ...
        if(nameValue!=null) {
            ...
            final Object existingEntity = MetamodelBuilderUtil.findEObjectByPath(resources, fullPath, record.getMetaClassUri(), status);
    ...
    /**
     * Create new EObjects using the given records.  Adds the entities to the appropriate
     * parent and sets all supplied feature values. 
     ...
     *           the new entity.
     */
    private void process(final EObject entity, final MetamodelEntityRecord entityRecord, EFactory factory, boolean isExisting) {
        if(!isExisting) {
     ...
     * @since 4.3
     */
    private boolean addEntity(final EObject entity, final MetamodelEntityRecord entityRecord) {
        ...
        final Object parent = MetamodelBuilderUtil.findEObjectByPath(resources, path, entityRecord.getParentMetaClassUri(), status);
        if(parent == null) {
     ...
     * @since 4.3
     */
    private boolean addChildToParent(final Resource rsrc, final EObject child, final Object parent) {
     ...
     * @since 4.3
     */
    private boolean addFeatureValue(final EObject eObject, final String featureName, final Object value) {
     ...
     * @since 4.3
     */
    private void setFeatureValue(final EObject eObject, final EFactory factory, final String featureName, final Object value, final boolean isExisting) {
     ...
     * @since 4.3
     */
    private void setDescription(EObject eObject, final String value) {
     ...
     * @since 4.3
     */
    private EStructuralFeature getFeature(final EClass eClass, final String featureName, final boolean caseSensitiveMatch) {
        if(featureName == null) {
            return null;
        }
