 ...
 * the Metamodel Entity builder framework.
 */
public class MetamodelBuilderUtil implements MetamodelBuilderConstants {
    ...
    /**
     * Helper method to find a child with the given name of the given metaClass (may be null). 
     * If the metaClass is null you will get the first child with a matching name.  
     ...
     * @since 4.3
     */
    public static Object findChild(final String name, final Object parent, final String metaClassUri) {
    ...
    /**
     * Search for an existing extension for a given EObject - This method was ported from
     * ModelEditor with the removal of logic that made it not UnitTestable 
     ...
     * @since 4.3
     */
    public static EObject getExtension(EObject eObject, final MultiStatus status) throws ModelerCoreException {
                    ...
                    if ( xclass != null ) {
                        ...
                        try {
                            ...
                            if(builderDebugEnabled) {
                    	        MetamodelBuilderExecutionPlugin.Util.log(IStatus.ERROR, e, msg);
                            }
                        }
                        return result;
                    }
     ...
     * @since 4.3
     */
    public static Object findEObjectByPath(final ResourceSet resources, final String path, final String metaClassUri, final MultiStatus status) {
     ...
     * @since 4.3
     */
    public static Resource findResource (final ResourceSet resources, final String path){
    ...
    /**
     * Helper to find a ModelAnnotation in a given Resource.  Ported from
     * ModelEditorImpl and removed logic making this method Unit Testable 
     ...
     * @since 4.3
     */
    public static EPackage getEPackageForUri(final String ePkgUri, final MultiStatus status) {
		boolean builderDebugEnabled = MetamodelBuilderPlugin.Util.isDebugEnabled(DebugConstants.METAMODEL_BUILDER);
     ...
     * @since 4.3
     */
    public static EClassifier getEClassForUri(final String metaClassUri, final MultiStatus status) {
		boolean builderDebugEnabled = MetamodelBuilderPlugin.Util.isDebugEnabled(DebugConstants.METAMODEL_BUILDER);
     ...
     * @since 4.3
     */
    public static Object getInternalObjectByUri(final ResourceSet resources, final String uri, final MultiStatus status) {
		boolean builderDebugEnabled = MetamodelBuilderPlugin.Util.isDebugEnabled(DebugConstants.METAMODEL_BUILDER);
