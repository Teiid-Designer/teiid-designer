 ...
 * @since 4.2
 */
public class XmlResultAspect extends XmlServiceComponentAspect implements SqlColumnAspect {
     ...
     * @since 4.2
     */
    public XmlResultAspect(final MetamodelEntity entity) {
        super(entity);
    }
    ...
    public String getFullName(final EObject eObject) {
    	...
    	if(eObject!=null) {
        	final EObject parentEObj = eObject.eContainer();
        	
            IPath path = getPath(parentEObj);
            if(path != null) {
                return path.toString().replace(IPath.SEPARATOR, DELIMITER_CHAR)+DELIMITER_CHAR+name;
            }
    	}
    	return name;
    }
    ...
    public void setDatatype(EObject eObject, EObject datatype) {
        throw new UnsupportedOperationException(XmlServiceMetamodelPlugin.Util.getString("XmlResultAspect.setDatatypeNotSupported")); //$NON-NLS-1$
    }
    ...
    public void setLength(EObject eObject, int length) {
        throw new UnsupportedOperationException(XmlServiceMetamodelPlugin.Util.getString("XmlResultAspect.setLengthNotSupported")); //$NON-NLS-1$
    }
    ...
    public void setNullType(EObject eObject, int nullType) {
        throw new UnsupportedOperationException(XmlServiceMetamodelPlugin.Util.getString("XmlResultAspect.setNullTypeNotSupported")); //$NON-NLS-1$
    }
