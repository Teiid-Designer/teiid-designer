...
public class RuntimeAdapter extends RecordFactory {
     ...
     * to be used as the index file record(s) for this SqlAspect instance.  The word entries
     ...
     */
    public static void addIndexWord(final Object eObject, final IndexingContext context, final String modelPath, final Collection wordEntries) {
        addIndexWord(eObject, context, modelPath, wordEntries, true);
    }

    /**
     * Create the {@link com.metamatrix.internal.core.index.impl.WordEntry} instance(s)
     * to be used as the index file record.  The word entries are added to the list provided
     * by the calling method.
     * @param filePath The path to the file in the vdb
     * @param wordEntries the list to which WordEntry instances are added
     * @param addAllWords boolean indicating if certain types of indexes can be skipped based on type of indexer call this. 
     */
    public static void addFileIndexWord(final String filePath, final Collection wordEntries) {
     ...
     * @param addAllWords boolean indicating if certain types of indexes can be skipped based on type of indexer call this. 
     */
    public static void addIndexWord(final Object eObject, final IndexingContext context, final String modelPath, final Collection wordEntries, final boolean addAllWords) {
     ...
     * instance representing a model.  This resulting WordEntry is of the form:
     * header|maxSetSize|boolean values|footer|
     */
    public static void addModelWord(final SqlModelAspect aspect, final EObject eObject, 
                                    final String modelPath, final Collection wordEntries) {
        ...
        addModelWord(objectID, fullName, aspect.getNameInSource(eObject), parentObjectID, 
                     aspect.getMaxSetSize(eObject), aspect.getModelType(eObject), 
                     aspect.isVisible(eObject), aspect.supportsDistinct(eObject), 
                     aspect.supportsJoin(eObject), aspect.supportsOrderBy(eObject), 
                     aspect.supportsOuterJoin(eObject), aspect.supportsWhereAll(eObject), 
                     aspect.getPrimaryMetamodelUri(eObject), modelPath, wordEntries);
    }

    /**
     * Create a {@link com.metamatrix.internal.core.index.impl.WordEntry}
     * instance representing a model.  This resulting WordEntry is of the form:
     * header|maxSetSize|modelType|primaryMetamodelUri|boolean values|footer|
     */
    static void addModelWord(final String objectID, final String fullName,
                             final String nameInSource, final String parentObjectID,
                             final int maxSetSize, final int modelType, 
                             final boolean isVisible, final boolean supportsDistinct, 
                             final boolean supportsJoin, final boolean supportsOrderBy, 
                             final boolean supportsOuterJoin, final boolean supportsWhereAll, 
                             final String primaryMetamodelUri, final String modelPath, 
    ...
    /**
     * Create a {@link com.metamatrix.internal.core.index.impl.WordEntry}
     * instance representing a VDB archive.  This resulting WordEntry is of the form:
     * header|version|identifer|producerName|producerVersion|provider|timeLastChanged|
     *            timeLastProduced|modelIDs|description|footer|
     */
    public static void addVdbWord(final SqlVdbAspect aspect, final EObject eObject, 
                                  final String modelPath, final Collection wordEntries) {
        ...
        addVdbWord(objectID, fullName, aspect.getNameInSource(eObject), parentObjectID, 
                   aspect.getVersion(eObject), aspect.getIdentifier(eObject), 
                   aspect.getDescription(eObject), aspect.getProducerName(eObject), 
                   aspect.getProducerVersion(eObject), aspect.getProvider(eObject), 
                   aspect.getTimeLastChanged(eObject), aspect.getTimeLastProduced(eObject), 
                   aspect.getModelIDs(eObject), modelPath, name, wordEntries);
    }
     ...
     *            timeLastProduced|modelIDs|description|footer|
     */
    static void addVdbWord(final String objectID, final String fullName,
                             final String nameInSource, final String parentObjectID,
                             final String version, final String identifier,
                             final String description, final String producerName,
                             final String producerVersion, final String provider,
                             final String timeLastChanged, final String timeLastProduced,
                             final List modelIDs, final String modelPath, final String name, final Collection wordEntries) {
    ...
    /**
     * Create a {@link com.metamatrix.internal.core.index.impl.WordEntry}
     * instance representing a transformation.  This resulting WordEntry is of the form:
        ...
        if(types != null) {
            for(int i=0; i < types.length; i++) {
                ...
                if(transInfo != null) {
                    ...
                    addTransformationWord(upperName, types[i], transformationObjectID, transformedObjectID,
                                          sqlTransform, bindingNames, schemaPaths, 
     ...
     *            transformationType|transformedObjectID|transformation|bindingNames|schemaPaths|footer|
     */
    static void addTransformationWord(final String upperName, final String tranformType, final String transformationObjectID, 
                                      final String transformedObjectID, final String transformation, 
                                      final List bindings, final List schemaPaths, 
                                      final String modelPath, final String name, final Collection wordEntries) {
     ...
     * Create a {@link com.metamatrix.internal.core.index.impl.WordEntry}
     * instance representing a model.  This resulting WordEntry is of the form:
     * header|isFunction|parameterIDs|resultSetID|footer|
     */
    public static void addCallableWord(final SqlProcedureAspect aspect, final EObject eObject, 
                                    final String modelPath, final Collection wordEntries) {
        ...
        // Construct a string containing the runtime metadata
        final StringBuffer sb = new StringBuffer(getIniitalBufferSize());
        appendWordHeader(IndexConstants.RECORD_TYPE.CALLABLE,objectID,fullName,aspect.getNameInSource(eObject),parentObjectID,sb);        
     ...
     * Create a {@link com.metamatrix.internal.core.index.impl.WordEntry}
     * instance representing a model.  This resulting WordEntry is of the form:
     * header|defaultValue|dataType|length|radix|scale|nullable|precision|position|paramType|isOptional|footer|
     */
    public static void addCallableParameterWord(final SqlProcedureParameterAspect aspect, final EObject eObject, 
                                    final String modelPath, final Collection wordEntries) {
        ...
        // Construct a string containing the runtime metadata
        final StringBuffer sb = new StringBuffer(getIniitalBufferSize());
        appendWordHeader(IndexConstants.RECORD_TYPE.CALLABLE_PARAMETER,objectID,fullName,aspect.getNameInSource(eObject),parentObjectID,sb);        
    ...
    /**
     * Create a {@link com.metamatrix.internal.core.index.impl.WordEntry}
     * instance representing a table.  This resulting WordEntry is of the form:
     * header|cardinality|boolean values|columnIDs|primaryKeyID|foreignKeyIDs|indexIDs|uniqueKeyIDs|accessPatternIDs|materializedTableIDs|footer|
     */
    public static void addTableWord(final SqlTableAspect aspect, 
                                    final EObject eObject, final IndexingContext context,
                                    final String modelPath, 
                                    final Collection wordEntries) {
        ...
        addTableWord(objectID, fullName, aspect.getNameInSource(eObject), parentObjectID, 
                     aspect.getCardinality(eObject), aspect.getTableType(eObject), aspect.isVirtual(eObject),
                     aspect.isSystem(eObject), isMaterialized, aspect.supportsUpdate(eObject), primaryKeyID,
                     aspect.getColumns(eObject), aspect.getForeignKeys(eObject), 
                     aspect.getIndexes(eObject), aspect.getUniqueKeys(eObject), 
                     aspect.getAccessPatterns(eObject), materializedTableID, materializedStageTableID, modelPath, name, wordEntries);
    }

    /**
     * Create a {@link com.metamatrix.internal.core.index.impl.WordEntry}
     * instance representing a table.  This resulting WordEntry is of the form:
     * header|cardinality|boolean values|columnIDs|primaryKeyID|foreignKeyIDs|indexIDs|uniqueKeyIDs|accessPatternIDs|materializedTableID|materializedStageTableID|footer|
     */
    static void addTableWord(final String objectID, final String fullName, 
                             final String nameInSource, final String parentObjectID, 
                             final int cardinality, final int tableType, final boolean isVirtual, 
                             final boolean isSystem, final boolean isMaterialized, final boolean supportsUpdate, final String primaryKeyID, 
                             final List columnIDs, final Collection foreignKeyIDs, 
                             final Collection indexIDs, final Collection uniqueKeyIDs, 
                             final Collection accessPatternIDs, final String materializedTableID, final String materializedStageTableID, 
                             final String modelPath, final String name,
                             final Collection wordEntries) {
    ...
    /**
     * Create a {@link com.metamatrix.internal.core.index.impl.WordEntry}
     * instance representing a column.  This resulting WordEntry is of the form:
     * header|boolean values|nullType|searchType|
     *           length|scale|precision|charOctetLength|radix|distinctValues|nullValues|minValue|maxValue|format|datatype|defaultValue|footer|
     */
    public static void addColumnWord(final SqlColumnAspect aspect, 
        ...
        addColumnWord(objectID, fullName, aspect.getNameInSource(eObject), parentObjectID, 
                     aspect.isSelectable(eObject), aspect.isUpdatable(eObject),
                     aspect.getNullType(eObject), aspect.isAutoIncrementable(eObject),
                     aspect.isCaseSensitive(eObject), aspect.isSigned(eObject), 
                     aspect.isCurrency(eObject), aspect.isFixedLength(eObject), 
                     aspect.isTranformationInputParameter(eObject),
                     aspect.getSearchType(eObject), aspect.getLength(eObject),
                     aspect.getScale(eObject), aspect.getPrecision(eObject),
                     aspect.getCharOctetLength(eObject), aspect.getRadix(eObject), aspect.getDistinctValues(eObject), aspect.getNullValues(eObject),
                     minValue, maxValue, aspect.getFormat(eObject),
                     aspect.getRuntimeType(eObject), aspect.getNativeType(eObject), aspect.getDatatypeObjectID(eObject),
                     defaultValue, aspect.getPosition(eObject), 
                     modelPath, name, wordEntries);
    }
     ...
     * instance representing a column.  This resulting WordEntry is of the form:
     * header|boolean values|nullType|searchType|
     *           length|scale|precision|charOctetLength|radix|distinctValues|nullValues|minValue|maxValue|format|datatype|nativeType|defaultValue|footer|
     */
    static void addColumnWord(final String objectID, final String fullName, 
                              final String nameInSource, final String parentObjectID, 
                              final boolean isSelectable, final boolean isUpdatable, 
                              final int nullType, final boolean isAutoIncrementable, 
                              final boolean isCaseSensitive, final boolean isSigned, 
                              final boolean isCurrency, final boolean isFixedLength, 
                              final boolean isTranformationInputParameter, final int searchType, 
                              final int length, final int scale, final int precision, 
                              final int charOctetLength, final int radix, final int distinctValues, final int nullValues,
                              final String minValue, final String maxValue, final String format,
                              final String runtimeType, final String nativeType, final String datatypeObjectID,
    ...
    /**
     * Create a {@link com.metamatrix.internal.core.index.impl.WordEntry}
     * instance representing a index, access pattern or resultSet.  This resulting 
     * WordEntry is of the form:
     * header|columnIDs|footer|
     */
    public static void addColumnSetWord(final SqlColumnSetAspect aspect, 
        ...
        addColumnSetWord(recordType, objectID, fullName, aspect.getNameInSource(eObject),
                         parentObjectID, aspect.getColumns(eObject), modelPath, name, wordEntries);
    }

    /**
     * Create a {@link com.metamatrix.internal.core.index.impl.WordEntry}
     * instance representing a primaryKey, uniqueKey, index, or access pattern.  This resulting 
     * WordEntry is of the form:
     * header|columnIDs|footer|
     */
    static void addColumnSetWord(final char recordType, final String objectID, 
                                 final String fullName, 
                                 final String nameInSource, final String parentObjectID, 
                                 final List columnIDs, final String modelPath, 
                                 final String name, final Collection wordEntries) {
    ...
    /**
     * Create a {@link com.metamatrix.internal.core.index.impl.WordEntry}
     * instance representing a uniqueKey.  This resulting WordEntry is of the form:
     * header|columnIDs|foreignKeyIDs|footer|
     */
    public static void addUniqueKeyWord(final SqlUniqueKeyAspect aspect, 
        ...
        addUniqueKeyWord(recordType, objectID, fullName, aspect.getNameInSource(eObject), parentObjectID, 
                          aspect.getColumns(eObject), aspect.getForeignKeys(eObject), modelPath, name, wordEntries);
    }
     ...
     * header|columnIDs|foreignKeyIDs|footer|
     */
    static void addUniqueKeyWord(final char recordType, final String objectID, final String fullName, 
                                  final String nameInSource, final String parentObjectID, 
                                  final List columnIDs, final List foreignKeyIDs, 
                                  final String modelPath, final String name, final Collection wordEntries) {
    ...
    /**
     * Create a {@link com.metamatrix.internal.core.index.impl.WordEntry}
     * instance representing a foreignKey.  This resulting WordEntry is of the form:
     * header|columnIDs|uniqueKeyID|footer|
     */
    public static void addForeignKeyWord(final SqlForeignKeyAspect aspect, 
        ...
        addForeignKeyWord(objectID, fullName, aspect.getNameInSource(eObject), parentObjectID, 
                          aspect.getColumns(eObject), uniqueKeyID, modelPath, name, wordEntries);
    }
     ...
     * header|columnIDs|uniqueKeyID|footer|
     */
    static void addForeignKeyWord(final String objectID, final String fullName, 
                                  final String nameInSource, final String parentObjectID, 
                                  final List columnIDs, final String uniqueKeyID, 
                                  final String modelPath, final String name, final Collection wordEntries) {
    ...
    /**
     * Create a {@link com.metamatrix.internal.core.index.impl.WordEntry}
     * instance representing a datatype.  This resulting WordEntry is of the form:
...
//System.out.println(aspect.getDatatypeID(eObject)+", "+aspect.getBasetypeID(eObject)+", "+aspect.getPrimitiveTypeID(eObject));
        ...
        addDatatypeWord(objectID, fullName, 
                        aspect.getNameInSource(eObject), parentObjectID, 
                        aspect.getLength(eObject), aspect.getPrecisionLength(eObject),
                        aspect.getScale(eObject), aspect.getRadix(eObject),
                        aspect.isSigned(eObject), aspect.isAutoIncrement(eObject),
                        aspect.isCaseSensitive(eObject), aspect.getType(eObject),
                        aspect.getSearchType(eObject), aspect.getNullType(eObject),
                        aspect.getJavaClassName(eObject), aspect.getRuntimeTypeName(eObject),
                        aspect.getDatatypeID(eObject), aspect.getBasetypeID(eObject), 
                        aspect.getPrimitiveTypeID(eObject),
                        aspect.getVarietyType(eObject), aspect.getVarietyProps(eObject),
                        modelPath, name, wordEntries);
    }
     ...
     *            scale|radix|primitiveTypeID|footer|
     */
    static void addDatatypeWord(final String objectID, final String fullName, 
                                final String nameInSource, final String parentObjectID, 
                                final int length, final int precisionLength,
                                final int scale, final int radix,
                                final boolean isSigned, final boolean isAutoIncrement,
                                final boolean isCaseSensitive, final short type,
                                final short searchType, final short nullType,
                                final String javaClassName, final String runtimeTypeName,
                                final String datatypeID, final String baseTypeID,
                                final String primitiveTypeID, 
                                final short varietyType, final List varietyProps,
                                final String modelPath, final String name, final Collection wordEntries) {
	...
	/**
	 * Create a {@link com.metamatrix.internal.core.index.impl.WordEntry}
	 * instance representing a annotation.  This resulting WordEntry is of the form:
	 * recordType|objectID|propertyName|value|isExtention|footer|
	 */
	public static void addPropertyWord(final SqlAspect sqlAspect, final EObject eObject, final String modelPath, final Collection wordEntries) {
	 ...
	 * recordType|objectID|propertyName|value|isExtention|footer|
	 */
	public static void addPropertyWord(final String objectID, final String name, final String propName, final String propValue, final boolean isExtention, final String modelPath, final Collection wordEntries) {
    ...
    public static void addAnnotationWord(final SqlAnnotationAspect aspect, 
        ...
        addAnnotationWord(objectID, fullName, aspect.getNameInSource(eObject), parentObjectID, 
     ...
     * header|description|footer|
     */
    static void addAnnotationWord(final String objectID, final String fullName, 
                                  final String nameInSource, final String parentObjectID, 
    ...
    /**
     * Split the specified WordEntry into multiple WordEntry
     * instances if it exceeds the allowable INDEX_RECORD_BLOCK_SIZE.
     * If the entry length does not exceed INDEX_RECORD_BLOCK_SIZE then
     * the original entry will be the only item returned in the list.
     * @param wordEntry
     * @param blockSize
     */
    public static List splitWordEntry(final String objectID, final WordEntry wordEntry, final int blockSize) {
        ...
        // from the WordEntry
        Assertion.assertTrue(blockSize >= (objectID.length()+8));
    ...
    /**
     * Append the index record version information to the StringBuffer.
     * The version information consists of 3 characters, the first being
     * a special marker character followed by two integer value characters
     * for a version range of [0-99].  Version values less than 10 will
     * be preceeded by a 0 character.
     * @param indexVersion
     * @param sb
     * @since 4.2
     */
    protected static void appendIndexVersion(final int indexVersion, final StringBuffer sb) {
        // The range of index versions is [0,99]
        Assertion.assertTrue(indexVersion > -1 && indexVersion < 100);
    ...
    protected static void appendObject(final Object obj, final StringBuffer sb) {
        if (obj != null) {
    ...
    protected static void appendBoolean(final boolean b, final StringBuffer sb) {
        if (b) {
     ...
     */
    protected static void appendStrings(final Collection objs, final StringBuffer sb) {
	 ...
	 * Concatenate the identifiers for each object in the collection
	 */
	protected static void appendStrings(final Map objs, final int indexVersionNumber, final StringBuffer sb) {
		if (objs == null || objs.isEmpty()) {
			sb.append(IndexConstants.RECORD_STRING.SPACE);
			return;
		}
     ...
     * Concatenate the identifiers for each object in the collection
     */
    protected static void appendIDs(final Collection objs, final StringBuffer sb) {
        if (objs == null || objs.isEmpty()) {
            sb.append(IndexConstants.RECORD_STRING.SPACE);
            return;
        }
	...
	protected static void appendID(final Object obj, final StringBuffer sb) {
	 ...
	 * Concatenate the identifiers for each object in the collection
	 */
	protected static void appendURIs(final Collection objs, final int indexVersionNumber, final StringBuffer sb) {
		if (objs == null || objs.isEmpty()) {
			sb.append(IndexConstants.RECORD_STRING.SPACE);
			return;
		}
	...
	protected static void appendURI(final Object obj, final StringBuffer sb, final boolean isMetaClass) {
	...
	protected static String getObjectURIString(final Object obj, final boolean isMetaClass) {
		if (obj == null) {
			return null;
		}
    ...
    protected static Properties getProperties(final String values, final int indexVersionNumber) {
    ...
    protected static Properties getProperties(final String values, final char listDelimiter, final char propDelimiter) {
        ...
        for (Iterator iter = tokens.iterator(); iter.hasNext();) {
            ...
            if (token != null) {
                final List propTokens = StringUtil.split(token,String.valueOf(propDelimiter));
    ...
    /**
     * Add new WordEntry instance to the specified list.  If the
     * size of the WordEntry exceeds the allowable block size then
     * the entry is split into multiple entries and each one added
     * to the list.
     * @param objectID
     * @param sb
     * @param wordEntries
     */
    protected static void addNewWordEntryToList(final String objectID, final StringBuffer sb,  final Collection wordEntries) {
    ...
    /**
     * Create the initial "header" portion of an index record.  This
     * header is common to all record types and is of the form: 
     * recordType|upperFullName|objectID|fullName|nameInSource|parentObjectID
     */
    private static void appendWordHeader(final char recordType, final String objectID,
                                         final String fullName, final String nameInSource,
                                         final String parentObjectID, final StringBuffer sb) {
    ...
    /**
     * Create the initial "footer" portion of an index record.  This
     * footer is common to all record types and is of the form: 
     * modelPath|name
     */
    private static void appendWordFooter(final String modelPath, final String name, final StringBuffer sb) {
        sb.append(IndexConstants.RECORD_STRING.RECORD_DELIMITER);
    ...
    /**
     * Create the continuation "header" portion of an index record.  This
     * header is used to prefix a record that is a continuation of another
     * record and is of the form: 
     * RECORD_CONTINUATION|objectID|segmentCount|
     */
    private static void appendContinuationHeader(final char recordType, final String objectID, 
                                                 final int segCount, final StringBuffer sb) {
    ...
    /**
     * Pad the string buffer with spaces out to blockSize -1 and then
     * add the RECORD_CONTINUATION at the blockSize index.
     */
    private static void appendContinuationTrailer(final int blockSize, final StringBuffer sb) {
        int blanksToAdd = blockSize - sb.length() - 1;
        Assertion.assertTrue(blanksToAdd >= 0);
    ...
    public static WordEntry createTestWordEntry(final char recordType, final int numFields, final String fieldValue) {
        final StringBuffer sb = new StringBuffer(getIniitalBufferSize());
        sb.append(recordType);
        sb.append(IndexConstants.RECORD_STRING.RECORD_DELIMITER);
    ...
    public static WordEntry createTestWordEntry(final char recordType, final int numFields, final Collection fieldValue) {
        final StringBuffer sb = new StringBuffer(getIniitalBufferSize());
        sb.append(recordType);
        sb.append(IndexConstants.RECORD_STRING.RECORD_DELIMITER);
    ...
    public static WordEntry createTestWordEntry(final char recordType, final int numFields, final Map fieldValue) {
        final StringBuffer sb = new StringBuffer(getIniitalBufferSize());
        sb.append(recordType);
        sb.append(IndexConstants.RECORD_STRING.RECORD_DELIMITER);
