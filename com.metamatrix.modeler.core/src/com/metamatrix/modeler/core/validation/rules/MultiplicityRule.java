...
/**
 * MultiplicityRule, this is a core rule that needs to be run for all features, this rule
 * checks the multiplicity of a feature with the upper and lower bounds of multiplicity allowed
 * for that feature.
 */
public class MultiplicityRule implements StructuralFeatureValidationRule {
    ...
    public void validate(
        ...
        final boolean lowerViolated = lowerBound != ETypedElement.UNBOUNDED_MULTIPLICITY && 
                                      featureReferences < lowerBound;
        final boolean upperViolated = upperBound != ETypedElement.UNBOUNDED_MULTIPLICITY && 
                                      featureReferences > upperBound;
                    ...
                    if ( oppositeName != null ) {
                        if ( containment ) {
                            if ( upperBound == ETypedElement.UNBOUNDED_MULTIPLICITY ) {
                                ...
                                final Object[] params = new Object[] {className,new Integer(lowerBound),new Integer(upperBound),featureName,actual};
                        ...
                        if ( upperBound == ETypedElement.UNBOUNDED_MULTIPLICITY ) {
                            ...
                            final Object[] params = new Object[] {new Integer(lowerBound),new Integer(upperBound),featureName,actual};
