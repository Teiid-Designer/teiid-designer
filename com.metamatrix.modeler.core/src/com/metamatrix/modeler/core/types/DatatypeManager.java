...
//     * to the set of predefined MetaMatrix datatypes. By calling this method
...
//    void setParentDatatypeManager(DatatypeManager parentMgr);
    ...
    /**
     * Return a reference to the DatatypeManager used exclusively for
     * built-in datatypes or null if the implementation does not support
     * this concept.
     */
    DatatypeManager getBuiltInTypeManager();
    
    /**
     * Return the <code>EObject</code> instance representing
     * the ur type of "anySimpleType" as defined in XML Schema.
     * 
     * @return
     */
    ...
    /**
     * Return the <code>EObject</code> instance representing
     * the ur type of "anyType" as defined in XML Schema.
     * 
     * @return
     */
     ...
     * all datatypes known to the manager.
     * 
     * @return
     */
    ...
    /**
     * Return the array of <code>EObject</code> instances representing
     * all built-in datatypes known to the manager.
     * 
     * @return
     */
    ...
    /**
     * Return the array of <code>EObject</code> instances representing
     * all datatypes that are allowable values for the specified
     * <code>EStructuralFeature</code>.
     * 
     * @return
     */
    EObject[] getAllowableTypeValues(EObject eObject, EStructuralFeature feature) throws ModelerCoreException;
       
    /**
     * Return the array of <code>EObject</code> instances representing
     * all datatypes that are allowable values for the basetype definition 
     * feature of an atomic simple type.
     * 
     * @return
     */
    ...
    /**
     * Return the array of <code>EObject</code> instances representing
     * all datatypes that are allowable values for the item type definition
     * feature of an list simple type.
     * 
     * @return
     */
    ...
    /**
     * Return the array of <code>EObject</code> instances representing
     * all datatypes that are allowable values for the member type definition
     * feature of an union simple type.
     * 
     * @return
     */
    ...
    /**
     * Return the <code>EObject</code> instance representing
     * the default built-in datatype for the specified runtime 
     * datatype name or null if a datatype by that name does not exist.
    ...
    /**
     * Return the <code>EObject</code> instance representing
     * the built-in datatype with the specified name or null
     * if a datatype by that name does not exist.
    ...
    /**
     * Returns true if the <code>EObject</code> instance represents
     * a MetaMatrix built-in datatype (an extension of the XSD 
     * built-in datatypes).
    ...
    /**
     * Return the <code>EObject</code> instance for the datatype with
     * the specified identifier or null if none exists.  The identifier
     * may be in the form of a URI reference constructed as follows:
     * <p>
     ...
     * @param the unique identifier of the datatype to return;
     * may not be null.
     * @return the datatype for the specified id or null if a 
     * datatype with that id cannot be found.
     */ 
    EObject findDatatype(String id) throws ModelerCoreException;

    /** 
     * Return the <code>EObject</code> instance for the datatype from
     * the specified XSDSimpleTypeDefinition or AnySimpleType if one can not be
     * determined.
     */
    EObject getDatatypeForXsdType(final EObject xsdType) throws ModelerCoreException;
    
    /**
     * Return the runtime type java class name associated with
     * the datatype having the specified identifier or null if no datatype
     * with this identifier exists.  The identifier may be in the form 
     * of a URI reference constructed as follows:
     * <p>
     * 1. the base URI of the XML Schema namespace
     * 2. the fragment identifier defining the name of the datatype
     * </p>
     ...
     * @return the name of the java class or null if the
     * it does not exist.
     */ 
    String getRuntimeTypeJavaClassName(String id) throws ModelerCoreException;
    
    /**
     * Return the name of the runtime type associated with 
     * the datatype having the specified identifier or null if no datatype
     * with this identifier exists.  The identifier may be in the form 
     * of a URI reference constructed as follows:
     * <p>
     ...
     * or may represent the string form of an <code>ObjectID</code>
     * @param the unique identifier of the datatype; may not be null.
     * @return the name of the runtime type or null if the
     * runtime type does not exist.
     */ 
     ...
     * @return the name of the runtime data access or null if the
     * runtime type does not exist.
     */ 
    ...
    /**
     * Get the <code>EObject</code> instance representing the  
     * data type that the specified simple data type is derived from.  
     * If the specified simple data type is considered a built-in primative 
     * data type, then there is no base type and null is returned.
    ...
    /**
     * Get the array <code>EObject</code> instances for all datatypes that
     * extend/restrict the the specified datatype. If none exist then
    ...
    /**
     * Get the array <code>EObject</code> instances for all datatypes that
     * are built-in primative datatypes. 
    ...
    /**
     * Return the <code>EObject</code> instance representing
     * the built-in primitive datatype from which this datatype
     * extends or restricts.
     * @param eObject The datatype whose primitive type we 
     * want to return; may not be null
     * @return
     */
    EObject getBuiltInPrimitiveType(EObject type);
        
    /**
     * Return true if, for the specified <code>EObject</code> instance 
     * representing a simple datatype, the datatype is numeric
    ...
    /**
     * Return true if, for the specified <code>EObject</code> instance 
     * representing a simple datatype, extends or restricts the built-in 
     * primitive type of "decimal"
     * @param eObject The <code>EObject</code> to check; may not be null
     * @return
     */
    ...
    /**
     * Return true if, for the specified <code>EObject</code> instance 
     * representing a simple datatype, extends or restricts one of the
     * MetaMatrix the built-in types of "object", "blob", or "clob"
     * @param eObject The <code>EObject</code> to check; may not be null
     * @return
     */
    ...
    /**
     * Return the description associated with the specified 
     * <code>EObject</code> instance representing a simple datatype.
     * If a description does not exist and empty string is returned.
     * @param eObject The <code>EObject</code> to check; may not be null
     * @return
     */
     ...
     * @return the <code>EnterpriseDatatypeInfo</code> for the enterprise datatype; if
     * this is not an enterprise datatype, null is returned.  
     */    
    EnterpriseDatatypeInfo getEnterpriseDatatypeInfo(XSDSimpleTypeDefinition simpleType);
    
    /**
     * Set the basetype definition on the <code>XSDSimpleTypeDefinition</code>.
     * Add an import and namespace declaration if necessary 
     * @param simpleType
     * @param baseType
     */
    void setBasetypeDefinition(final XSDSimpleTypeDefinition simpleType, final XSDSimpleTypeDefinition baseType);    
