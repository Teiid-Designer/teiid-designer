    ...
    public String[] getDataSourceNames() {
        ...
        if ((defaultServer != null) && defaultServer.isConnected()) {
            ...
            try {
                ...
                UTIL.log(IStatus.ERROR,
                         e,
                         UTIL.getString("VdbSourceConnectionHandler.errorObtainingDataSources", defaultServer.getTeiidAdminInfo().getURL())); //$NON-NLS-1$
            }
    ...
    public String[] getTranslatorTypes() {
        ...
        if ((defaultServer != null) && defaultServer.isConnected()) {
            ...
            try {
                ...
                UTIL.log(IStatus.ERROR,
                         e,
                         UTIL.getString("VdbSourceConnectionHandler.errorObtainingTranslators", defaultServer.getTeiidAdminInfo().getURL())); //$NON-NLS-1$
            }
