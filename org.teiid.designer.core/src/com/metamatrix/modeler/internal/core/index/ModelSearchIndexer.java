...
public class ModelSearchIndexer extends ModelIndexer {
     ...
     * instance representing a EObject within a resource.  This resulting WordEntry is of the form:
     * uuid|metamodelURI#EClass|modelPath|
     * @see com.metamatrix.modeler.internal.core.index.ModelIndexer#addIndexWord(org.eclipse.emf.ecore.EObject, java.lang.String, java.util.List)
     */
    protected void addIndexWord(final EObject eObject, final String modelPath, final List wordEntries) {
    ...
    @Override
    protected void addIndexWord(final EObject eObject, IndexingContext context, final String modelPath, final List wordEntries) {
        addIndexWord(eObject, modelPath, wordEntries);
    }
    
    /** 
     * @see com.metamatrix.modeler.internal.core.index.ModelIndexer#addResourceWordEntries(com.metamatrix.internal.core.index.IDocument, java.util.List)
     */
    @Override
    protected void addResourceWordEntries(final IDocument document, final List wordEntries) {
		...
		if(document instanceof ModelDocument) { 
			...
			try {
				...
				SearchRuntimeAdapter.addResourceSearchWords(modelResource.getUuid(),
								...
								primaryMetamodelURI,
								modelResource.getModelType().getName(), wordEntries);
			...
			if(header != null) {
				...
				SearchRuntimeAdapter.addResourceSearchWords(header.getUUID(),
								 ...
								 ModelType.VDB_ARCHIVE_LITERAL.getName(), wordEntries);				
			}
		}
    }
