...
public interface MetamodelBuilderConstants {
	...
	final String[] EXTENSIONS_PROCESSING_ORDER = new String [] { XPACKAGE_TABLE,
		XCLASS_TABLE,XENUM_TABLE,XATTRIBUTE_TABLE,XENUM_LITERAL_TABLE
	};
	...
	final String[] RELATIONAL_PROCESSING_ORDER = new String [] { CATALOG_TABLE, SCHEMA_TABLE,
		BASETABLE_TABLE, VIEW_TABLE, PROCEDURE_TABLE, COLUMN_TABLE, PROCEDURE_RESULT_TABLE,
		PROCEDURE_PARAMETER_TABLE, INDEX_TABLE, PRIMARY_KEY_TABLE, FOREIGN_KEY_TABLE,
