 ...
 * DrawingEditPart
 */
public class DrawingEditPart extends AbstractGraphicalEditPart implements PropertyChangeListener, DiagramEditPart {
    ...
    **/
    ...
    protected DrawingFigureFactory getFigureFactory() {
        if (drawingFigureFactory == null) drawingFigureFactory = new DrawingFigureFactory();
