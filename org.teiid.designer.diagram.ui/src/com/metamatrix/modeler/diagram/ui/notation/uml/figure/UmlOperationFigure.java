 ...
 * UmlOperationFigure
 */
public class UmlOperationFigure extends LabeledRectangleFigure implements DirectEditFigure {
	...
	public UmlOperationFigure(String labelString, ColorPalette colorPalette) {
		super(labelString, true, colorPalette);
		showSelected(false);
	}
    
    
	public UmlOperationFigure(String labelString, Image icon, ColorPalette colorPalette) {
		super(labelString, icon, true, colorPalette);
		showSelected(false);
	}
    
    
	public UmlOperationFigure(String labelString, Font newFont, ColorPalette colorPalette) {
