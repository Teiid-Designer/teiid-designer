...
public class EnablePreviewPreferenceContributor implements IGeneralPreferencePageContributor, DqpUiConstants {
    ...
    private static final String PREFIX = I18nUtil.getPropertyPrefix(EnablePreviewPreferenceContributor.class);
    ...
    public boolean performDefaults() {
        this.chkEnabled.setSelection(PreferenceConstants.PREVIEW_ENABLED_DEFAULT);
    ...
    public boolean performOk() {
        ...
        prefs.putBoolean(PreferenceConstants.PREVIEW_ENABLED, this.chkEnabled.getSelection());
    ...
    public void refresh() {
        IEclipsePreferences prefs = getPreferences();
        boolean enable = prefs.getBoolean(PreferenceConstants.PREVIEW_ENABLED, PreferenceConstants.PREVIEW_ENABLED_DEFAULT);
