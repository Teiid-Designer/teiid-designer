 ...
 * @since 4.2
 */
public class PresentationEntityNameToNameIgnoreCaseMatcher extends AbstractEObjectNameMatcher {

    /** 
     * 
     * @since 4.2
     */
    public PresentationEntityNameToNameIgnoreCaseMatcher() {
        super();
    }
    ...
    protected String getInputKey(EObject entity) {
        if(entity instanceof PresentationEntity) {
            final String name = ((PresentationEntity)entity).getName();
            if(name != null) {
