...
start eclipse\eclipse.exe -consoleLog -debug -data workspace -vmargs -Xrunyjpagent:cpu=times,onexit=cpu,dir=d:\scott\snapshots -Xbootclasspath/a:license -Xms128M -Xmx512M -Djavax.net.ssl.trustStore=license\mmdemo.truststore -Dmetamatrix.config.none
