...
public interface IModelerProductContexts extends IProductContexts {
    ...
    interface Metamodel {
        ...
        /**
         * The Metamodel URI context can be used to determine if a product supports a specific metamodel URI that are
         * visible to the user
         * @since 5.0
         */
    ...
    interface License {
        /**
         * The context used to determine if a licence capability is supported by a product.
         * @since 4.3
         * @see com.metamatrix.modeler.ui.UiConstants.ProductInfo.Capabilities
         */
        IProductContext CAPABILITY = new ProductContext(Categories.LICENSE, "capability"); //$NON-NLS-1$
    }
    ...
    interface PreferencePages {
        /**
         * The context used to determine if modeler preference page should include the functionality of
    ...
    interface Actions {
        /**
         * The context used to determine if a main menu is supported by a product. Use the menu identifier as the
         * value being checked.
        ...
        /**
         * The context used to determine if a submenu is supported by a product. Use the menu identifier as the
         * value being checked.
         * @see com.metamatrix.modeler.ui.actions.IModelerRcpActionIds
         * @since 4.4
         */
        ...
        /**
         * The context used to determine if an action is supported by a product. Use the action dentifier as the
         * value being checked.
         * @see com.metamatrix.modeler.ui.actions.IModelerRcpActionIds
         * @since 4.4
         */
        ...
        /**
         * The context used to determine if an action is supported by a product. Use the action dentifier as the
         * value being checked. Use the full class name for the value (i.e. com.metamatrix.modeler.internal.ui.ShowModelStatisticsAction)
         * @see com.metamatrix.modeler.ui.actions.IModelerRcpActionIds
         * @since 4.4
         */
        ...
        /**
         * The context used to determine if an action is supported by a product. Use the action dentifier as the
         * value being checked. Use the full class name for the value (i.e. com.metamatrix.modeler.internal.ui.GenerateSqlRelationshipsAction)
         * @see com.metamatrix.modeler.ui.actions.IModelerRcpActionIds
         * @since 4.4
         */
