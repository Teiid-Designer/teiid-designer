 ...
 * Modeler General Preferences.
 */
public class ModelerPreferencePage
...
implements IWorkbenchPreferencePage, UiConstants {
	...
	public ModelerPreferencePage() {
		...
		setDescription(Util.getString("ModelerPreferencePage.description")); //$NON-NLS-1$
		initializeDefaults();
	}
/**
 ...
 */
    ...
    public void createFieldEditors() {
		...
		addField(new StringFieldEditor(P_STRING, Util.getString("ModelerPreferencePage.A_&text_preference__15"), //$NON-NLS-1$
                                       getFieldEditorParent()));
	}
