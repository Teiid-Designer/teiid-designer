...
public class DeleteMappingLinksAction extends MappingAction {
            ...
            if( getMappingClassFactory() != null) {
                ...
                try {
                    ...
                    while( iter.hasNext() ) {
                        ...
                        if( isMappingClassColumn(mappingRef) )
                        ...
                        if( mcc != null && locationEObject != null )
                            getMappingClassFactory().removeLocation(mcc, locationEObject);
            ...
            if( canWrite && getMappingClassFactory() != null) {
                ...
                if( selectedEditParts != null && !selectedEditParts.isEmpty()) {
                    ...
                    while( iter.hasNext() && allOK ) {
                        ...
                        if( isMappingClassColumn(object) )
                            mcc = (MappingClassColumn)object;
                            
                        locationEObject = ((MappingExtentNode)nextMEEP.getModel()).getExtent().getDocumentNodeReference();
                        
                        if( mcc != null && locationEObject != null )
                            allOK = getMappingClassFactory().canRemoveLocation(mcc, locationEObject);
                        else
                            allOK = false;
                    }
    ...
    private List getSelectedMappedExtents() {
        ...
        while( iter.hasNext() && allOK ) {
            ...
            if( ! (nextObject instanceof MappingExtentEditPart) )
                allOK = false;
        }
