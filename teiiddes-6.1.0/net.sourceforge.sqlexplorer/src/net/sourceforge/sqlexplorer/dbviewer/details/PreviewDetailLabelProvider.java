...
class PreviewDetailLabelProvider
	extends LabelProvider
	implements ITableLabelProvider {

	PreviewDetailTableModel pdtm;
	public PreviewDetailLabelProvider(PreviewDetailTableModel pdtm){
		this.pdtm=pdtm;
	}
	/**
	...
	public String getColumnText(Object element, int columnIndex) {
		Object obj=pdtm.getValue(element,columnIndex);
		if(obj!=null)
			return obj.toString();
        return nullString;
	}
