...
/**
 * @author blafond
 * AbstractFreeDiagramModelNode
 * This class provides a base class for any DiagramModelNode that doesn't have any need for
 * an EObject or DiagramEntity.
 * First cut is for Label objects on Associations
 */
abstract public class AbstractFreeDiagramModelNode implements DiagramModelNode, DiagramUiConstants {
    ...
    public void setPosition(Point position) {
        if ( Util.isDebugEnabled(DebugConstants.DIAGRAM_MODEL_NODE) &&  Util.isDebugEnabled(com.metamatrix.modeler.internal.ui.DebugConstants.TRACE)) {
            debugMessage = ".setPosition():  New Position for " + getName() + " diagram node = " + position; //$NON-NLS-2$ //$NON-NLS-1$
    ...
    public void setSize(Dimension dimension) {
        if ( Util.isDebugEnabled(DebugConstants.DIAGRAM_MODEL_NODE) &&  Util.isDebugEnabled(com.metamatrix.modeler.internal.ui.DebugConstants.TRACE)) {
            debugMessage = ".setPosition():  New dimension for " + getName() + " diagram node = " + dimension; //$NON-NLS-2$ //$NON-NLS-1$
            Util.print(this.getClass(), debugMessage);
        }
    ...
    public void setName(String name) {
        if( this.name == null || ! this.name.equals(name)) {
            ...
            if ( Util.isDebugEnabled(DebugConstants.DIAGRAM_MODEL_NODE) &&  Util.isDebugEnabled(com.metamatrix.modeler.internal.ui.DebugConstants.TRACE)) {
                debugMessage = ".setName():  Just changed [" + oldName + "] name to: [" + name + "]"; //$NON-NLS-3$ //$NON-NLS-2$ //$NON-NLS-1$
                Util.print(this.getClass(), debugMessage);
            }
