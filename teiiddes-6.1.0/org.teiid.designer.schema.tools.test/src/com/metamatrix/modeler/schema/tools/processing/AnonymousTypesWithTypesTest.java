...
public class AnonymousTypesWithTypesTest extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        try {
            ...
            fail("Exception in AnonymousTypeWithTypesTest setUp: " + e.getMessage()); //$NON-NLS-1$
        }
    }
    ...
    public void testRootElementsSize() {
        try {
            ...
            assertTrue("Roots size should be 4 not " + roots.size(), roots.size() == 4); //$NON-NLS-1$
        } catch (Exception e) {
            fail("Exception in AnonymousTypeWithTypesTest testRootElementsSize: " + e.getMessage()); //$NON-NLS-1$
        }
    }
    ...
    public void testSelectedRootElementsSize() {
        try {
            ...
            assertTrue("Selected roots size should be 2 not " + count, 2 == count); //$NON-NLS-1$
        } catch (Exception e) {
            fail("Exception in AnonymousTypeWithTypesTest testSelectedRootElementsSize: " + e.getMessage()); //$NON-NLS-1$
        }
    }
    ...
    public void testCountFoldedElements() {
        try {
            ...
            model.setTypeAsRoot("Alpha", "http://www.example.org/Anonymous_Type"); //$NON-NLS-1$ //$NON-NLS-2$
            ...
            fail("Exception in AnonymousTypeWithTypesTest testCountFoldedElements: " + e.getMessage()); //$NON-NLS-1$
        }
    }
