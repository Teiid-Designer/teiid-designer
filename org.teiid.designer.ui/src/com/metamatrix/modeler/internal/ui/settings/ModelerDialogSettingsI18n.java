...
public final class ModelerDialogSettingsI18n extends NLS {
    ...
    static {
        final String I18N_NAME = "com.metamatrix.modeler.internal.ui.settings.modelerDialogSettingsI18n";//$NON-NLS-1$
        
        // load message values from bundle file
        NLS.initializeMessages(I18N_NAME, ModelerDialogSettingsI18n.class);
    }
