...
public class QueryClient {
    private static final SimpleDateFormat dateFormat = new SimpleDateFormat("-HH_mm_ss_MMM_dd"); //$NON-NLS-1$
     ...
     * @return
     */
    public String buildConnectionURL(String executionDir, String theVdbName, String theVersion, Properties executionProps) {
