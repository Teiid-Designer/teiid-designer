...
public class Uml2AssociationUmlAspect extends AbstractUml2UmlAspect implements UmlAssociation {
	 ...
	 */
	 public String getRoleName(final Object assoc, final int end) {
	 ...
	 */
	public String getMultiplicity(Object assoc, int end) {
		final Association a = assertAssociation(assoc);
	 ...
	 */
	public int getAggregation(final Object assoc, final int end) {
		final Association a = assertAssociation(assoc);
	 ...
	 */
	public int getNavigability(final Object assoc, final int end) {
		final Association a  = assertAssociation(assoc);
	 ...
	 */
	public EObject getEnd(final Object assoc, final int end) {
		final Association a = assertAssociation(assoc);
        final Property aEnd = getOppositeEnd(a, end);
        //final Property aEnd = getAssociationEnd(a, end);
		return aEnd;
	 ...
	 */
	public EObject getEndTarget(final Object assoc, final int end) {
		final Association a = assertAssociation(assoc);
        final Property aEnd = getOppositeEnd(a, end);
		return aEnd.getType();
	}
	...
	public IStatus setRoleName(Object assoc, int end, String name) {
		throw new UnsupportedOperationException(Uml2Plugin.Util.getString("Uml2AssociationUmlAspect.Signature_may_not_be_set_on_a_1",getStereotype(assoc))); //$NON-NLS-1$
	}
	...
	public IStatus setMultiplicity(Object assoc, int end, String mult) {
		...
		//			return new Status(IStatus.OK, Uml2MetamodelConstants.PLUGIN_ID, 0, "OK", null);  
		//		}
		return new Status(IStatus.ERROR, Uml2MetamodelConstants.PLUGIN_ID, 0, Uml2Plugin.Util.getString("Uml2AssociationUmlAspect.Invalid_end_11"), null); //$NON-NLS-1$
	...
	public IStatus setProperties(Object assoc, int end, String[] props) {
		throw new UnsupportedOperationException(Uml2Plugin.Util.getString("Uml2AssociationUmlAspect.Properties_may_not_be_set_on_a__12", getStereotype(assoc))); //$NON-NLS-1$
	}
	...
	public IStatus setNavigability(Object assoc, int end, int navigability) {
		throw new UnsupportedOperationException(Uml2Plugin.Util.getString("Uml2AssociationUmlAspect.Navigability_may_not_be_set_on_a__13", getStereotype(assoc))); //$NON-NLS-1$
	}

	/* (non-Javadoc)
	 * @see com.metamatrix.modeler.core.metamodel.aspect.uml.UmlDiagramAspect#getIconPath(java.lang.Object)
	 */
	public String getIconPath(Object eObject) {
	...
	public IStatus setSignature(Object eObject, String newSignature) {
		...
		return new Status(IStatus.OK, Uml2MetamodelConstants.PLUGIN_ID, 0, Uml2Plugin.Util.getString("Uml2AssociationUmlAspect.OK_15"), null); //$NON-NLS-1$
	}
    ...
    public String toString(Object eObject) {
        final Association a = assertAssociation(eObject);
        final StringBuffer sb = new StringBuffer(200);
    ...
    private Property getOppositeEnd( final Association assoc, final int end) {
        final int oppositeEnd = (end == 0 ? 1 : 0);
        return this.getAssociationEnd(assoc,oppositeEnd);
    }

	private Property getAssociationEnd( final Association assoc, final int end) {
