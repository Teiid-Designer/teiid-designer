...
public abstract class AbstractUml2NamedElementUmlAspect extends AbstractUml2ElementUmlAspect {
    ...
    protected void appendName( final NamedElement namedElement, final StringBuffer sb ) {
        this.appendName(namedElement,sb,false);
    }

    protected void appendName( final NamedElement namedElement, final StringBuffer sb, final boolean upperCaseFirstLetter ) {
