...
/**
 * This is the item provider adapter for a {@link com.metamatrix.metamodels.history.Branch} object. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * 
 * @generated
 */
public class BranchItemProvider extends HistoryLogEntryItemProvider {
    /**
    ...
    protected void addVersionPropertyDescriptor( Object object ) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                                                                 getResourceLocator(),
                                                                 getString("_UI_Branch_version_feature"), //$NON-NLS-1$
                                                                 getString("_UI_PropertyDescriptor_description", "_UI_Branch_version_feature", "_UI_Branch_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                                                                 HistoryPackage.eINSTANCE.getBranch_Version(),
                                                                 true,
    ...
    public Object getImage( Object object ) {
        return getResourceLocator().getImage("full/obj16/Branch"); //$NON-NLS-1$
    }
    ...
    public String getText( Object object ) {
        String label = ((Branch)object).getTimestamp();
        return label == null || label.length() == 0 ? getString("_UI_Branch_type") : //$NON-NLS-1$
        getString("_UI_Branch_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
