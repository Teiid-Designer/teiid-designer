...
public class TransformationEditPart extends AbstractDiagramEditPart implements EditableEditPart {
    ...
    private static final String THIS_CLASS = "TransformationEditPart"; //$NON-NLS-1$
    ...
    **/
    ...
    public void propertyChange(PropertyChangeEvent evt) {
        ...
        if (prop.equals(DiagramUiConstants.DiagramNodeProperties.CONNECTION)) {
            if ( UiConstants.Util.isDebugEnabled(com.metamatrix.modeler.internal.ui.DebugConstants.PROPERTIES) && 
                 UiConstants.Util.isDebugEnabled(com.metamatrix.modeler.internal.ui.DebugConstants.TRACE)) { 
                UiConstants.Util.debug(com.metamatrix.modeler.internal.ui.DebugConstants.PROPERTIES, 
    ...
    **/
    ...
    public ConnectionAnchor getAnchor() {
        if( singleAnchor == null )
            singleAnchor = new ChopboxAnchor(this.getFigure());
