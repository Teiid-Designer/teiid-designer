...
public class ProjectionNodeImpl extends OperationNodeImpl implements ProjectionNode {
    ...
    protected EClass eStaticClass() {
        return TransformationPackage.eINSTANCE.getProjectionNode();
    }
    ...
    public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
        if (featureID >= 0) {
            switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
                ...
                case TransformationPackage.PROJECTION_NODE__OUTPUT_LINKS:
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
        if (featureID >= 0) {
            switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
                case TransformationPackage.PROJECTION_NODE__OWNER:
                    return eBasicSetContainer(null, TransformationPackage.PROJECTION_NODE__OWNER, msgs);
                case TransformationPackage.PROJECTION_NODE__INPUT_LINKS:
                ...
                case TransformationPackage.PROJECTION_NODE__NODE_GROUP:
                    return eBasicSetContainer(null, TransformationPackage.PROJECTION_NODE__NODE_GROUP, msgs);
                default:
