...
public class FunctionPackageImpl extends EPackageImpl implements FunctionPackage {
    ...
    public void initializePackageContents() {
        ...
        initEAttribute(getScalarFunction_Deterministic(), ecorePackage.getEBoolean(), "deterministic", "false", 0, 1, ScalarFunction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$ //$NON-NLS-2$
