    ...
    private class AnchorListManager {
        ...
        public void addAnchor(DiagramEditPart editPart, NodeConnectionAnchor anchor) {
            ...
            if( direction == EAST || direction == WEST )
                newPositionValue = newPosition.y;
            else
                newPositionValue = newPosition.x;
            
            // Now we need to check the relative position of this anchor based on direction

            if( anchorArray.isEmpty() )
                anchorArray.add(new AnchorInfo(anchor, newPositionValue));
            else {
