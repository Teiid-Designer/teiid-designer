...
public interface DiagramUiConstants {
     ...
     * @since 4.0
     */
    String PLUGIN_ID = "com.metamatrix.modeler.diagram.ui"; //$NON-NLS-1$
    ...
    interface ExtensionPoints {
        interface Diagram {
            String ID = "diagram"; //$NON-NLS-1$
        }
        
        interface Notation {
            String ID = "notation"; //$NON-NLS-1$
        }
    ...
    /**
     * Constants related to properties of 'foreign' (i.e., GEF) actions
     * @since 4.0
     */
    interface ForeignActionProperties {

        String ZOOMIN_TEXTID   = "DiagramForeignActions.zoomin.textid"; //$NON-NLS-1$
        String ZOOMOUT_TEXTID  = "DiagramForeignActions.zoomout.textid"; //$NON-NLS-1$
        String PRINT_TEXTID    = "DiagramForeignActions.print.textid"; //$NON-NLS-1$ 
    }
     ...
     * @since 4.0
     */
    interface DiagramActionProperties {

        String FONTUP_TEXTID   = "DiagramActions.fontup.textid"; //$NON-NLS-1$
        String FONTDOWN_TEXTID  = "DiagramActions.fontdown.textid"; //$NON-NLS-1$
        String AUTOLAYOUT_TEXTID    = "DiagramActions.autolayout.textid"; //$NON-NLS-1$ 
    }  
