 ...
 * NewRectangleAction
 */
public class NewRectangleAction extends DrawingAction {
    ...
    public NewRectangleAction() {
        super();
        setImageDescriptor(DiagramUiPlugin.getDefault().getImageDescriptor(DiagramUiConstants.Images.NEW_RECTANGLE));
    ...
    protected void doRun() {
        ...
        if( diagramNode != null ) {
            DiagramModelNode newNode = DrawingModelFactory.createModelNode(DrawingConstants.TypeId.RECTANGLE, diagramNode);
            if( newNode != null )
