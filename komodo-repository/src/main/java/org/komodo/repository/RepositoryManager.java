...
import org.komodo.repository.artifact.RepositoryConstants;
...
public class RepositoryManager implements RepositoryConstants {
    ...
    /**
     * Shutdowns the repository manager (including the persistence manager, query manager, and derived artifacts).
