...
/**
 * An S-RAMP translator artifact.
 */
final class SrampTranslatorArtifact extends Translator implements TranslatorArtifact, SrampArtifact {
    ...
    /**
     * @param delegate the S-RAMP translator artifact (cannot be <code>null</code>)
     * @param repository the S-RAMP repository where the artifact is found (cannot be <code>null</code>)
     */
    public SrampTranslatorArtifact(final ExtendedArtifactType delegate,
                                   final SrampRepository repository) {
        Precondition.notNull(delegate, "delegate"); //$NON-NLS-1$
        Precondition.matchesExactly(delegate.getExtendedType(), TranslatorArtifact.TYPE.getId(), "translator artifact type"); //$NON-NLS-1$
    ...
    public Type getArtifactType() {
        return TranslatorArtifact.TYPE;
    }
     ...
     * {@inheritDoc}
     *
     * @see org.komodo.teiid.model.vdb.Translator#getTranslatorType()
     */
    @Override
    public String getTranslatorType() {
        return getProperty(Translator.PropertyName.TYPE);
    }
     ...
     * {@inheritDoc}
     *
     * @see org.komodo.teiid.model.vdb.Translator#setType(java.lang.String)
     */
    @Override
