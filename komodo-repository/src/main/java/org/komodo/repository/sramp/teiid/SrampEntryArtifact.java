...
/**
 * An S-RAMP VDB entry artifact.
 */
final class SrampEntryArtifact extends Entry implements EntryArtifact, SrampArtifact {
    ...
    /**
     * @param delegate the S-RAMP entry artifact (cannot be <code>null</code>)
     * @param repository the S-RAMP repository where the artifact is found (cannot be <code>null</code>)
     */
    public SrampEntryArtifact(final ExtendedArtifactType delegate,
                              final SrampRepository repository) {
        Precondition.notNull(delegate, "delegate"); //$NON-NLS-1$
        Precondition.matchesExactly(delegate.getExtendedType(), EntryArtifact.TYPE.getId(), "entry artifact type"); //$NON-NLS-1$
     ...
     * {@inheritDoc}
     *
     * @see org.komodo.teiid.model.vdb.Entry#getPath()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.komodo.teiid.model.vdb.Entry#setPath(java.lang.String)
     */
    @Override
