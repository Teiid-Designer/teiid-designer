...
public class VdbArtifact implements Artifact {
    ...
    public VdbArtifact(final String simpleName,
        ...
        ((UserDefinedArtifactType)this.delegate).setUserType(ARTIFACT_TYPE);
    }
     ...
     * {@inheritDoc}
     *
     * @see org.komodo.repository.artifact.Artifact#getDelegate()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.komodo.repository.artifact.Artifact#getFullName()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.komodo.repository.artifact.Artifact#getParentPath()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.komodo.repository.artifact.Artifact#getName()
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.komodo.repository.artifact.Artifact#getType()
     */
    @Override
