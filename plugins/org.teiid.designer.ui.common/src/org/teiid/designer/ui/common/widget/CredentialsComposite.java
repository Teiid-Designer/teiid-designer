 ...
 * @since 8.0
 */
public class CredentialsComposite extends Composite implements UiConstants, Listener, ICredentialsCommon {
	...
	public CredentialsComposite(Composite parent, int style, String wsType) {
		...
		securityCombo.setItems(
				new String[] { SecurityType.None.name(), SecurityType.HTTPBasic.name(), SecurityType.Digest.name() });
