...
//            column.setEditingSupport(new TranslatorOverridePropertyEditingSupport(this.propertiesViewer, this.vdb.getFile()));
    ...
    void handleAddProperty() {
        ...
        MessageDialog.openWarning(getShell(), "NOT YET IMPLEMENTED", "handleAddProperty() not yet supported");
...
//            translator.addOverrideProperty(property);
//
...
//        }
    ...
    void handleEditProperty() {
        ...
        MessageDialog.openWarning(getShell(), "NOT YET IMPLEMENTED", "handleEditProperty() not yet supported");
...
//
//            if (dialog.open() == Window.OK) {
//                translatorOverride = new Translator(this.vdb, dialog.getName(), dialog.getType(), null);
//            }
//        } else {
...
//        }
    ...
    void handleEditTranslatorOverride() {
        ...
        MessageDialog.openWarning(getShell(), "NOT YET IMPLEMENTED", "handleEditTranslatorOverride() not yet supported");
