 ...
 *
 */
public class VdbNoTeiidServerVersionResolutionGenerator extends VdbMarkerResolutionGenerator {
	/**
     * {@inheritDoc}
     * 
    ...
    public IMarkerResolution[] getResolutions(IMarker marker) {
    	...
    	if( marker.getAttribute(VdbBuilder.NO_VALIDATION_VERSION, false) ) {
