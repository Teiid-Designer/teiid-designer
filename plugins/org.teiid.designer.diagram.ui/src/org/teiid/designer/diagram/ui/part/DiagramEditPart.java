...
public interface DiagramEditPart extends NodeEditPart {
    ...
    /**
     * This method is provided to allow the edit part to be the manager of the layout of it's children and also to indicate to
     * it's children that they should also call layout(). Through property changes, children may be added/removed (i.e.
     * refreshChildren()) or things renamed. If these changes occur to the model, then the edit part needs to communicate to it's
     * children to layout or update their figures, then update or layout it's figure.
     * 
    ...
    /**
     * This method is provided to allow the edit part to be the manager of the layout of it's children and not affect the children
     * (see layout(layoutChildren) method.
     * 
     * @param layoutChildren
     */
    void layout();
    ...
    /**
     * This method provides the edit part the ability to selectively and recursively clear selection within the edit part
     * hiearchy.
     * 
    ...
    /**
     * This method provides the edit part the ability to tell it's edit parts to upate it's content. Rename actions, add/remove
     * child, change date-type, stereotype, whatever are all actions that would require the edit parts to update their Figures.
     * Again, the EditPart is the controller, and when it receives a property change event, it has to tell it's figure update it's
     * content from the model object data?
     */
    void updateContent();
    ...
    /**
     * Used by the edit part to access the underlying model object that the edit part, model, and figure are based on or
     * referenced to. This is the hook method to send back the 'real' selected item in a diagram.
     * 
     * @return modelObject;
     */
    ...
    /**
     * Method to walk a edit part's ancestry, and select the primary parent. This allows a 'classifier container', for instance,
     * to delegate it's selection to the 'classifier'.
     */
    void selectPrimaryParent();

    /**
     * Method to walk a edit part's ancestry, and find the primary parent. A primary parent is defined as the edit part that
     * actually exists as a child of the 'diagram'.
     * 
    ...
    /**
     * Method used to locate sub-editpart or child/subchild of another given an EObject
     * 
     * @param childModelObject
     */
    EditPart getEditPart( EObject childModelObject,
                          boolean linksAllowed );

    /**
     * Method used to locate sub-editpart or child/subchild of another given an DiagramModelNode
     * 
     * @param someModelNode
     */
    ...
    /**
     * Simple method designed to allow quick call to the edit part to refresh the "name" object from the eObject and set the name
     * of the diagram entity to the same, if it exists.
     */
    void refreshName();

    /**
     * Simple method designed to allow quick call to the edit part to refresh the "font" of any object.
     */
    ...
    /**
     * Method to allow a call to edit parts to generically set a hilite backaground color. In particular, UmlAttributes...
     * 
     * @param hiliteColor
     */
    ...
    /**
     * Method to allow a call to edit parts to generically clear all hiliting from this EditPart and any children... recursively.
    ...
    /**
     * Method to allow a call to edit parts to generically tell the part to render it's figure in a select state. In particular,
     * UmlAttributes...
     * 
     * @param selected
     */
    ...
    /**
     * Set the resizable state of the diagram edit part. Used primarily by the createChildEditPolicy() method of the XY Layout
     * edit policy
     * 
    ...
    /**
     * get the resizable state of the diagram edit part. Used primarily by the createChildEditPolicy() method of the XY Layout
     * edit policy
     * 
    ...
    /**
     * method to give the edit part a chance to update itself based on the current zoom factor (i.e. not everything wants to scale
     * with zoom)
     * 
     * @since 4.2
     */
