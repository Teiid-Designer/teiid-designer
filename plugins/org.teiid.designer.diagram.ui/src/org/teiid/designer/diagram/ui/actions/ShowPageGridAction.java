...
public class ShowPageGridAction extends DiagramAction 
    ...
    private static final String NATIVE_PRINT_DIALOG_WARNING_DIALOG_TITLE 
        = Util.getString("org.teiid.designer.diagram.ui.actions.ShowPageGridAction.nativePrintDialogWarningDialog.title"); //$NON-NLS-1$
    private static final String NATIVE_PRINT_DIALOG_WARNING_DIALOG_TEXT 
        = Util.getString("org.teiid.designer.diagram.ui.actions.ShowPageGridAction.nativePrintDialogWarningDialog.text"); //$NON-NLS-1$

    
    private static final String PRINT_DIALOG_TEXT 
        = Util.getString("org.teiid.designer.diagram.ui.actions.ShowPageGridAction.printDialog.text"); //$NON-NLS-1$
    
    private static final String SHOW_PRINT_GRID_TEXT 
        = Util.getString("org.teiid.designer.diagram.ui.actions.ShowPageGridAction.show.text"); //$NON-NLS-1$
    private static final String HIDE_PRINT_GRID_TEXT 
        = Util.getString("org.teiid.designer.diagram.ui.actions.ShowPageGridAction.hide.text"); //$NON-NLS-1$
    
    private static final String SHOW_PRINT_GRID_TOOLTIP 
        = Util.getString("org.teiid.designer.diagram.ui.actions.ShowPageGridAction.show.toolTip"); //$NON-NLS-1$
    private static final String HIDE_PRINT_GRID_TOOLTIP 
        = Util.getString("org.teiid.designer.diagram.ui.actions.ShowPageGridAction.hide.toolTip"); //$NON-NLS-1$
