...
/**
 *  Dialog for entering a generic name-value pair
 */
public class AddGeneralPropertyDialog  extends MessageDialog {
    ...
    public AddGeneralPropertyDialog( Shell parentShell,
        ...
        super(parentShell, Messages.AddGeneralPropertyDialog_title, null,  
        		Messages.AddGeneralPropertyDialog_message, MessageDialog.INFORMATION, 
        ...
        if (errorMsg == null) {
            ...
            for (String existingName : this.existingNames) {
                if (existingName.equals(this.name)) {
                    errorMsg = NLS.bind(Messages.AddGeneralPropertyDialog_customPropertyAlreadyExists, this.name);
                    break;
                }
            }
        }
