...
import org.teiid.designer.wsdl.util.WSDLSchemaExtractor;
...
public class ModelBuilder {
    ...
    private Operation[] getOperationsForBinding( Binding binding,
        ...
        while (opIter.hasNext()) {
            ...
            Operation operation = new Operation(binding);
            ...
            if (operation.getBinding().getStyle() == null) {
                ...
                String message = WsdlPlugin.Util.getString("ModelBuilder.cannot.resolve.style"); //$NON-NLS-1$
    ...
    private Fault[] getFaultsForOperation( Operation operation,
        ...
        while (faultIter.hasNext()) {
            ...
            Fault newFault = new Fault(operation);
            newFault.setName(fault.getName());
            newFault.setId(fault.getName());
            Message message = new Message(newFault);
    ...
    private Message getInputMessageForOperation( Operation operation,
                                                 Input input,
                                                 BindingInput bIn ) {
        Message inputMessage = new Message(operation);
    ...
    private Message getOutputMessageForOperation( Operation operation,
                                                  Output output,
                                                  BindingOutput bOut ) {
        Message outputMessage = new Message(operation);
    ...
    private Part[] getPartsForMessage( Message msg,
        ...
        while (partIter.hasNext()) {
            ...
            if (!resolvePart(newPart)) {
                ...
                String message = WsdlPlugin.Util.getString("ModelBuilder.cannot.resolve.element"); //$NON-NLS-1$
