...
public class RelationalObjectFactory {
    ...
    public BaseTable createBaseTable( String name,
                                      String description,
    ...
    public Procedure createPushdownFunction( String name,
                                             String description ) {
    ...
    public Column createColumn( String name,
        ...
        if (column != null) {
            ...
            if (datatype != null) column.setType(datatype);
            else {
                if (useDefaultDatatype && defaultDatatype != null) {
                    column.setType(defaultDatatype);
                }
            }
            if (length > 0) column.setLength(length);
    ...
    public ProcedureParameter createParameter( String name,
                                               String description,
                                               boolean isOutput,
                                               Procedure procedure,
                                               boolean useDefaultDatatype,
        ...
        if (param != null) {
            ...
            // SET DATATYPE AND LENGTH
            if (datatype != null) param.setType(datatype);
            else {
                if (useDefaultDatatype && defaultDatatype != null) {
                    param.setType(defaultDatatype);
                }
            }
            if (length > 0) param.setLength(length);
            else if (useDefaultDatatype) {
    ...
    private void addDescription( EObject eObject,
                                 String description ) {
