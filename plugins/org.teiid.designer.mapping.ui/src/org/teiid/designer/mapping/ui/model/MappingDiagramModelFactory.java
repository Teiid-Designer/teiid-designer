...
public class MappingDiagramModelFactory extends TransformationDiagramModelFactory {
    ...
    /* (non-Javadoc)
     * @See org.teiid.designer.diagram.ui.model.DiagramModelFactory#refresh(org.teiid.designer.metamodels.diagram.Diagram)
     */
...
//        if (image != null) diagramNode.setFirstOverlayImage(image, PluginConstants.INPUT_SET_EDITOR_ID);
    ...
    /**
     * @see org.teiid.designer.transformation.ui.model.TransformationDiagramModelFactory#addSourceTable(org.eclipse.emf.ecore.EObject,
     *      org.teiid.designer.diagram.ui.model.DiagramModelNode, org.eclipse.emf.ecore.EObject)
     * @since 4.2
     */
    @Override
