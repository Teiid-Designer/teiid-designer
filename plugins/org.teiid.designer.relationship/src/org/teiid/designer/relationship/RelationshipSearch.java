...
public interface RelationshipSearch extends ISearchEngine {
     ...
     * {@link org.teiid.designer.core.workspace.ModelWorkspaceItem} are supplied, only relationships
     * that have at least one participant in those ModelWorkspaceItems will be found.
     * If the list of models is empty or is the {@link org.teiid.designer.core.workspace.ModelWorkspace},
     * this criteria is not used in the search.
     * @return the list of {@link org.teiid.designer.core.workspace.ModelWorkspaceItem}
     ...
     * {@link org.teiid.designer.core.workspace.ModelWorkspaceItem} are supplied, only relationships
     * that have at least one participant in those ModelWorkspaceItems will be found.
     * If the list of models is null is the {@link org.teiid.designer.core.workspace.ModelWorkspace},
     * this criteria is not used in the search.
     * @param modelWorkspaceItems the list of {@link org.teiid.designer.core.workspace.ModelWorkspaceItem}
     ...
     * {@link org.teiid.designer.core.workspace.ModelWorkspaceItem} are supplied or the list
     * includes the whole {@link org.teiid.designer.core.workspace.ModelWorkspace}, then all Relationship
     * model in the workspace will be searched.  Otherwise, only those 
     * {@link org.teiid.designer.core.workspace.ModelResource ModelResources} that are specified or below
