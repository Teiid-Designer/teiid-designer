...
import org.teiid.designer.core.search.commands.FindRelationshipsCommandImpl;
...
public class RelationshipPlugin extends Plugin {
     ...
     * {@link org.teiid.designer.metamodels.relationship.RelationshipFactory#createRelationship() RelationshipFactory}
     ...
     * is to be edited, then the caller must create that instance using the
     * {@link org.teiid.designer.metamodels.relationship.RelationshipFactory#createRelationshipType() RelationshipFactory}
