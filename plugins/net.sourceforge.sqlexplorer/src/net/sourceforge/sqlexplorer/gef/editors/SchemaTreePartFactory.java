 ...
 *
 */
public class SchemaTreePartFactory implements EditPartFactory{
	

	public EditPart createEditPart(EditPart context, Object model) {
		Object obj1 = null;
		if(model instanceof Table)
			obj1=new TableTreeEditPart(model);
		else if (model instanceof Schema)
			obj1=new SchemaTreeEditPart(model);
		else if (model instanceof Note)
			obj1=new NoteTreeEditPart(model);
		return (EditPart)obj1;
	}
	
	public SchemaTreePartFactory(){
	}
}
