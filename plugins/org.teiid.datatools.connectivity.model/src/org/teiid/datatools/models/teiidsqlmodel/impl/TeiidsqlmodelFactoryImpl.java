...
public class TeiidsqlmodelFactoryImpl extends EFactoryImpl implements TeiidsqlmodelFactory {
	...
	public static TeiidsqlmodelFactory init() {
		try {
			TeiidsqlmodelFactory theTeiidsqlmodelFactory = (TeiidsqlmodelFactory)EPackage.Registry.INSTANCE.getEFactory("http:///org/teiid/datatools/connectivity/teiidsqlmodel.ecore"); 
