...
public class ProcedureUpdateVisitor extends LanguageVisitor {
     ...
     * {@link org.teiid.designer.webservice.procedure.ProcedureCriteriaMapping} objects.
     * @since 4.3
     */
    ...
    /** 
     * @see org.teiid.query.sql.LanguageVisitor#visit(org.teiid.query.sql.proc.Block)
     * @since 4.3
     */
    @Override
    ...
    /** 
     * @see org.teiid.query.sql.LanguageVisitor#visit(org.teiid.query.sql.lang.Query)
     * @since 4.3
     */
    @Override
