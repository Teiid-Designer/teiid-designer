 ...
 */
public class Aggregate9Symbol extends Function implements AggregateSymbol {
     ...
     * @param id
     */
    public Aggregate9Symbol(Teiid9Parser p, int id) {
        super(p, id);
    }
...
//                return this.getFunctionDescriptor().getReturnType();
    ...
    public boolean equals(Object obj) {
        ...
        Aggregate9Symbol other = (Aggregate9Symbol)obj;
    ...
    @Override
    public Aggregate9Symbol clone() {
        Aggregate9Symbol clone = new Aggregate9Symbol((Teiid9Parser) this.parser, this.id);
