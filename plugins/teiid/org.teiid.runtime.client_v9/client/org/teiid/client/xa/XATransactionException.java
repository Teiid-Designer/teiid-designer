 ...
 */
public class XATransactionException extends TeiidClientException {
    ...
    public XATransactionException(int code, Throwable e) {
        super(e);
        this.errorCode = code;
    }    
    
    public XATransactionException(int code, Throwable e, String msg) {
        super(e, msg);
        this.errorCode = code;
    }
