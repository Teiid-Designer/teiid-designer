...
public class BasicCryptor implements Cryptor {
    ...
    protected void initDecryptCipher() throws CryptoException {
        ...
        try {
            ...
            decryptCipher.init( Cipher.DECRYPT_MODE, decryptKey );
              ...
              throw new CryptoException(Messages.gs(Messages.TEIID.TEIID10009, cipherAlgorithm ));
        } catch ( NoSuchPaddingException e ) {
              throw new CryptoException(Messages.gs(Messages.TEIID.TEIID10010, cipherAlgorithm, e.getClass().getName(),  e.getMessage() ));
    ...
    public String encrypt( String cleartext ) throws CryptoException {
        ...
        if ( clearString.trim().length() == 0 && clearString.length() == 0 ) {
              throw new CryptoException(Messages.gs(Messages.TEIID.TEIID10015));
        }
    ...
    protected void initEncryptCipher() throws CryptoException {
        ...
        try {
            ...
            encryptCipher.init( Cipher.ENCRYPT_MODE, encryptKey );
              ...
              throw new CryptoException(e, Messages.gs(Messages.TEIID.TEIID10016, cipherAlgorithm ));
        } catch ( NoSuchPaddingException e ) {
              throw new CryptoException(e, Messages.gs(Messages.TEIID.TEIID10017, cipherAlgorithm , e.getMessage() ));
        } catch ( InvalidKeyException e ) {
