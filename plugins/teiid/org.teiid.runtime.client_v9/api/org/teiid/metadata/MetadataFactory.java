...
public class MetadataFactory implements Serializable {
	...
	public MetadataFactory(ITeiidServerVersion teiidVersion, String vdbName, Object vdbVersion, Map<String, Datatype> runtimeTypes, Model model) {
        this(teiidVersion, vdbName, vdbVersion, model.getName(), runtimeTypes, model.getProperties(), model.getSchemaText());
        this.model = model;
    }

    public MetadataFactory(ITeiidServerVersion teiidVersion, String vdbName, Object vdbVersion, String schemaName, Map<String, Datatype> runtimeTypes, Properties modelProperties, String rawMetadata) {
