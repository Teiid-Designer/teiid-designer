...
public class CallbackSQLStringVisitorImpl extends SQLStringVisitor implements ISQLStringVisitor {
    ...
    public void visit(ILanguageObject languageObject) {
        ...
        if (delegate instanceof CreateProcedureCommand) {
            visit((CreateProcedureCommand)delegate);
            return;
        }
        ...
        if (delegate instanceof ExceptionExpression) {
            visit((ExceptionExpression)delegate);
            return;
        }
        ...
        if (delegate instanceof ObjectTable) {
            visit((ObjectTable)delegate);
            return;
        }
        ...
        if (delegate instanceof ReturnStatement) {
            visit((ReturnStatement)delegate);
            return;
        }
        ...
        if (delegate instanceof RaiseStatement) {
            visit((RaiseStatement)delegate);
            return;
        }
