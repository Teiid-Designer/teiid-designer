...
public class CreateProcedureCommandImpl extends CommandImpl implements ICreateProcedureCommand {
     ...
     */
    public CreateProcedureCommandImpl(CreateUpdateProcedureCommand createUpdateProcedureCommand) {
    ...
    public CreateProcedureCommandImpl clone() {
        return new CreateProcedureCommandImpl((CreateUpdateProcedureCommand) getDelegate().clone());
    }
