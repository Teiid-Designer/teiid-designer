...
public interface ILogon {
    ...
    */
   ResultsFuture<?> ping()
       throws InvalidSessionException, TeiidClientException, CommunicationException;
   
   ResultsFuture<?> ping(Collection<String> sessions)
   		throws TeiidClientException, CommunicationException;
    ...
    */
   ResultsFuture<?> logoff() throws InvalidSessionException, TeiidClientException;
   
   @Secure
   void assertIdentity(SessionToken sessionId) throws InvalidSessionException, TeiidClientException, CommunicationException;
}
