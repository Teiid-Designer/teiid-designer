...
public class ObjectConverterUtil {
    ...
    private static final int DEFAULT_READING_SIZE = 8192;
     ...
     protected static byte[] convertBlobToByteArray(final java.sql.Blob data) throws TeiidClientException {
          try {
              ...
              return convertToByteArray(l_blobStream);
                ...
                final Object[] params = new Object[]{data.getClass().getName()};
                  throw new TeiidClientException(ioe, Messages.gs(Messages.TEIID.TEIID10030, params));
          } catch (SQLException sqe) {
                final Object[] params = new Object[]{data.getClass().getName()};
                  throw new TeiidClientException(sqe,Messages.gs(Messages.TEIID.TEIID10030,params));
          }
    }

    public static byte[] convertToByteArray(final Object data) throws TeiidClientException, IOException {
        ...
        final Object[] params = new Object[]{data.getClass().getName()};
          throw new TeiidClientException(Messages.gs(Messages.TEIID.TEIID10032, params));
    }
