...
import org.teiid.runtime.client.util.ExternalizeUtil;
import org.teiid.runtime.client.util.ObjectConverterUtil;
...
public final class ClobType extends Streamable<Clob> implements NClob, Comparable<ClobType> {
        ...
        return new CharSequence() {
            ...
            public int length() {
                ...
                if (((int)result) != result) {
                      throw new RuntimeException(Messages.gs(Messages.TEIID.TEIID10052));
                }
                return (int)result;
            }
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + ((this.getCharSequence() == null) ? 0 : this.getCharSequence().hashCode());
        return result;
    }
