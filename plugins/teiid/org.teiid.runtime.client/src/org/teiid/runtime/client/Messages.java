...
public class Messages {
    ...
    public enum SystemSource {
        ...
        Add_result_desc,
        Subtract_desc,
        Subtract_result_desc,
        Multiply_desc,
        Multiply_result_desc,
        Divide_desc,
        Divide_result_desc,
        Ceiling_desc,
        Exp_desc,
        ...
        Curtime_desc,
        Now_desc,
        Dayname_result_d_desc,
        Dayname_result_ts_desc,
        Dayofmonth_result_d_desc,
        Dayofmonth_result_ts_desc,
        Dayofweek_result_d_desc,
        Dayofweek_result_ts_desc,
        Dayofyear_result_d_desc,
        Dayofyear_result_ts_desc,
        Month_result_d_desc,
        Month_result_ts_desc,
        Monthname_result_d_desc,
        Monthname_result_ts_desc,
        Week_result_d_desc,
        Week_result_ts_desc,
        Year_result_d_desc,
        Year_result_ts_desc,
        Hour_result_t_desc,
        Hour_result_ts_desc,
        Minute_result_t_desc,
        Minute_result_ts_desc,
        Second_result_t_desc,
        Second_result_ts_desc,
        Quarter_result_d_desc,
        Quarter_result_ts_desc,
        Length_result,
        Ucase_result,
        Lcase_result,
        Lower_result,
        ...
        Right_result,
        Formattime_desc,
        Formattime_result_desc,
        Formatdate_desc,
        Formatdate_result_desc,
        Formattimestamp_desc,
        Formattimestamp_result_desc,
        Parsetime_desc,
        Parsetime_result_desc,
        Parsedate_desc,
        Parsedate_result_desc,
        Parsetimestamp_desc,
        Parsetimestamp_result_desc,
        Formatinteger_desc,
        Formatinteger_result_desc,
        Formatlong_desc,
        Formatlong_result_desc,
        Formatdouble_desc,
        Formatdouble_result_desc,
        Formatfloat_desc,
        Formatfloat_result_desc,
        Formatbiginteger_desc,
        Formatbiginteger_result_desc,
        Formatbigdecimal_desc,
        Formatbigdecimal_result_desc,
        Parseinteger_desc,
        Parseinteger_result_desc,
        Parselong_desc,
        Parselong_result_desc,
        Parsedouble_desc,
        Parsedouble_result_desc,
        Parsefloat_desc,
        Parsefloat_result_desc,
        Parsebiginteger_desc,
        Parsebiginteger_result_desc,
        Parsebigdecimal_desc,
        Parsebigdecimal_result_desc,
        Arith_left_op,
        Arith_right_op,
        Abs_desc,
        Abs_arg,
