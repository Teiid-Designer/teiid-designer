...
public class TranslatorElement implements Serializable {
    ...
    TranslatorElement( Translator translatorOverride ) {
        ...
        // process properties
        for (Object prop : translatorOverride.getProperties().keySet()) {
        	String key = (String)prop;
        	String value = (String)translatorOverride.getProperties().get(key);
            this.properties.add(new PropertyElement(key, value));
        }
    }
