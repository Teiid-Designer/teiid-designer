...
//	String mask;
	...
	*/
     ...
     */
    TeiidType IDENTIFIER = TeiidType.VDB_PERMISSION;
...
//		this.order = permission.getOrder();
	 ...
	 * @param constraint
	 */
	public void addCondition(String condition, boolean constraint) {
		this.condition = new Condition(condition, constraint);
