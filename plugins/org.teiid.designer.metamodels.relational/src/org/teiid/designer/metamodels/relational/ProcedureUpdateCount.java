...
/**
 * <!-- begin-user-doc --> A representation of the literals of the enumeration '<em><b>Procedure Update Count</b></em>', and
 * utility methods for working with them. <!-- end-user-doc -->
 * 
 * @see org.teiid.designer.metamodels.relational.RelationalPackage#getProcedureUpdateCount()
 * @model
 * @generated
 */
public final class ProcedureUpdateCount extends AbstractEnumerator {
    ...
    /**
     * An array of all the '<em><b>Procedure Update Count</b></em>' enumerators. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    private static final ProcedureUpdateCount[] VALUES_ARRAY = new ProcedureUpdateCount[] {AUTO_LITERAL, ZERO_LITERAL,
        ONE_LITERAL, MULTIPLE_LITERAL,};

    /**
     * A public read-only list of all the '<em><b>Procedure Update Count</b></em>' enumerators. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * Returns the '<em><b>Procedure Update Count</b></em>' literal with the specified name. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * Returns the '<em><b>Procedure Update Count</b></em>' literal with the specified value. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @generated
     */
    public static ProcedureUpdateCount get( int value ) { // NO_UCD
        switch (value) {
            case AUTO:
                return AUTO_LITERAL;
            case ZERO:
     ...
     * @generated
     */
    private ProcedureUpdateCount( int value,
                                  String name ) {
        super(value, name);
    }
