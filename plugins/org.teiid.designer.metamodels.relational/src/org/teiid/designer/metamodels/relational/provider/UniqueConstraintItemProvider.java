...
/**
 * This is the item provider adapter for a {@link org.teiid.designer.metamodels.relational.UniqueConstraint} object. <!--
 ...
 * @since 8.0
 */
public class UniqueConstraintItemProvider extends UniqueKeyItemProvider {
    /**
    ...
    public String getText( Object object ) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_UniqueConstraint_type") : //$NON-NLS-1$
        label;
    }
