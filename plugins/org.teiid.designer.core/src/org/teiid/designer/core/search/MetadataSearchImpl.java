...
public class MetadataSearchImpl implements MetadataSearch {
    ...
    static {
        ...
        TYPED_META_CLASS_NAMES.add("org.teiid.designer.metamodels.relational.Column"); //$NON-NLS-1$
        TYPED_META_CLASS_NAMES.add("org.teiid.designer.metamodels.relational.ProcedureParameter"); //$NON-NLS-1$
        TYPED_META_CLASS_NAMES.add("org.teiid.designer.metamodels.sdt.SimpleDatatype"); //$NON-NLS-1$
        TYPED_META_CLASS_NAMES.add("org.eclipse.xsd.XSDSimpleTypeDefinition"); //$NON-NLS-1$
        TYPED_META_CLASS_NAMES.add("org.teiid.designer.metamodels.transformation.InputParameter"); //$NON-NLS-1$
        TYPED_META_CLASS_NAMES.add("org.teiid.designer.metamodels.transformation.MappingClassColumn"); //$NON-NLS-1$
        TYPED_META_CLASS_NAMES.add("org.teiid.designer.metamodels.dataaccess.Element"); //$NON-NLS-1$
        TYPED_META_CLASS_NAMES.add("org.teiid.designer.metamodels.dataaccess.ProcedureParameter"); //$NON-NLS-1$
    ...
    /**
     * @see org.teiid.designer.core.search.MetadataSearch#setFeatureCriteria(java.lang.String, java.lang.String, boolean,
     *      boolean)
     * @since 4.1
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.teiid.designer.core.search.MetadataSearch#getSearchCriteria()
     */
    @Override
