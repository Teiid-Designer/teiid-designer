...
public interface DdlImporterI18n {
    ...
    String MAT_VIEW_TABLE_REF_NOT_FOUND_MSG = i18n("matViewTableRefNotFoundMsg"); //$NON-NLS-1$
    String TRANSLATOR_SELECTION_REQUIRED_TITLE = i18n("translatorSelectionRequiredTitle");  //$NON-NLS-1$
