...
public class TeiidAdminPropertyPage  extends ExtensibleProfileDetailsPropertyPage 
...
public TeiidAdminPropertyPage() {
    super(ITeiidAdminProfileConstants.TEIID_ADMIN_CATEGORY);
}
