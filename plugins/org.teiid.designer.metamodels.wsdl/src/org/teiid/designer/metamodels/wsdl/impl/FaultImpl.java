 ...
 * <ul>
 * <li>{@link org.teiid.designer.metamodels.wsdl.impl.FaultImpl#getName <em>Name</em>}</li>
 * <li>{@link org.teiid.designer.metamodels.wsdl.impl.FaultImpl#getDocumentation <em>Documentation</em>}</li>
 * <li>{@link org.teiid.designer.metamodels.wsdl.impl.FaultImpl#getDeclaredNamespaces <em>Declared Namespaces</em>}</li>
 * <li>{@link org.teiid.designer.metamodels.wsdl.impl.FaultImpl#getAttributes <em>Attributes</em>}</li>
 * <li>{@link org.teiid.designer.metamodels.wsdl.impl.FaultImpl#getMessage <em>Message</em>}</li>
 * <li>{@link org.teiid.designer.metamodels.wsdl.impl.FaultImpl#getOperation <em>Operation</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class FaultImpl extends EObjectImpl implements Fault {
	...
	public void setName( String newName ) {
        String oldName = name;
        name = newName;
        if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, WsdlPackage.FAULT__NAME, oldName, name));
    }
    ...
    public NotificationChain basicSetDocumentation( Documentation newDocumentation,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WsdlPackage.FAULT__DOCUMENTATION,
	...
	public void setDocumentation( Documentation newDocumentation ) {
        if (newDocumentation != documentation) {
            ...
            if (msgs != null) msgs.dispatch();
                                                                          ...
                                                                          WsdlPackage.FAULT__DOCUMENTATION, newDocumentation,
                                                                          newDocumentation));
    }
	...
	public EList getDeclaredNamespaces() {
        if (declaredNamespaces == null) {
            declaredNamespaces = new EObjectContainmentWithInverseEList(NamespaceDeclaration.class, this,
                                                                        WsdlPackage.FAULT__DECLARED_NAMESPACES,
	...
	public EList getAttributes() {
        if (attributes == null) {
            attributes = new EObjectContainmentWithInverseEList(Attribute.class, this, WsdlPackage.FAULT__ATTRIBUTES,
	...
	public void setMessage( String newMessage ) {
        ...
        message = newMessage;
        if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, WsdlPackage.FAULT__MESSAGE,
                                                                   oldMessage, message));
    }
	...
	public void setOperation( Operation newOperation ) {
        if (newOperation != eContainer || (eContainerFeatureID != WsdlPackage.FAULT__OPERATION && newOperation != null)) {
            ...
            if (newOperation != null) msgs = ((InternalEObject)newOperation).eInverseAdd(this,
                                                                                         WsdlPackage.OPERATION__FAULTS,
                                                                                         Operation.class,
                                                                                         msgs);
            msgs = eBasicSetContainer((InternalEObject)newOperation, WsdlPackage.FAULT__OPERATION, msgs);
            if (msgs != null) msgs.dispatch();
        } else if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, WsdlPackage.FAULT__OPERATION,
            ...
            switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
                case WsdlPackage.FAULT__DOCUMENTATION:
                    if (documentation != null) msgs = ((InternalEObject)documentation).eInverseRemove(this,
                                                                                                      ...
                                                                                                      - WsdlPackage.FAULT__DOCUMENTATION,
                                                                                                      null,
                                                                                                      msgs);
        ...
        if (baseClass == Documented.class) {
            switch (baseFeatureID) {
                case WsdlPackage.DOCUMENTED__DOCUMENTATION:
                    return WsdlPackage.FAULT__DOCUMENTATION;
                default:
                    return -1;
            }
        }
        if (baseClass == NamespaceDeclarationOwner.class) {
            switch (baseFeatureID) {
                case WsdlPackage.NAMESPACE_DECLARATION_OWNER__DECLARED_NAMESPACES:
                    return WsdlPackage.FAULT__DECLARED_NAMESPACES;
                default:
                    return -1;
            }
        }
        if (baseClass == AttributeOwner.class) {
            switch (baseFeatureID) {
                case WsdlPackage.ATTRIBUTE_OWNER__ATTRIBUTES:
                    return WsdlPackage.FAULT__ATTRIBUTES;
                default:
                    return -1;
            }
        }
