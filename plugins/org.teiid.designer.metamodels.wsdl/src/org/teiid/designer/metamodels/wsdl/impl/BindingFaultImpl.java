...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Binding Fault</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.teiid.designer.metamodels.wsdl.impl.BindingFaultImpl#getDocumentation <em>Documentation</em>}</li>
 * <li>{@link org.teiid.designer.metamodels.wsdl.impl.BindingFaultImpl#getDeclaredNamespaces <em>Declared Namespaces</em>}</li>
 * <li>{@link org.teiid.designer.metamodels.wsdl.impl.BindingFaultImpl#getElements <em>Elements</em>}</li>
 * <li>{@link org.teiid.designer.metamodels.wsdl.impl.BindingFaultImpl#getName <em>Name</em>}</li>
 * <li>{@link org.teiid.designer.metamodels.wsdl.impl.BindingFaultImpl#getBindingOperation <em>Binding Operation</em>}</li>
 * <li>{@link org.teiid.designer.metamodels.wsdl.impl.BindingFaultImpl#getSoapFault <em>Soap Fault</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class BindingFaultImpl extends EObjectImpl implements BindingFault {
    ...
    /**
     * The cached value of the '{@link #getSoapFault() <em>Soap Fault</em>}' containment reference. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getSoapFault()
     * @generated
    ...
    public NotificationChain basicSetDocumentation( Documentation newDocumentation,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                                                                   WsdlPackage.BINDING_FAULT__DOCUMENTATION, oldDocumentation,
                                                                   newDocumentation);
	...
	public void setDocumentation( Documentation newDocumentation ) {
        if (newDocumentation != documentation) {
            ...
            if (msgs != null) msgs.dispatch();
                                                                          ...
                                                                          WsdlPackage.BINDING_FAULT__DOCUMENTATION,
     ...
     * @generated
     */
    public NotificationChain basicSetSoapFault( SoapFault newSoapFault,
                                                NotificationChain msgs ) {
        SoapFault oldSoapFault = soapFault;
        soapFault = newSoapFault;
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WsdlPackage.BINDING_FAULT__SOAP_FAULT,
                                                                   oldSoapFault, newSoapFault);
            if (msgs == null) msgs = notification;
            else msgs.add(notification);
        }
        return msgs;
	...
	public void setSoapFault( SoapFault newSoapFault ) {
        if (newSoapFault != soapFault) {
            ...
            if (soapFault != null) msgs = ((InternalEObject)soapFault).eInverseRemove(this,
                                                                                      SoapPackage.SOAP_FAULT__BINDING_FAULT,
                                                                                      SoapFault.class,
                                                                                      msgs);
            if (newSoapFault != null) msgs = ((InternalEObject)newSoapFault).eInverseAdd(this,
                                                                                         SoapPackage.SOAP_FAULT__BINDING_FAULT,
                                                                                         SoapFault.class,
                                                                                         msgs);
            ...
            if (msgs != null) msgs.dispatch();
                                                                          ...
                                                                          WsdlPackage.BINDING_FAULT__SOAP_FAULT, newSoapFault,
                                                                          newSoapFault));
    }
        ...
        if (baseClass == NamespaceDeclarationOwner.class) {
            switch (baseFeatureID) {
                case WsdlPackage.NAMESPACE_DECLARATION_OWNER__DECLARED_NAMESPACES:
                    return WsdlPackage.BINDING_FAULT__DECLARED_NAMESPACES;
                default:
                    return -1;
            }
        }
        if (baseClass == ElementOwner.class) {
            switch (baseFeatureID) {
                case WsdlPackage.ELEMENT_OWNER__ELEMENTS:
                    return WsdlPackage.BINDING_FAULT__ELEMENTS;
                default:
                    return -1;
            }
        }
        if (baseClass == WsdlNameRequiredEntity.class) {
            switch (baseFeatureID) {
                case WsdlPackage.WSDL_NAME_REQUIRED_ENTITY__NAME:
                    return WsdlPackage.BINDING_FAULT__NAME;
                default:
                    return -1;
            }
        }
