 ...
 * <ul>
 * <li>{@link org.teiid.designer.metamodels.wsdl.impl.ElementImpl#getDeclaredNamespaces <em>Declared Namespaces</em>}</li>
 * <li>{@link org.teiid.designer.metamodels.wsdl.impl.ElementImpl#getAttributes <em>Attributes</em>}</li>
 * <li>{@link org.teiid.designer.metamodels.wsdl.impl.ElementImpl#getDocumentation <em>Documentation</em>}</li>
 * <li>{@link org.teiid.designer.metamodels.wsdl.impl.ElementImpl#getElements <em>Elements</em>}</li>
 * <li>{@link org.teiid.designer.metamodels.wsdl.impl.ElementImpl#getName <em>Name</em>}</li>
 * <li>{@link org.teiid.designer.metamodels.wsdl.impl.ElementImpl#getPrefix <em>Prefix</em>}</li>
 * <li>{@link org.teiid.designer.metamodels.wsdl.impl.ElementImpl#getTextContent <em>Text Content</em>}</li>
 * <li>{@link org.teiid.designer.metamodels.wsdl.impl.ElementImpl#getNamespaceUri <em>Namespace Uri</em>}</li>
 * <li>{@link org.teiid.designer.metamodels.wsdl.impl.ElementImpl#getElementOwner <em>Element Owner</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class ElementImpl extends EObjectImpl implements Element {
    ...
    public NotificationChain basicSetDocumentation( Documentation newDocumentation,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WsdlPackage.ELEMENT__DOCUMENTATION,
	...
	public void setDocumentation( Documentation newDocumentation ) {
        if (newDocumentation != documentation) {
            ...
            if (msgs != null) msgs.dispatch();
                                                                          ...
                                                                          WsdlPackage.ELEMENT__DOCUMENTATION, newDocumentation,
                                                                          newDocumentation));
    }
	...
	public void setElementOwner( ElementOwner newElementOwner ) {
        if (newElementOwner != eContainer
            ...
            if (newElementOwner != null) msgs = ((InternalEObject)newElementOwner).eInverseAdd(this,
                                                                                               WsdlPackage.ELEMENT_OWNER__ELEMENTS,
                                                                                               ElementOwner.class,
                                                                                               msgs);
            msgs = eBasicSetContainer((InternalEObject)newElementOwner, WsdlPackage.ELEMENT__ELEMENT_OWNER, msgs);
            if (msgs != null) msgs.dispatch();
        } else if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET,
                                                                          WsdlPackage.ELEMENT__ELEMENT_OWNER, newElementOwner,
                                                                          newElementOwner));
    }
            ...
            switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
                ...
                case WsdlPackage.ELEMENT__DOCUMENTATION:
                    if (documentation != null) msgs = ((InternalEObject)documentation).eInverseRemove(this,
                                                                                                      ...
                                                                                                      - WsdlPackage.ELEMENT__DOCUMENTATION,
                                                                                                      null,
                                                                                                      msgs);
        ...
        if (baseClass == Documented.class) {
            switch (baseFeatureID) {
                case WsdlPackage.DOCUMENTED__DOCUMENTATION:
                    return WsdlPackage.ELEMENT__DOCUMENTATION;
                default:
                    return -1;
            }
        }
        if (baseClass == ElementOwner.class) {
            switch (baseFeatureID) {
                case WsdlPackage.ELEMENT_OWNER__ELEMENTS:
                    return WsdlPackage.ELEMENT__ELEMENTS;
                default:
                    return -1;
            }
        }
