 ...
 * 
 */
public class SourceModelStatusRowProvider implements IStatusRowProvider {

    /**
     * 
     */
    public SourceModelStatusRowProvider() {
    ...
    @Override
    public int getId() {
        return AdvisorUiConstants.Groups.GROUP_SOURCES;
    }
