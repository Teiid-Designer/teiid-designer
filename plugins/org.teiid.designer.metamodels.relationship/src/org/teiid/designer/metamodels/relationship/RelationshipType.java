 ...
 * <ul>
 * <li>{@link org.teiid.designer.metamodels.relationship.RelationshipType#isDirected <em>Directed</em>}</li>
 * <li>{@link org.teiid.designer.metamodels.relationship.RelationshipType#isExclusive <em>Exclusive</em>}</li>
 * <li>{@link org.teiid.designer.metamodels.relationship.RelationshipType#isCrossModel <em>Cross Model</em>}</li>
 * <li>{@link org.teiid.designer.metamodels.relationship.RelationshipType#isAbstract <em>Abstract</em>}</li>
 * <li>{@link org.teiid.designer.metamodels.relationship.RelationshipType#isUserDefined <em>User Defined</em>}</li>
 * <li>{@link org.teiid.designer.metamodels.relationship.RelationshipType#getStatus <em>Status</em>}</li>
 * <li>{@link org.teiid.designer.metamodels.relationship.RelationshipType#getStereotype <em>Stereotype</em>}</li>
 * <li>{@link org.teiid.designer.metamodels.relationship.RelationshipType#getConstraint <em>Constraint</em>}</li>
 * <li>{@link org.teiid.designer.metamodels.relationship.RelationshipType#getLabel <em>Label</em>}</li>
 * <li>{@link org.teiid.designer.metamodels.relationship.RelationshipType#getOppositeLabel <em>Opposite Label</em>}</li>
 * <li>{@link org.teiid.designer.metamodels.relationship.RelationshipType#getRelationshipFeatures <em>Relationship Features</em>}</li>
 * <li>{@link org.teiid.designer.metamodels.relationship.RelationshipType#getSuperType <em>Super Type</em>}</li>
 * <li>{@link org.teiid.designer.metamodels.relationship.RelationshipType#getSubType <em>Sub Type</em>}</li>
 * <li>{@link org.teiid.designer.metamodels.relationship.RelationshipType#getRoles <em>Roles</em>}</li>
 * <li>{@link org.teiid.designer.metamodels.relationship.RelationshipType#getOwner <em>Owner</em>}</li>
 * </ul>
 * </p>
 * 
 * @see org.teiid.designer.metamodels.relationship.RelationshipPackage#getRelationshipType()
 * @model
 * @generated
 */
public interface RelationshipType extends RelationshipEntity {
     ...
     * @see org.teiid.designer.metamodels.relationship.RelationshipPackage#getRelationshipType_Directed()
     * @model default="true"
     * @generated
     */
    boolean isDirected();
    ...
    /**
     * Sets the value of the '{@link org.teiid.designer.metamodels.relationship.RelationshipType#isDirected <em>Directed</em>}'
     ...
     * @see org.teiid.designer.metamodels.relationship.RelationshipPackage#getRelationshipType_Exclusive()
     * @model default="true"
     * @generated
     */
    boolean isExclusive();
    ...
    /**
     * Sets the value of the '{@link org.teiid.designer.metamodels.relationship.RelationshipType#isExclusive <em>Exclusive</em>}'
     * attribute. <!-- begin-user-doc -->
     * <p>
     * If a relationship type is exclusive, then an object participating in a relationship must participate either in the
     * {@link #getSourceRole() source role} or in the {@link #getTargetRole() target role} of the relationship, but not both.
     ...
     * @see org.teiid.designer.metamodels.relationship.RelationshipPackage#getRelationshipType_CrossModel()
     * @model default="true"
     * @generated
     */
    ...
    /**
     * Sets the value of the '{@link org.teiid.designer.metamodels.relationship.RelationshipType#isCrossModel <em>Cross Model</em>}'
     * attribute. <!-- begin-user-doc -->
     * <p>
     * A relationship type that allows participants in {@link Relationship} to exist in different models is considered to be
     * cross-model. Thus, a relationship type that requires participants in a relationship to exist in the same model is
     ...
     * @see org.teiid.designer.metamodels.relationship.RelationshipPackage#getRelationshipType_Abstract()
     * @model default="false"
     * @generated
     */
    boolean isAbstract();
    ...
    /**
     * Sets the value of the '{@link org.teiid.designer.metamodels.relationship.RelationshipType#isAbstract <em>Abstract</em>}'
     * attribute. <!-- begin-user-doc -->
     * <p>
     * An abstract relationship type cannot be referenced as the {@link Relationship#getType() type} of a {@link Relationship}. In
     * other words, it cannot be "instantiated".
     ...
     * @see org.teiid.designer.metamodels.relationship.RelationshipPackage#getRelationshipType_UserDefined()
     * @model default="true"
     * @generated
     */
    ...
    /**
     * Sets the value of the '{@link org.teiid.designer.metamodels.relationship.RelationshipType#isUserDefined <em>User Defined</em>}'
     ...
     * from the enumeration {@link org.teiid.designer.metamodels.relationship.RelationshipTypeStatus}. <!-- begin-user-doc -->
     * <p>
     ...
     * @see org.teiid.designer.metamodels.relationship.RelationshipPackage#getRelationshipType_Status()
    ...
    /**
     * Sets the value of the '{@link org.teiid.designer.metamodels.relationship.RelationshipType#getStatus <em>Status</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     ...
     * @see org.teiid.designer.metamodels.relationship.RelationshipPackage#getRelationshipType_Stereotype()
     * @model
     * @generated
     */
    ...
    /**
     * Sets the value of the '{@link org.teiid.designer.metamodels.relationship.RelationshipType#getStereotype <em>Stereotype</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     ...
     * @see org.teiid.designer.metamodels.relationship.RelationshipPackage#getRelationshipType_Constraint()
     * @model
     * @generated
     */
    ...
    /**
     * Sets the value of the '{@link org.teiid.designer.metamodels.relationship.RelationshipType#getConstraint <em>Constraint</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     ...
     * @see #setLabel(String)
     * @see org.teiid.designer.metamodels.relationship.RelationshipPackage#getRelationshipType_Label()
     * @model
     * @generated
     */
    String getLabel();
    ...
    /**
     * Sets the value of the '{@link org.teiid.designer.metamodels.relationship.RelationshipType#getLabel <em>Label</em>}' attribute.
     * <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     ...
     * @see org.teiid.designer.metamodels.relationship.RelationshipPackage#getRelationshipType_OppositeLabel()
     * @model
     * @generated
     */
    ...
    /**
     * Sets the value of the '{@link org.teiid.designer.metamodels.relationship.RelationshipType#getOppositeLabel
     ...
     * @see org.teiid.designer.metamodels.relationship.RelationshipPackage#getRelationshipType_RelationshipFeatures()
     ...
     * {@link org.teiid.designer.metamodels.relationship.RelationshipType#getSubType <em>Sub Type</em>}'. <!-- begin-user-doc -->
     * <p>
     ...
     * @see org.teiid.designer.metamodels.relationship.RelationshipPackage#getRelationshipType_SuperType()
    ...
    /**
     * Sets the value of the '{@link org.teiid.designer.metamodels.relationship.RelationshipType#getSuperType <em>Super Type</em>}'
    ...
    /**
     * Unsets the value of the '{@link org.teiid.designer.metamodels.relationship.RelationshipType#getSuperType <em>Super Type</em>}'
     * reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #isSetSuperType()
     * @see #getSuperType()
    ...
    /**
     * Returns whether the value of the '{@link org.teiid.designer.metamodels.relationship.RelationshipType#getSuperType
     ...
     * {@link org.teiid.designer.metamodels.relationship.RelationshipType}. It is bidirectional and its opposite is '
     * {@link org.teiid.designer.metamodels.relationship.RelationshipType#getSuperType <em>Super Type</em>}'. <!-- begin-user-doc -->
     * <p>
     ...
     * @see org.teiid.designer.metamodels.relationship.RelationshipPackage#getRelationshipType_SubType()
     * @see org.teiid.designer.metamodels.relationship.RelationshipType#getSuperType
     * @model type="org.teiid.designer.metamodels.relationship.RelationshipType" opposite="superType"
     * @generated
     */
    EList getSubType();
     ...
     * {@link org.teiid.designer.metamodels.relationship.RelationshipRole}. It is bidirectional and its opposite is '
     * {@link org.teiid.designer.metamodels.relationship.RelationshipRole#getRelationshipType <em>Relationship Type</em>}'. <!--
     * begin-user-doc -->
     * <p>
     ...
     * @see org.teiid.designer.metamodels.relationship.RelationshipPackage#getRelationshipType_Roles()
     * @see org.teiid.designer.metamodels.relationship.RelationshipRole#getRelationshipType
     * @model type="org.teiid.designer.metamodels.relationship.RelationshipRole" opposite="relationshipType" containment="true"
     *        lower="2" upper="2"
     * @generated
     */
    EList getRoles();
     ...
     * {@link org.teiid.designer.metamodels.relationship.RelationshipFolder#getOwnedRelationshipTypes
     ...
     * @see org.teiid.designer.metamodels.relationship.RelationshipPackage#getRelationshipType_Owner()
    ...
    /**
     * Sets the value of the '{@link org.teiid.designer.metamodels.relationship.RelationshipType#getOwner <em>Owner</em>}' container
     * reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     ...
     * 
     * @model dataType="org.teiid.designer.metamodels.relationship.List" parameters=""
     * @generated
     */
