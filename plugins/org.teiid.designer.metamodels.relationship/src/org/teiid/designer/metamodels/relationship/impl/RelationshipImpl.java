 ...
 * <ul>
 * <li>{@link org.teiid.designer.metamodels.relationship.impl.RelationshipImpl#getOwnedRelationships <em>Owned Relationships</em>}</li>
 * <li>{@link org.teiid.designer.metamodels.relationship.impl.RelationshipImpl#getFeatureValues <em>Feature Values</em>}</li>
 * <li>{@link org.teiid.designer.metamodels.relationship.impl.RelationshipImpl#getTargets <em>Targets</em>}</li>
 * <li>{@link org.teiid.designer.metamodels.relationship.impl.RelationshipImpl#getSources <em>Sources</em>}</li>
 * <li>{@link org.teiid.designer.metamodels.relationship.impl.RelationshipImpl#getType <em>Type</em>}</li>
 * <li>{@link org.teiid.designer.metamodels.relationship.impl.RelationshipImpl#getRelationshipContainer <em>Relationship Container
 * </em>}</li>
 * </ul>
 * </p>
 * 
...
public class RelationshipImpl extends RelationshipEntityImpl implements Relationship {
    ...
    /**
     * The cached value of the '{@link #getFeatureValues() <em>Feature Values</em>}' map. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
    ...
    /**
     * The cached value of the '{@link #getTargets() <em>Targets</em>}' reference list. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     * 
     * @see #getTargets()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getSources() <em>Sources</em>}' reference list. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     * 
     * @see #getSources()
     * @generated
        ...
        if (type != null && type.eIsProxy()) {
            ...
            if (type != oldType) {
                if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                                                                           RelationshipPackage.RELATIONSHIP__TYPE, oldType, type));
            }
        }
        return type;
    }
	...
	public void unsetType() {
        ...
        if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.UNSET,
                                                                   RelationshipPackage.RELATIONSHIP__TYPE, oldType, null,
                                                                   oldTypeESet));
    }
	...
	public void setRelationshipContainer( RelationshipContainer newRelationshipContainer ) {
        if (newRelationshipContainer != eContainer
            ...
            if (newRelationshipContainer != null) msgs = ((InternalEObject)newRelationshipContainer).eInverseAdd(this,
                                                                                                                 RelationshipPackage.RELATIONSHIP_CONTAINER__OWNED_RELATIONSHIPS,
                                                                                                                 RelationshipContainer.class,
                                                                                                                 msgs);
            msgs = eBasicSetContainer((InternalEObject)newRelationshipContainer,
                                      RelationshipPackage.RELATIONSHIP__RELATIONSHIP_CONTAINER,
                                      msgs);
            if (msgs != null) msgs.dispatch();
                                                                          ...
                                                                          Notification.SET,
                                                                          RelationshipPackage.RELATIONSHIP__RELATIONSHIP_CONTAINER,
                                                                          newRelationshipContainer, newRelationshipContainer));
    }
    ...
    public IStatus isValid() {
        ...
        if (relationType != null) {
            // type name
            String typeName = relationType.getName() != null ? relationType.getName() : RelationshipMetamodelPlugin.Util.getString("RelationshipImpl.<<_Relationship_Type_>>_1"); //$NON-NLS-1$
        ...
        if (baseClass == RelationshipContainer.class) {
            switch (baseFeatureID) {
                case RelationshipPackage.RELATIONSHIP_CONTAINER__OWNED_RELATIONSHIPS:
                    return RelationshipPackage.RELATIONSHIP__OWNED_RELATIONSHIPS;
                default:
                    return -1;
            }
        }
