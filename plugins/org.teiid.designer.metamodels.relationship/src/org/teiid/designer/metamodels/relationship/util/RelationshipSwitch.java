...
public class RelationshipSwitch {
    ...
    /**
     * Returns the result of interpretting the object as an instance of '<em>Type</em>'. <!-- begin-user-doc --> This
    ...
    /**
     * Returns the result of interpretting the object as an instance of '<em>Relationship</em>'. <!-- begin-user-doc --> This
     * implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
     * 
     * @param object the target of the switch.
    ...
    /**
     * Returns the result of interpretting the object as an instance of '<em>File Reference</em>'. <!-- begin-user-doc --> This
     * implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
     * 
     * @param object the target of the switch.
    ...
    /**
     * Returns the result of interpretting the object as an instance of '<em>Role</em>'. <!-- begin-user-doc --> This
     * implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
     * 
     * @param object the target of the switch.
    ...
    /**
     * Returns the result of interpretting the object as an instance of '<em>Placeholder Reference</em>'. <!-- begin-user-doc -->
    ...
    /**
     * Returns the result of interpretting the object as an instance of '<em>Uri Reference</em>'. <!-- begin-user-doc --> This
     * implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
     * 
     * @param object the target of the switch.
    ...
    /**
     * Returns the result of interpretting the object as an instance of '<em>Folder</em>'. <!-- begin-user-doc --> This
     * implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
     * 
     * @param object the target of the switch.
