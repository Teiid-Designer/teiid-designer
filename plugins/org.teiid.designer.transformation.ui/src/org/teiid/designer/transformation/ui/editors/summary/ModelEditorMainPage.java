...
//        overviewSection = section;
    ...
    private Composite createPropertiesPanel(Composite parent ) {
    	this.propertiesPanel = new ModelObjectPropertiesPanel(parent, false);
    	return this.propertiesPanel.getPrimaryPanel();
    }
...
//        GridLayoutFactory.fillDefaults().numColumns(1).margins(2, 2).applyTo(vertToolbar);
//        GridDataFactory.fillDefaults().hint(40, -1).grab(false, true).applyTo(vertToolbar);
//        Button editDescriptionButton = null;
//        
//        ADD_TOOLBAR_BUTTONS: {
//        	// PREVIEW
//        	editDescriptionButton = getToolkit().createButton(vertToolbar, "", SWT.PUSH);
//        	editDescriptionButton.setText("Edit");
//        	GridDataFactory.fillDefaults().grab(true, false).applyTo(previewButton);
//        	editDescriptionButton.setEnabled(false);
//        	editDescriptionButton.addSelectionListener(new SelectionListener() {
//				
//				@Override
//				public void widgetSelected(SelectionEvent e) {
////					SortableSelectionAction action = ModelerSpecialActionManager.getAction(Special.PREVIEW_DATA);
