...
public class PojoWizardPage_1 extends AbstractWizardPage implements UiConstants {
	...
	public PojoWizardPage_1(MaterializedModelManager generator) {
		super(PojoWizardPage_1.class.getSimpleName(), Messages.PojoWizardPage_1_Title);
	...
	public void createControl(Composite parent) {
		...
		// Add widgets to page
    	Group viewPanel = WidgetFactory.createGroup(mainPanel, Messages.PojoWizardPage_1_ViewModelGroupName, SWT.NONE, 1, 2);
    	...
    	Label vModelLabel = WidgetFactory.createLabel(viewPanel, Messages.PojoWizardPage_1_Name);
    	...
    	Label vTableLabel = WidgetFactory.createLabel(viewPanel, Messages.PojoWizardPage_1_SelectedView);
		...
		// Add widgets to page
    	Group theGroup = WidgetFactory.createGroup(mainPanel, Messages.PojoWizardPage_1_GroupName, SWT.NONE, 1, 3);
    	...
    	Label label = WidgetFactory.createLabel(theGroup, Messages.PojoWizardPage_1_SourceModelName); 
        label.setToolTipText(Messages.PojoWizardPage_1_SourceModelNameTooltip);
        ...
        this.modelNameField.setToolTipText(Messages.PojoWizardPage_1_SourceModelNameTooltip);
...
//        GridDataFactory.swtDefaults().grab(true,  true).applyTo(modelNameField);
        ...
        // Instruction label.
        Label locationLabel = new Label(theGroup, SWT.NULL);
        locationLabel.setText(Messages.PojoWizardPage_1_SourceModelLocationLabel);
        locationLabel.setImage(UiPlugin.getDefault().getImage(UiConstants.Images.FOLDER));
		...
		setMessage(Messages.PojoWizardPage_1_Message);
