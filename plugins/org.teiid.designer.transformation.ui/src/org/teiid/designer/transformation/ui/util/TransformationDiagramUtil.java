...
public class TransformationDiagramUtil {
    ...
    public static boolean isVirtualProcedureOrTable( final EObject eObject ) {
        boolean result = ((org.teiid.designer.core.metamodel.aspect.sql.SqlAspectHelper.isTable(eObject) || org.teiid.designer.core.metamodel.aspect.sql.SqlAspectHelper.isProcedure(eObject)) && ModelObjectUtilities.isVirtual(eObject));
        return result;
    }

    public static boolean isVirtualProcedure( final EObject eObject ) {
        return org.teiid.designer.core.metamodel.aspect.sql.SqlAspectHelper.isProcedure(eObject) && ModelObjectUtilities.isVirtual(eObject);
    }
    ...
    public static boolean isTreeLayout() {
        return UiPlugin.getDefault().getPreferenceStore().getBoolean(org.teiid.query.ui.UiConstants.Prefs.TREE_DIAGRAM_LAYOUT);
    }
