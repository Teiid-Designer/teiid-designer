...
public class CreatePojoWizard extends AbstractWizard
		implements INewWizard, InternalUiConstants.Widgets, CoreStringUtil.Constants, UiConstants, ReverseEngConstants {

	private static final String I18N_PREFIX = I18nUtil.getPropertyPrefix(CreatePojoWizard.class);
	...
	private PojoWizardPage_1 page_1;
	private PojoWizardPage_2 page_2;
//	private PojoWizardPage_3 page_3;

	/**
	 * @since 4.0
	 */
	public CreatePojoWizard() {
	...
	public void init(final IWorkbench workbench, final IStructuredSelection selection) {
		...
		this.manager = new MaterializedModelManager((EObject)initialSelection.toList().get(0));
		
		this.page_1 = new PojoWizardPage_1(this.manager);
		addPage(page_1);
		
		this.page_2 = new PojoWizardPage_2(this.manager);
		addPage(page_2);
//		
