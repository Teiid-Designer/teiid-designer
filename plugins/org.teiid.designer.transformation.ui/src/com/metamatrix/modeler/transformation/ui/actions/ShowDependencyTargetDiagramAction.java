...
public class ShowDependencyTargetDiagramAction extends DiagramEditorAction {
    ...
    private Diagram getParentDiagram() {
        ...
        if( diagramNode != null ) {
            ...
            if( currentDiagram != null && currentDiagram.getType() != null && currentDiagram.getType().equals(PluginConstants.DEPENDENCY_DIAGRAM_TYPE_ID) ) {
                    ...
                    modelResource != null ) {
                        ...
                        if( parentObject != null && parentObject instanceof EObject ) {
                            try {
                                ...
                                String message = "ShowDependencyTargetDiagramAction cannot find parent package diagram";  //$NON-NLS-1$
