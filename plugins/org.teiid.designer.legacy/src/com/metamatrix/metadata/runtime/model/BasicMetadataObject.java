...
abstract public class BasicMetadataObject implements MetadataObject, Serializable {
    ...
    /**
     * Call constructor to instantiate a runtime object by passing the BasicRuntimeID that identifies the entity and the
     * BasicVirtualDatabaseID that identifes the Virtual Database the object will be contained.
     * 
    ...
    /**
     * returns the id for the Virtual Database for which this runtime object is contained within. This method will be overridden
     * by BasicVirtualDatabase so that it calls the super method getID to return as its <code>VirtualDatabaseID</code>.
     */
