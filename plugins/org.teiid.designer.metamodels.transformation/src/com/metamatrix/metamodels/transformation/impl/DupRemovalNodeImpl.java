...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Dup Removal Node</b></em>'. <!-- end-user-doc -->
 * <p>
 * </p>
 * 
 * @generated
 */
public class DupRemovalNodeImpl extends OperationNodeImpl implements DupRemovalNode {
    ...
    protected EClass eStaticClass() {
        return TransformationPackage.eINSTANCE.getDupRemovalNode();
    }
    ...
    public NotificationChain eInverseAdd( InternalEObject otherEnd,
        ...
        if (featureID >= 0) {
            switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
                case TransformationPackage.DUP_REMOVAL_NODE__OWNER:
                    if (eContainer != null) msgs = eBasicRemoveFromContainer(msgs);
                    return eBasicSetContainer(otherEnd, TransformationPackage.DUP_REMOVAL_NODE__OWNER, msgs);
                case TransformationPackage.DUP_REMOVAL_NODE__INPUT_LINKS:
                    return ((InternalEList)getInputLinks()).basicAdd(otherEnd, msgs);
                case TransformationPackage.DUP_REMOVAL_NODE__OUTPUT_LINKS:
                    return ((InternalEList)getOutputLinks()).basicAdd(otherEnd, msgs);
                case TransformationPackage.DUP_REMOVAL_NODE__EXPRESSIONS:
                    return ((InternalEList)getExpressions()).basicAdd(otherEnd, msgs);
                case TransformationPackage.DUP_REMOVAL_NODE__NODE_GROUP:
                    if (eContainer != null) msgs = eBasicRemoveFromContainer(msgs);
                    return eBasicSetContainer(otherEnd, TransformationPackage.DUP_REMOVAL_NODE__NODE_GROUP, msgs);
                default:
    ...
    public NotificationChain eInverseRemove( InternalEObject otherEnd,
        ...
        if (featureID >= 0) {
            switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
                case TransformationPackage.DUP_REMOVAL_NODE__OWNER:
                    return eBasicSetContainer(null, TransformationPackage.DUP_REMOVAL_NODE__OWNER, msgs);
                case TransformationPackage.DUP_REMOVAL_NODE__INPUT_LINKS:
                ...
                case TransformationPackage.DUP_REMOVAL_NODE__NODE_GROUP:
                    return eBasicSetContainer(null, TransformationPackage.DUP_REMOVAL_NODE__NODE_GROUP, msgs);
                default:
    ...
    public Object eGet( EStructuralFeature eFeature,
        ...
        switch (eDerivedStructuralFeatureID(eFeature)) {
            case TransformationPackage.DUP_REMOVAL_NODE__NAME:
                return getName();
            case TransformationPackage.DUP_REMOVAL_NODE__OWNER:
                return getOwner();
            case TransformationPackage.DUP_REMOVAL_NODE__INPUT_LINKS:
