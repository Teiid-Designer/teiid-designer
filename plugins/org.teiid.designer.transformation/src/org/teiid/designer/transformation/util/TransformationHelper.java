...
//                    final String userSql = SqlConverter.convertUUIDsToFullNames(deleteSql, container);
    ...
    public static boolean isTableThatSupportsUpdate( EObject target ) {
        ...
        SqlAspect sqlAspect = org.teiid.designer.core.metamodel.aspect.sql.SqlAspectHelper.getSqlAspect(target);
    ...
    public static boolean isSqlTable( Object obj ) {
        ...
        if (obj != null && obj instanceof EObject) {
            isTable = org.teiid.designer.core.metamodel.aspect.sql.SqlAspectHelper.isTable((EObject)obj);
        }
        return isTable;
    }
    ...
    public static boolean isXmlDocument( Object obj ) {
        boolean isTable = false;
        if (obj != null && obj instanceof EObject) {
            isTable = org.teiid.designer.core.metamodel.aspect.sql.SqlAspectHelper.isXmlDocument((EObject)obj);
        }
        return isTable;
    }
    ...
    public static boolean isSqlProcedure( Object obj ) {
        ...
        if (obj != null && obj instanceof EObject) {
            isProcedure = org.teiid.designer.core.metamodel.aspect.sql.SqlAspectHelper.isProcedure((EObject)obj);
        }
        return isProcedure;
    }
    ...
    public static boolean isSqlProcedureParameter( Object obj ) {
        boolean isProcedure = false;
        if (obj != null && obj instanceof EObject) {
            isProcedure = org.teiid.designer.core.metamodel.aspect.sql.SqlAspectHelper.isProcedureParameter((EObject)obj);
        }
        return isProcedure;
    }
    ...
    public static boolean isSqlProcedureResultSet( Object obj ) {
        boolean isProcedure = false;
        if (obj != null && obj instanceof EObject) {
            isProcedure = org.teiid.designer.core.metamodel.aspect.sql.SqlAspectHelper.isProcedureResultSet((EObject)obj);
        }
        return isProcedure;
    }
    ...
    public static boolean isSqlColumnSet( Object obj ) {
        boolean isTable = false;
        if (obj != null && obj instanceof EObject) {
            isTable = org.teiid.designer.core.metamodel.aspect.sql.SqlAspectHelper.isColumnSet((EObject)obj);
        }
        return isTable;
    }
    ...
    public static boolean isSqlColumn( Object obj ) {
        ...
        if (obj != null && obj instanceof EObject) {
            isColumn = org.teiid.designer.core.metamodel.aspect.sql.SqlAspectHelper.isColumn((EObject)obj);
        }
        return isColumn;
    }
    ...
    public static boolean isVirtualSqlTable( Object obj ) {
        ...
        if (obj != null && obj instanceof EObject) {
            boolean isTable = org.teiid.designer.core.metamodel.aspect.sql.SqlAspectHelper.isTable((EObject)obj);
            if (isTable) {
    ...
    public static boolean isValidSqlTransformationTarget( Object obj ) {
        ...
        if (obj != null && obj instanceof EObject) {
            isValidTarget = org.teiid.designer.core.metamodel.aspect.sql.SqlAspectHelper.isValidSqlTransformationTarget((EObject)obj);
    ...
    public static boolean isValidTransformationTarget( Object obj ) {
        boolean isValidTarget = false;
        if (obj != null && obj instanceof EObject) {
            isValidTarget = org.teiid.designer.core.metamodel.aspect.sql.SqlAspectHelper.isValidTransformationTarget((EObject)obj);
        }
        return isValidTarget;
    }
    ...
    public static List getTableColumns( final EObject sqlTable ) {
        ...
        if (sqlTable != null && org.teiid.designer.core.metamodel.aspect.sql.SqlAspectHelper.isTable(sqlTable)) {
    ...
    public static List getColumnSetColumns( final EObject sqlColumnSet ) {
        List columns = new ArrayList();
        if (sqlColumnSet != null && org.teiid.designer.core.metamodel.aspect.sql.SqlAspectHelper.isColumnSet(sqlColumnSet)) {
...
//            String oldSbString = CoreStringUtil.collapseWhitespace(oldSb.toString());
    ...
    private static org.eclipse.emf.common.command.Command getProcResultSetDescriptor( EObject procEObject ) {
        ...
        while (iter.hasNext()) {
            ...
            if (org.teiid.designer.core.metamodel.aspect.sql.SqlAspectHelper.isColumnSet(eObj)) {
                break;
            }
        }
    ...
    public static Object getSqlProcedureForResultSet( Object obj ) {
        if (obj != null && obj instanceof EObject) {
            MetamodelAspect aspect = org.teiid.designer.core.metamodel.aspect.sql.SqlAspectHelper.getSqlAspect((EObject)obj);
