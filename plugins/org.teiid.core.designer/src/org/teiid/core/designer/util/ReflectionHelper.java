...
public class ReflectionHelper {
    ...
    public ReflectionHelper( Class<?> targetClass ) {
        if ( targetClass == null ) {
            throw new IllegalArgumentException(CoreModelerPlugin.Util.getString("ReflectionHelper.errorConstructing")); //$NON-NLS-1$
        }
     ...
     * @throws TeiidDesignerException if an error occurs instantiating the class
     */

    public static final Object create(String className, Collection<?> ctorObjs, 
                                      final ClassLoader classLoader) throws TeiidDesignerException {
        try {
    ...
    public static final Object create(String className, Object[] ctorObjs, Class<?>[] argTypes, 
        ...
        if (ctor == null) {
              throw new TeiidDesignerException(className + " " + Arrays.toString(argTypes)); //$NON-NLS-1$
        }
