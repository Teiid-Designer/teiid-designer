...
import static org.teiid.designer.modelgenerator.salesforce.SalesforceConstants.SF_Column.PICKLIST_VALUES;
    ...
    private void addColumnsToTable( SalesforceObject sfo,
        ...
        for (int i = 0; i < fields.length; i++) {
            ...
            if (field.isPrimaryKey()) {
                column.setNullable(org.teiid.designer.metamodels.relational.NullableType.NO_NULLS_LITERAL);
