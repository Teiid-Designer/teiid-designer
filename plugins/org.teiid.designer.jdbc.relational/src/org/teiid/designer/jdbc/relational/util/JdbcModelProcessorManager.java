...
public class JdbcModelProcessorManager {
     ...
     * {@link org.teiid.designer.jdbc.metadata.JdbcDatabase JDBC metadata} into a
     * {@link org.teiid.designer.metamodels.relational.RelationalPackage Relational} model.
     * <p>
     * This method attempts to find the model processor that is best suited for the supplied source. It does so by searching for
     * the first <code>org.teiid.designer.jdbc.relational.modelProcessor</code> extension that is defined to work with the
