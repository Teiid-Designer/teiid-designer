...
import org.teiid.designer.relationship.ui.properties.RelationshipPropertyEditorFactory;
...
public class RelationshipTypePanel extends Composite
    ...
    private static final String NAME = UiConstants.Util.getString("org.teiid.designer.relationship.ui.editor.RelationshipTypePanel.name.text"); //$NON-NLS-1$
    private static final String SUPERTYPE_TEXT = UiConstants.Util.getString("org.teiid.designer.relationship.ui.editor.RelationshipTypePanel.superType.text"); //$NON-NLS-1$
    private static final String BROWSE_BUTTON_TEXT = UiConstants.Util.getString("org.teiid.designer.relationship.ui.editor.RelationshipTypePanel.browseButton.text"); //$NON-NLS-1$

    private static final String RELATION_EXPRESSIONS_PANEL_TITLE = UiConstants.Util.getString("org.teiid.designer.relationship.ui.editor.RelationshipTypePanel.relationExpressionsPanelTitle.text"); //$NON-NLS-1$        
    private static final String RELATION_EXPRESSIONS_PANEL_TEXT = UiConstants.Util.getString("org.teiid.designer.relationship.ui.editor.RelationshipTypePanel.relationExpressionsPanelExplanation.text"); //$NON-NLS-1$       
    private static final String DEFAULT_ROLE_A_NAME = UiConstants.Util.getString("org.teiid.designer.relationship.ui.editor.RelationshipTypePanel.defaultRoleAName.text"); //$NON-NLS-1$
    private static final String DEFAULT_ROLE_B_NAME = UiConstants.Util.getString("org.teiid.designer.relationship.ui.editor.RelationshipTypePanel.defaultRoleBName.text"); //$NON-NLS-1$

    private static final String DIRECTED_CHECKBOX_TEXT = UiConstants.Util.getString("org.teiid.designer.relationship.ui.editor.RelationshipTypePanel.directedCheckbox.text"); //$NON-NLS-1$
    private static final String EXCLUSIVE_CHECKBOX_TEXT = UiConstants.Util.getString("org.teiid.designer.relationship.ui.editor.RelationshipTypePanel.exclusiveCheckbox.text"); //$NON-NLS-1$
    private static final String CROSS_MODEL_CHECKBOX_TEXT = UiConstants.Util.getString("org.teiid.designer.relationship.ui.editor.RelationshipTypePanel.crossModelCheckbox.text"); //$NON-NLS-1$
    private static final String ABSTRACT_CHECKBOX_TEXT = UiConstants.Util.getString("org.teiid.designer.relationship.ui.editor.RelationshipTypePanel.abstractCheckbox.text"); //$NON-NLS-1$
    private static final String ROLE_A_TITLE = UiConstants.Util.getString("org.teiid.designer.relationship.ui.editor.RelationshipTypePanel.roleA.title"); //$NON-NLS-1$
    private static final String ROLE_B_TITLE = UiConstants.Util.getString("org.teiid.designer.relationship.ui.editor.RelationshipTypePanel.roleB.title"); //$NON-NLS-1$
    private static final String PROPERTIES_TITLE = UiConstants.Util.getString("org.teiid.designer.relationship.ui.editor.RelationshipTypePanel.properties.title"); //$NON-NLS-1$
    private static final String INHERITANCE_TITLE = UiConstants.Util.getString("org.teiid.designer.relationship.ui.editor.RelationshipTypePanel.inheritance.title"); //$NON-NLS-1$

    final String INCLUDE_TYPES_TEXT = UiConstants.Util.getString("org.teiid.designer.relationship.ui.editor.RelationshipTypePanel.includeTypes.text"); //$NON-NLS-1$
    final String EXCLUDE_TYPES_TEXT = UiConstants.Util.getString("org.teiid.designer.relationship.ui.editor.RelationshipTypePanel.excludeTypes.text"); //$NON-NLS-1$

    private final String PROPERTIES_BUTTON_TEXT = UiConstants.Util.getString("org.teiid.designer.relationship.ui.editor.RelationshipTypePanel.propertiesButton.text"); //$NON-NLS-1$
    private final String ROLE_A_TYPE_NAME_TEXT = UiConstants.Util.getString("org.teiid.designer.relationship.ui.editor.RelationshipTypePanel.roleATypeName.text"); //$NON-NLS-1$
    private final String ROLE_B_TYPE_NAME_TEXT = UiConstants.Util.getString("org.teiid.designer.relationship.ui.editor.RelationshipTypePanel.roleBTypeName.text"); //$NON-NLS-1$

    private final String ORDERED_TEXT = UiConstants.Util.getString("org.teiid.designer.relationship.ui.editor.RelationshipTypePanel.ordered.text"); //$NON-NLS-1$          
    private final String UNIQUE_TEXT = UiConstants.Util.getString("org.teiid.designer.relationship.ui.editor.RelationshipTypePanel.unique.text"); //$NON-NLS-1$
    private final String NAVIGABLE_TEXT = UiConstants.Util.getString("org.teiid.designer.relationship.ui.editor.RelationshipTypePanel.navigable.text"); //$NON-NLS-1$

    private final String LOWER_BOUND_TEXT = UiConstants.Util.getString("org.teiid.designer.relationship.ui.editor.RelationshipTypePanel.lowerBound.text"); //$NON-NLS-1$
    private final String UPPER_BOUND_TEXT = UiConstants.Util.getString("org.teiid.designer.relationship.ui.editor.RelationshipTypePanel.upperBound.text"); //$NON-NLS-1$
    ...
    private static final String EXPLORER_VIEW = org.teiid.designer.ui.UiConstants.Extensions.Explorer.VIEW;
    ...
    class RolePanel extends Composite implements IContentFilter, SelectionListener {
        ...
        private final String ADD_TEXT = UiConstants.Util.getString("org.teiid.designer.relationship.ui.editor.RelationshipPanel.add.text"); //$NON-NLS-1$
        private final String REMOVE_TEXT = UiConstants.Util.getString("org.teiid.designer.relationship.ui.editor.RelationshipPanel.remove.text"); //$NON-NLS-1$
        private final String OBJECT_NAME_TITLE = UiConstants.Util.getString("org.teiid.designer.relationship.ui.editor.RelationshipTypePanel.metaclassName.title"); //$NON-NLS-1$
        private final String OBJECT_PATH_TITLE = UiConstants.Util.getString("org.teiid.designer.relationship.ui.editor.RelationshipTypePanel.metaclassPath.title"); //$NON-NLS-1$
    ...
    class InheritanceTablePanel extends Composite implements SelectionListener {
        ...
        private static final int BUTTON_GRID_STYLE = GridData.HORIZONTAL_ALIGN_FILL | GridData.HORIZONTAL_ALIGN_CENTER;
        private final String CLASS_NAME_TITLE = UiConstants.Util.getString("org.teiid.designer.relationship.ui.editor.RelationshipTypePanel.className.title"); //$NON-NLS-1$
        private final String CLASS_PATH_TITLE = UiConstants.Util.getString("org.teiid.designer.relationship.ui.editor.RelationshipTypePanel.classPath.title"); //$NON-NLS-1$

        private final String SUBTYPES_TEXT = UiConstants.Util.getString("org.teiid.designer.relationship.ui.editor.RelationshipTypePanel.subTypes.text"); //$NON-NLS-1$    
        private final String FIND_BUTTON_TEXT = UiConstants.Util.getString("org.teiid.designer.relationship.ui.editor.RelationshipTypePanel.findButton.text"); //$NON-NLS-1$
