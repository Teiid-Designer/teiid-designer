...
import org.teiid.designer.relationship.ui.properties.RelationshipRoleSelectionValidator;
...
public class RelationshipPanel extends Composite
    ...
    private static final String RELATIONSHIP_NAME_TEXT = UiConstants.Util.getString("org.teiid.designer.relationship.ui.editor.RelationshipPanel.name.text"); //$NON-NLS-1$
    private static final String RELATIONSHIP_TYPE_TEXT = UiConstants.Util.getString("org.teiid.designer.relationship.ui.editor.RelationshipPanel.type.text"); //$NON-NLS-1$
    private static final String LOCATION_TEXT = UiConstants.Util.getString("org.teiid.designer.relationship.ui.editor.RelationshipPanel.location.text"); //$NON-NLS-1$
    private static final String BROWSE_TEXT = UiConstants.Util.getString("org.teiid.designer.relationship.ui.editor.RelationshipPanel.browse.text"); //$NON-NLS-1$
    private static final String ROLES_TAB_TEXT = UiConstants.Util.getString("org.teiid.designer.relationship.ui.editor.RelationshipPanel.rolesTab.title"); //$NON-NLS-1$
    ...
    private static final String NEED_LOCATION_ERROR_MSG = UiConstants.Util.getString("org.teiid.designer.relationship.ui.editor.RelationshipPanel.needLocation.text"); //$NON-NLS-1$
    private static final String SELECT_TYPE_TEXT = UiConstants.Util.getString("org.teiid.designer.relationship.ui.editor.RelationshipPanel.selectType.text"); //$NON-NLS-1$

    static final String DEFAULT_ROLE_A_NAME = UiConstants.Util.getString("org.teiid.designer.relationship.ui.editor.RelationshipTypePanel.defaultRoleAName.text"); //$NON-NLS-1$
    static final String DEFAULT_ROLE_B_NAME = UiConstants.Util.getString("org.teiid.designer.relationship.ui.editor.RelationshipTypePanel.defaultRoleBName.text"); //$NON-NLS-1$
    private static/*final*/String SWAP_TEXT = UiConstants.Util.getString("org.teiid.designer.relationship.ui.editor.RelationshipTypePanel.swap.text"); //$NON-NLS-1$
    ...
    class RolePanel extends Composite implements SelectionListener {
        ...
        private final String OBJECT_NAME_TITLE = UiConstants.Util.getString("org.teiid.designer.relationship.ui.editor.RelationshipPanel.objectName.title"); //$NON-NLS-1$
        private final String OBJECT_PATH_TITLE = UiConstants.Util.getString("org.teiid.designer.relationship.ui.editor.RelationshipPanel.objectPath.title"); //$NON-NLS-1$
