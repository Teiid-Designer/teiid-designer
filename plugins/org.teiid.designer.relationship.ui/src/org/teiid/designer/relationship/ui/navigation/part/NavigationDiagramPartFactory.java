 ...
 */
package org.teiid.designer.relationship.ui.navigation.part;
...
import org.teiid.designer.relationship.NavigationHistory;
import org.teiid.designer.relationship.ui.UiConstants;
import org.teiid.designer.relationship.ui.navigation.figure.NavigationDiagramFigureFactory;
import org.teiid.designer.relationship.ui.navigation.model.DummyFocusModelNode;
import org.teiid.designer.relationship.ui.navigation.model.FocusModelNode;
import org.teiid.designer.relationship.ui.navigation.model.LabelModelNode;
import org.teiid.designer.relationship.ui.navigation.model.NavigationContainerModelNode;
import org.teiid.designer.relationship.ui.navigation.model.NavigationDiagramLink;
import org.teiid.designer.relationship.ui.navigation.model.NavigationDiagramNode;
import org.teiid.designer.relationship.ui.navigation.model.NonFocusModelNode;
import org.teiid.designer.relationship.ui.navigation.model.RelationshipModelNode;
...
public class NavigationDiagramPartFactory extends AbstractDiagramEditPartFactory implements UiConstants {
    ...
    public NavigationDiagramPartFactory( NavigationHistory history ) {
        ...
        if (figureFactory == null) figureFactory = new NavigationDiagramFigureFactory(history);
    }
    ...
    public EditPart createEditPart( EditPart iContext,
        ...
        if (iModel instanceof NavigationDiagramNode) {
            ...
            // NotationPartGenerator generator =
            // DiagramUiPlugin.getDiagramNotationManager().getEditPartGenerator(getNotationId());
            // if( generator != null ) {
        ...
        if (editPart != null) {
            ...
            } else if (editPart instanceof NavigationNodeEditPart) {
                editPart.setModel(iModel);
            }
