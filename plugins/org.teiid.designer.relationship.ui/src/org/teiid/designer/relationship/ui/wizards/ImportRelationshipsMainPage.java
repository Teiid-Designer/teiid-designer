 ...
 */
package org.teiid.designer.relationship.ui.wizards;
...
import org.teiid.designer.relationship.ui.textimport.RelationshipTextImportModelSelectorDialog;
import org.teiid.designer.relationship.ui.textimport.RelationshipsLocationSelectionValidator;
 ...
 * @since 4.2
 */
public class ImportRelationshipsMainPage extends WizardDataTransferPage
    implements UiConstants, IListPanelController, ITextImportMainPage {
    ...
    private static final String I18N_PREFIX = "ImportRelationshipsMainPage"; //$NON-NLS-1$
    ...
    private static final int LARGE_ROWS = 500;
     ...
     */
    protected ImportRelationshipsMainPage( String title,
     ...
     */
    public ImportRelationshipsMainPage( IStructuredSelection selection ) {
        this(PAGE_TITLE, selection);
        setTitle(PAGE_TITLE);
    }

    public ImportRelationshipsMainPage() {
        this(null);
    }
    ...
    protected void handleSourceBrowseButtonPressed() {
        ...
        if (selectedFile != null) {
            if (!selectedFile.equals(sourceNameField.getText())) {
                ...
                this.rows = this.relationshipObjectProcessor.loadLinesFromFile(sourceNameField.getText());
    ...
    public boolean finish() {
        ...
        Collection tableRows = this.relationshipObjectProcessor.createRowObjsFromStrings(this.rows);

        if (!tableRows.isEmpty() && relationshipObjectProcessor.confirmLargeImport(this.getShell(), tableRows.size(), LARGE_ROWS)) {
