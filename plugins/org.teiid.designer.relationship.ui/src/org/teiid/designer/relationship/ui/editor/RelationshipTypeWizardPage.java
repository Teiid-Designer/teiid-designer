...
//    private Composite parent;
    ...
    private static final String TITLE 
        = UiConstants.Util.getString("org.teiid.designer.relationship.ui.editor.RelationshipTypeWizardPage.title.text"); //$NON-NLS-1$
        
    private static final String STATUS_OK_MESSAGE
        = UiConstants.Util.getString("org.teiid.designer.relationship.ui.editor.RelationshipTypeWizardPage.statusOkMessage.text"); //$NON-NLS-1$
        
    private static final String STARTUP_MESSAGE
        = UiConstants.Util.getString("org.teiid.designer.relationship.ui.editor.RelationshipTypeWizardPage.startupMessage.text"); //$NON-NLS-1$
