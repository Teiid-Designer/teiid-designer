 ...
 */
package org.teiid.designer.relationship.ui.textimport;
 ...
 * @since 4.2
 */
public class RelationshipsLocationSelectionValidator  implements ISelectionStatusValidator, UiConstants {

    private StatusInfo stStatus;
    private static final String WRONG_CLASS_ERROR_MSG 
        = Util.getString("RelationshipsLocationSelectionValidator.wrongClassErrorMessage.text"); //$NON-NLS-1$
    private static final String CONTAINER_READONLY_ERROR_MSG 
        = Util.getString("RelationshipsLocationSelectionValidator.containerReadOnlyErrorMessage.text"); //$NON-NLS-1$
    private static final String CONTAINER_OBJECT_READONLY_ERROR_MSG 
        = Util.getString("RelationshipsLocationSelectionValidator.containerObjectReadOnlyErrorMessage.text"); //$NON-NLS-1$
    private static final String CONTAINER_MODEL_READONLY_ERROR_MSG 
        = Util.getString("RelationshipsLocationSelectionValidator.containerModelReadOnlyErrorMessage.text"); //$NON-NLS-1$
