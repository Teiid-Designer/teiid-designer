...
public class RelationshipWizardPage extends WizardPage implements IStatusListener {
    ...
    private static final String PAGE_NAME = UiConstants.Util.getString("org.teiid.designer.relationship.ui.editor.RelationshipWizardPage.pageName.text"); //$NON-NLS-1$
    private static final String TITLE = UiConstants.Util.getString("org.teiid.designer.relationship.ui.editor.RelationshipWizardPage.title.text"); //$NON-NLS-1$
    private static final String STATUS_OK_MESSAGE = UiConstants.Util.getString("org.teiid.designer.relationship.ui.editor.RelationshipWizardPage.statusOkMessage.text"); //$NON-NLS-1$
    private static final String STARTUP_MESSAGE = UiConstants.Util.getString("org.teiid.designer.relationship.ui.editor.RelationshipWizardPage.startupMessage.text"); //$NON-NLS-1$
    ...
    /* (non-Javadoc)
     * @See org.teiid.designer.ui.wizards.INewAssociationWizard#setAssociationDescriptor(org.teiid.designer.core.association.AssociationDescriptor)
     */
