...
public class CustomDiagramPermanentActionContributor implements IModelObjectActionContributor {
    ...
    public void contributeToContextMenu( IMenuManager theMenuMgr,
        ...
        if (SelectionUtilities.isSingleSelection(theSelection)) {
            ...
            if (selectedObject instanceof EObject) {
                ...
                if (mr != null && RelationshipDiagramUtil.isRelationshipModelResource(mr)) addToChildMenu(theMenuMgr);
            }
        }
    }
    ...
    public List<IAction> getAdditionalModelingActions( ISelection theSelection ) {
        ...
        // if (SelectionUtilities.isSingleSelection(theSelection) && SelectionUtilities.isAllEObjects(theSelection)) {
    ...
    private boolean isPackage( EObject eObject ) {
        // if (eObject instanceof RelationshipFolder) return true;
