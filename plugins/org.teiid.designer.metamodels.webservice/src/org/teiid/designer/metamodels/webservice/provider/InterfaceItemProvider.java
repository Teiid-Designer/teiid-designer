...
/**
 * This is the item provider adapter for a {@link org.teiid.designer.metamodels.webservice.Interface} object. <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
 */
public class InterfaceItemProvider extends WebServiceComponentItemProvider {
    ...
    public Collection getChildrenFeatures( Object object ) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(WebServicePackage.eINSTANCE.getInterface_Operations());
        }
    ...
    public String getText( Object object ) {
        ...
        if (label == null || label.trim().length() == 0) {
            label = getString("_UI_Interface_type"); //$NON-NLS-1$
        }
        return label;
    }
    ...
    protected void collectNewChildDescriptors( Collection newChildDescriptors,
        ...
        newChildDescriptors.add(createChildParameter(WebServicePackage.eINSTANCE.getInterface_Operations(),
                                                     WebServiceFactory.eINSTANCE.createOperation()));
    }
