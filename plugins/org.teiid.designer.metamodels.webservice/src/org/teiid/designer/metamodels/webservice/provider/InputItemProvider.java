...
/**
 * This is the item provider adapter for a {@link org.teiid.designer.metamodels.webservice.Input} object. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * 
 * @generated
 */
public class InputItemProvider extends MessageItemProvider {
    ...
    public Object getImage( Object object ) {
        return getResourceLocator().getImage("full/obj16/Input"); //$NON-NLS-1$
    }
    ...
    public String getText( Object object ) {
        ...
        if (label == null || label.trim().length() == 0) {
            label = getString("_UI_Input_type"); //$NON-NLS-1$
        }
        return label;
    }
