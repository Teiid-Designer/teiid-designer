...
public class Messages extends NLS {
    ...
    public static String availableMedsDialogTableLabel;
    public static String availableMedsDialogDoneMsg;
    ...
    public static String editPropertyDialogAllowedValueRequiredMsg;
