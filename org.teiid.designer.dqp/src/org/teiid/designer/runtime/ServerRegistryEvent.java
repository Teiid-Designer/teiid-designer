...
/**
 * The <code>ServerRegistryEvent</code> class is the event that is broadcast from the {@link ServerRegistry server manager} when a
...
public final class ServerRegistryEvent {
     ...
     * @see Type#NEW
     */
    public static ServerRegistryEvent createNewEvent( ServerRegistry serverManager,
                                                      Server newServer ) {
        ArgCheck.isNotNull(serverManager, "serverManager"); //$NON-NLS-1$
        ArgCheck.isNotNull(newServer, "newServer"); //$NON-NLS-1$
     ...
     * @see Type#REMOVE
     */
    public static ServerRegistryEvent createRemoveEvent( ServerRegistry serverManager,
                                                         Server removedServer ) {
        ArgCheck.isNotNull(serverManager, "serverManager"); //$NON-NLS-1$
        ArgCheck.isNotNull(removedServer, "removedServer"); //$NON-NLS-1$
     ...
     * @see Type#UPDATE
     */
    public static ServerRegistryEvent createUpdateEvent( ServerRegistry serverManager,
     ...
     */
    private ServerRegistryEvent( ServerRegistry serverManager,
                                 Type type,
                                 Server server ) {
     ...
     */
    public ServerRegistry getServerManager() {
