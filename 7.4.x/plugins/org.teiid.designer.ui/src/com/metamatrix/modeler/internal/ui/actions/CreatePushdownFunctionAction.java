...
/**
 * Action and dialog designed to help create relational source model Pushdown functions. Basically, this provides users the
 * ability to model functions defined in databases and use the function call within virtual table or procedure SQL
 * statements/transformations. (see {@link UdfManager})
 */
public class CreatePushdownFunctionAction extends Action implements INewChildAction, INewSiblingAction { // ISelectionListener,
    // Comparable,
    // ISelectionAction,
    ...
    private void createProcedureInTxn( ModelResource modelResource,
                                       PushdownFunctionData data ) {
        ...
        try {
            ...
            if (editor != null) {
                ...
                factory.createParameter(data.getReturnParameterName(),
                                        null,
                                        true,
                                        pfd,
                                        false,
                                        returnParamDatatype,
                                        data.getReturnParameterLength());
                ...
                ANNOTATION_HELPER.addProperty(pfd,
                                              PushdownFunctionData.DETERMINISTIC_PROPERTY_KEY,
                                              Boolean.toString(data.getDeterministic()));
    ...
    class PushdownFunctionInputDialog extends TitleAreaDialog {
        ...
        public PushdownFunctionInputDialog( Shell parentShell,
                                            PushdownFunctionData data ) {
            super(parentShell);
            this.setTitle(TITLE);
            this.data = data;
        ...
        protected Control createDialogArea( Composite parent ) {
            ...
            Group nameGroup = WidgetFactory.createGroup(mainPanel,
                                                        UiConstants.Util.getString("PushdownFunctionInputDialog.name"), GridData.FILL_HORIZONTAL, 2, 1); //$NON-NLS-1$
            ...
            Group returnParamsGroup = WidgetFactory.createGroup(mainPanel,
                                                                UiConstants.Util.getString("PushdownFunctionInputDialog.returnParameter"), GridData.FILL_HORIZONTAL, 2, 3); //$NON-NLS-1$
            ...
            Group propertiesGroup = WidgetFactory.createGroup(mainPanel,
                                                              UiConstants.Util.getString("PushdownFunctionInputDialog.properties"), GridData.FILL_BOTH, 2, 2); //$NON-NLS-1$
            ...
            Group descriptionGroup = WidgetFactory.createGroup(mainPanel,
                                                               UiConstants.Util.getString("PushdownFunctionInputDialog.description"), GridData.FILL_HORIZONTAL, 2, 1); //$NON-NLS-1$
            GridData gdd = new GridData(GridData.FILL_BOTH);
            gdd.heightHint = 80;
            descriptionGroup.setLayoutData(gdd);

            StyledTextEditor textEditor = new StyledTextEditor(descriptionGroup, SWT.MULTI | SWT.V_SCROLL | SWT.H_SCROLL
                                                                                 | SWT.BORDER);
        ...
        protected void inputIncludeSelected( int rowID,
                                             boolean value ) {
    ...
    class ParameterRow {
        ...
        PushdownFunctionInputDialog dialog;
