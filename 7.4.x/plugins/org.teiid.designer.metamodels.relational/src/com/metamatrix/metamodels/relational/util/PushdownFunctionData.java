...
public class PushdownFunctionData {
    ...
    public void setToDefault( String name,
        ...
        for (int i = 0; i < numParams; i++) {
            ...
            param = new ParameterData(StringUtilities.EMPTY_STRING, PushdownFunctionData.DEFAULT_TYPE,
                                      PushdownFunctionData.DEFAULT_LENGTH);
            param.include();
            params.add(param);
        }
    ...
    public void setReturnParameterName( String returnParameterName ) {
        if (this.returnParameter == null) {
            this.returnParameter = new ParameterData(returnParameterName, PushdownFunctionData.DEFAULT_TYPE,
                                                     PushdownFunctionData.DEFAULT_LENGTH);
        } else {
    ...
    public void setInputParameterData( int index,
                                       String name,
                                       String type,
                                       int length ) {
        int nParams = this.inputParameters.size();
