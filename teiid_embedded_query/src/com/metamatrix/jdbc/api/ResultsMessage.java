...
public class ResultsMessage implements Externalizable {
    ...
    /**
     * Query plan annotations, if OPTION SHOWPLAN or OPTION PLANONLY was used: Collection of Object[] where each Object[] holds
     * annotation information that can be used to create an Annotation implementation in JDBC.
     */
    ...
    /**
     * Instantiate and copy relevant information from the original request message. Typically, the transaction context should only
     * be copied if this results message is being returned from the connector to the query engine. Clients will be unable to
    ...
    public String toString() {
        ...
        .append(results == null ? 0 : results.length).append(" finalRow=") //$NON-NLS-1$
        .append(finalRow).toString();
    }
