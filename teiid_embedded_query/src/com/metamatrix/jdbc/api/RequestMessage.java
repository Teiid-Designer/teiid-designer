...
public class RequestMessage implements Serializable {
    ...
    public void setTxnAutoWrapMode( String txnAutoWrapMode ) throws MetaMatrixProcessingException {
        if (txnAutoWrapMode != null) {
            ...
            if (!(txnAutoWrapMode.equals(ExecutionProperties.AUTO_WRAP_OFF)
                  ...
                  || txnAutoWrapMode.equals(ExecutionProperties.AUTO_WRAP_OPTIMISTIC) || txnAutoWrapMode.equals(ExecutionProperties.AUTO_WRAP_PESSIMISTIC))) {
                throw new MetaMatrixProcessingException(I18nUtil.getString("RequestMessage.invalid_txnAutoWrap", txnAutoWrapMode)); //$NON-NLS-1$
            }
        }
    ...
    /**
     * Set time that the time when the command was created by the client. NOTE: By default, this gets set to the current time by
     * the constructor.
     * 
