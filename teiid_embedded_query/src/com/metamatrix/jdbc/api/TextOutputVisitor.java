...
public class TextOutputVisitor extends PlanVisitor {
    ...
    private void printScalarValue( PlanNode node,
                                   String propName ) {
        text.append("+ "); //$NON-NLS-1$
    ...
    private void printNodeValue( int numTabs,
                                 String propName,
                                 Object propObject ) {
        text.append("+ "); //$NON-NLS-1$
        text.append(displayHelper.getPropertyName(propName));
    ...
    private void printCollectionValue( int propTabs,
                                       String propName,
                                       Object propObject ) {
    ...
    public static String convertToText( PlanNode node,
                                        int initialTabs ) {
