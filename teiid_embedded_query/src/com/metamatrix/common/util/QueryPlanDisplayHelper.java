...
public class QueryPlanDisplayHelper implements DisplayHelper {
     ...
     * @since 5.0
     */
    private void putPropertySortOrder( String type,
                                       String[] propOrder ) {
    ...
    private String replaceProperties( String descriptionExpression,
                                      Map nodeProps ) {
        ...
        descriptionExpression = descriptionExpression.substring(0, startIndex)
                                + replacement
                                + ((endIndex < descriptionExpression.length() - 1) ? descriptionExpression.substring(endIndex + 1) : ""); //$NON-NLS-1$
