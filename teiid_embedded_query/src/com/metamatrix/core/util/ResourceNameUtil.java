...
public abstract class ResourceNameUtil {
    ...
    public static final String SYSTEM_NAME = CoreConstants.SYSTEM_MODEL; //$NON-NLS-1$    
    ...
    public static final String[] RESERVED_XMI_NAMES = {CORE_NAME, BUILTINRELATIONALTYPES_NAME, DATAACCESS_NAME,
        ...
        SYSTEM_NAME, TRANSFORMATION_NAME, UML2_NAME, WEBSERVICE_NAME, WSDL1_1_NAME, WSDLSOAP_NAME, XML_NAME, XSD_NAME,};
