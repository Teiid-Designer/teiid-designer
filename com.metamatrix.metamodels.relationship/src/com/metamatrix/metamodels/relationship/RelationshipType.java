 ...
 *
 * <!-- begin-model-doc -->
 * A definition of the form for a relationship.  In particular, it defines constraints on the types (metaclasses) and numbers of objects that can be bound to a relationship.  Typically, many relationships have the same type.  Types can restrict or extend other types (that is, support generalization or specialization).
 * 
...
public interface RelationshipType extends RelationshipEntity{
     ...
     * <!-- begin-user-doc -->
     * <p>
     * A relationship type that is directed simply implies that the sources and targets are sufficiently
     * different such that a single object must be placed in one side or the other.  Most
     * relationship types are directed.  "Parent Of", "Author Of", "Uses", "Depends On"
     * are all examples of directed relationship types.
     * </p><p>
     * A relationship type that is not directed denotes that it doesn't really matter as to which side
     * an object participates in a relationship.  Non-directed relationships are typically loose associations.
     * For example, "sibling" might be a relationship type that is not directed.
     * </p>
     * <!-- end-user-doc -->
     * <!-- begin-model-doc -->
     * Specifies whether the relationship type has the concept of direction.  Defaults to 'true'.
     * <!-- end-model-doc -->
    ...
    /**
     * Sets the value of the '{@link com.metamatrix.metamodels.relationship.RelationshipType#isDirected <em>Directed</em>}' attribute.
     * <!-- begin-user-doc -->
     * <p>
     * A relationship type that is directed simply implies that the sources and targets are sufficiently
     * different such that a single object must be placed in one side or the other.  Most
     * relationship types are directed.  "Parent Of", "Author Of", "Uses", "Depends On"
     * are all examples of directed relationship types.  Directed relationship types also have an
     * {@link #getOppositeName() opposite name} that differs from the {@link #getName()}.  A directed
     * relationship type with a name "Author Of" might have an opposite name of "Written by".
     * </p><p>
     * A relationship type that is not directed denotes that it doesn't really matter as to which side
     * an object participates in a relationship.  Non-directed relationships are typically loose associations,
     * and typically there is no need for an {@link #getOppositeName() opposite name} (since it would be
     * the same as the {@link #getName()}). 
     * For example, "sibling" might be a relationship type that is not directed.
     * </p>
     * <!-- end-user-doc -->
     ...
     * <!-- begin-user-doc -->
     * <p>
     * If a relationship type is exclusive, then an object participating in a relationship must participate
     * either in the {@link #getSourceRole() source role} or in the {@link #getTargetRole() target role}
     * of the relationship, but not both.
     * </p>
     * <!-- end-user-doc -->
     * <!-- begin-model-doc -->
     * Defines whether it is legal for one object to be in both the 'sources' and a 'targets' references.  A value of 'true' means an object may appear in one or the other, but not both.  The default is 'true'.
     * <!-- end-model-doc -->
    ...
    /**
     * Sets the value of the '{@link com.metamatrix.metamodels.relationship.RelationshipType#isExclusive <em>Exclusive</em>}' attribute.
     * <!-- begin-user-doc -->
     * <p>
     * If a relationship type is exclusive, then an object participating in a relationship must participate
     * either in the {@link #getSourceRole() source role} or in the {@link #getTargetRole() target role}
    ...
    /**
     * Returns the value of the '<em><b>Cross Model</b></em>' attribute.
     * The default value is <code>"true"</code>.
     * <!-- begin-user-doc -->
     * <p>
     * A relationship type that allows participants in {@link Relationship} to exist in different models
     * is considered to be cross-model.  Thus, a relationship type that requires participants in a
     * relationship to exist in the same model is considered to be not cross-model.
     * </p>
     * <!-- end-user-doc -->
     * <!-- begin-model-doc -->
     * Defines whether it is legal for relationship instances with this type to reference objects that are in different models.  The default is 'true'.
     * <!-- end-model-doc -->
    ...
    /**
     * Sets the value of the '{@link com.metamatrix.metamodels.relationship.RelationshipType#isCrossModel <em>Cross Model</em>}' attribute.
     * <!-- begin-user-doc -->
     * <p>
     * A relationship type that allows participants in {@link Relationship} to exist in different models
     * is considered to be cross-model.  Thus, a relationship type that requires participants in a
     ...
     * <!-- begin-user-doc -->
     * <p>
     * An abstract relationship type cannot be referenced as the {@link Relationship#getType() type} of
     * a {@link Relationship}.  In other words, it cannot be "instantiated".
     * </p>
     * <!-- end-user-doc -->
     * <!-- begin-model-doc -->
     * Defines whether instances can be created of this relationship type.  An abstract relationship type cannot be instantiated.  
     * <!-- end-model-doc -->
    ...
    /**
     * Sets the value of the '{@link com.metamatrix.metamodels.relationship.RelationshipType#isAbstract <em>Abstract</em>}' attribute.
     * <!-- begin-user-doc -->
     * <p>
     * An abstract relationship type cannot be referenced as the {@link Relationship#getType() type} of
     * a {@link Relationship}.  In other words, it cannot be "instantiated".
     ...
     * <!-- begin-user-doc -->
     * <p>
     * All relationship types defined by users are considered to be user-defined.  Thus, the only relationship
     * types that would return false from this method are those that are "built-in" to the application.
     * </p>
     * <!-- end-user-doc -->
     * <!-- begin-model-doc -->
     * Defines whether a user has defined this type.  The only relationship types that can have a value set to 'false' are those types created by MetaMatrix and managed as "built-in relationshp types".
     * <!-- end-model-doc -->
    ...
    /**
     * Sets the value of the '{@link com.metamatrix.metamodels.relationship.RelationshipType#isUserDefined <em>User Defined</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * The literals are from the enumeration {@link com.metamatrix.metamodels.relationship.RelationshipTypeStatus}.
     * <!-- begin-user-doc -->
     * <p>
    ...
    /**
     * Sets the value of the '{@link com.metamatrix.metamodels.relationship.RelationshipType#getStatus <em>Status</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    /**
     * Sets the value of the '{@link com.metamatrix.metamodels.relationship.RelationshipType#getStereotype <em>Stereotype</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    /**
     * Sets the value of the '{@link com.metamatrix.metamodels.relationship.RelationshipType#getConstraint <em>Constraint</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * <!-- end-user-doc -->
     * <!-- begin-model-doc -->
     * If the RelationshipType has implied direction, the label generally reflects the verbage for such relationships in that direction.  For example, if a RelationshipType might have a label of "Author of", then the opposite label might be "Written by".
     * <!-- end-model-doc -->
    ...
    /**
     * Returns the value of the '<em><b>Opposite Label</b></em>' attribute.
     * <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Opposite Label</em>' attribute isn't clear,
     * there really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     * <!-- begin-model-doc -->
     * If the RelationshipType has implied direction, the label generally reflects the verbage for such relationships in that direction.  This field defines an alternative label from the opposite perspective.  For example, if a RelationshipType has a label of "Author of", then the opposite label might be "Written by".
     * <!-- end-model-doc -->
    ...
    /**
     * Sets the value of the '{@link com.metamatrix.metamodels.relationship.RelationshipType#getOppositeLabel <em>Opposite Label</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    /**
     * Returns the value of the '<em><b>Relationship Features</b></em>' reference list.
     * The list contents are of type {@link org.eclipse.emf.ecore.EStructuralFeature}.
     * <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Relationship Features</em>' reference list isn't clear,
     * there really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     ...
     * It is bidirectional and its opposite is '{@link com.metamatrix.metamodels.relationship.RelationshipType#getSubType <em>Sub Type</em>}'.
     * <!-- begin-user-doc -->
     * <p>
    ...
    /**
     * Sets the value of the '{@link com.metamatrix.metamodels.relationship.RelationshipType#getSuperType <em>Super Type</em>}' reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    /**
     * Unsets the value of the '{@link com.metamatrix.metamodels.relationship.RelationshipType#getSuperType <em>Super Type</em>}' reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see #isSetSuperType()
     * @see #getSuperType()
    ...
    /**
     * Returns whether the value of the '{@link com.metamatrix.metamodels.relationship.RelationshipType#getSuperType <em>Super Type</em>}' reference is set.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * It is bidirectional and its opposite is '{@link com.metamatrix.metamodels.relationship.RelationshipType#getSuperType <em>Super Type</em>}'.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * The list contents are of type {@link com.metamatrix.metamodels.relationship.RelationshipRole}.
     * It is bidirectional and its opposite is '{@link com.metamatrix.metamodels.relationship.RelationshipRole#getRelationshipType <em>Relationship Type</em>}'.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @model type="com.metamatrix.metamodels.relationship.RelationshipRole" opposite="relationshipType" containment="true" lower="2" upper="2"
     * @generated
     */
    EList getRoles();
     ...
     * It is bidirectional and its opposite is '{@link com.metamatrix.metamodels.relationship.RelationshipFolder#getOwnedRelationshipTypes <em>Owned Relationship Types</em>}'.
     * <!-- begin-user-doc -->
     * <p>
    ...
    /**
     * Sets the value of the '{@link com.metamatrix.metamodels.relationship.RelationshipType#getOwner <em>Owner</em>}' container reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * <!-- end-user-doc -->
     * <!-- begin-model-doc -->
     * Convenience method to obtain the 'source' RelationshipRole in this RelationshipType.
     * <!-- end-model-doc -->
     * @model parameters=""
     * @generated
     */
     ...
     * <!-- end-user-doc -->
     * <!-- begin-model-doc -->
     * Method to obtain all of the relationship features from this type and it's superType (recursively).
     * <!-- end-model-doc -->
