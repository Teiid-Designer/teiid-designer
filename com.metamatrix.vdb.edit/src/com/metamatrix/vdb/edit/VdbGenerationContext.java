...
public interface VdbGenerationContext {
	 ...
	 * @since 4.2
	 */
    void addErrorMessage(String message, int code, Throwable t);
	 ...
	 * @since 4.2
	 */
    void addWarningMessage(String message, int code);
	 ...
	 * @since 4.2
	 */
    void addInfoMessage(String message, int code);
	 ...
	 * @since 4.2
	 */
    boolean addGeneratedArtifact(String pathInVdb, String content);
	 ...
	 * @since 4.2
	 */
    boolean addGeneratedArtifact(String pathInVdb, org.jdom.Document xmlContent);
	 ...
	 * @since 4.2
	 */
    boolean addGeneratedArtifact(String pathInVdb, java.io.InputStream content);
	 ...
	 * @since 4.2
	 */
    boolean addGeneratedArtifact(String pathInVdb, java.io.File content);
    ...
    interface ModelObjectHelper {
		 ...
		 * determine if its contents adhere to constraints or boundaries imposed by the metamodel, Modeler, or MetaMatrix Server.
		 * Errors on a model object would prevent the model from being used within the server.
		 * 
		 * @param object
		 * @return
		 * @throws VdbGenerationInterruptedException if VDB artifact generation is canceled by the user.
		 ...
		 * determine if its contents adhere to constraints or boundaries imposed by the metamodel, Modeler, or MetaMatrix Server.
		 * Warnings on a model object will not prevent the model from being used within the server but should be examined by the
    ...
    /**
     * The ModelHelper object can be used to find some standard information about models.
     * Not all this information is standard EMF information; much of it is made available by the MetaBase Modeler
     * architecture.
     * @since 4.2
     */
    ...
    public final class ModelType {
        ...
        public static final ModelType[] ALL_MODEL_TYPES = new ModelType[]{
                                            PHYSICAL,CONFIGURATION,EXTENSION,FUNCTION,LOGICAL,
