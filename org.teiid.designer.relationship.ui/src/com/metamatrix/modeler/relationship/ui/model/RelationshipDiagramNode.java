 ...
 */
public class RelationshipDiagramNode extends AbstractLocalDiagramModelNode {

	public RelationshipDiagramNode( EObject modelObject, String diagramName) {
		super( modelObject, diagramName );
		diagram = (Diagram)modelObject;
	}
	    
	@Override
    public String toString() {
		return "RelationshipDiagramNode(" + getName() + ")"; //$NON-NLS-1$ //$NON-NLS-2$
	}
