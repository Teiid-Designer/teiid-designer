 ...
 * @since 5.0
 */
public class PreviewResultsCountPreferenceContributor implements IGeneralPreferencePageContributor, DqpUiConstants {

    private static final String PREFIX = I18nUtil.getPropertyPrefix(PreviewResultsCountPreferenceContributor.class);
    ...
    private int getPreferenceStoreValue( boolean theDefaultFlag ) {
        ...
        if (theDefaultFlag) {
            result = prefStore.getDefaultInt(Preferences.ID_PREVIEW_RESULTS_LIMIT);
        } else {
            result = prefStore.getInt(Preferences.ID_PREVIEW_RESULTS_LIMIT);
        }
    ...
    public boolean performOk() {
        ...
        getPreferenceStore().setValue(Preferences.ID_PREVIEW_RESULTS_LIMIT, Integer.parseInt(value));
